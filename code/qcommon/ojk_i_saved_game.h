...
public:
  ...
  virtual bool read_chunk(const uint32_t chunk_id) = 0;
  ...
  // Returns true on success or false otherwise.
  virtual bool write_chunk(const uint32_t chunk_id) = 0;

  // Reads data from the internal buffer.
  // Returns true on success or false otherwise.
  virtual bool read(void *dst_data, int dst_size) = 0;

  // Writes data into the internal buffer.
  // Returns true on success or false otherwise.
  virtual bool write(const void *src_data, int src_size) = 0;
