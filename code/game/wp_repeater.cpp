...
//---------------------------------------------------------
{
	...
	if (alt_fire) {
		...
		if (!(ent->client->ps.forcePowersActive & (1 << FP_SEE)) ||
			ent->client->ps.forcePowerLevel[FP_SEE] < FORCE_LEVEL_2) { // force sight 2+ gives perfect aim
			...
			if (ent->client && ent->NPC &&
				(ent->client->NPC_class == CLASS_STORMTROOPER || ent->client->NPC_class == CLASS_SWAMPTROOPER ||
