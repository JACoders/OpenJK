...
//---------------------------------------------------------
{
  ...
  missile->methodOfDeath = MOD_EMPLACED; // MOD_TURBLAST; //count as a heavy
                                         // weap
  ...
  missile->nextthink =
      level.time + 10000; // at 20000 speed, that should be more than enough
}
...
//---------------------------------------------------------
{
  ...
  // do some weird switchery on who the real owner is, we do this so the
  // projectiles don't hit the gun object
