...
// Queue Template
// --------------
// The queue is a circular buffer of objects which supports a push at the
// "front" and a pop at the "back".  Therefore it is:
//
// First In, First Out
//
// As the pointers to the push and pop locations are changed it wrapps around
// the end of the array and back to the front.  There are asserts to make sure
// it never goes beyond the capacity of the object.
//
//
//
// NOTES:
...
// The Queue Class
////////////////////////////////////////////////////////////////////////////////////////
template <class T> class queue_base : public ratl_base {
public:
...
public:
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  void push(const TTValue &v) { mData.construct(push_low(), v); }

  ////////////////////////////////////////////////////////////////////////////////////
  // Add A Value to the Queue, returning a void * to the memory
  ////////////////////////////////////////////////////////////////////////////////////
  TRatlNew *push_raw() { return mData.alloc_raw(push_low()); }
  ////////////////////////////////////////////////////////////////////////////////////
