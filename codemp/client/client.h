...
int CL_ServerStatus(const char *serverAddress, char *serverStatusString,
                    int maxLen);
...
const char *Key_KeynumToString(
    int keynum /*, qboolean bTranslate */); // note: translate is only called
                                            // for menu display not configs
