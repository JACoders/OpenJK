...
//---------------------------------------------------------
{
  ...
  gentity_t *missile = CreateMissile(wpMuzzle, wpFwd, ATST_SIDE_MAIN_VELOCITY,
                                     10000, ent, qfalse);
  ...
  missile->splashDamage = weaponData[WP_ATST_SIDE].splashDamage *
                          (ent->s.number == 0 ? 1.0f : 0.6f);
