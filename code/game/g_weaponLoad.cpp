...
// this is excluded from PCH usage 'cos it looks kinda scary to me, being game
// and ui.... -Ste
#include "g_local.h"
...
const int defaultDamage[] = {
    ...
    FLECHETTE_MINE_DAMAGE, // WP_DET_PACK			// HACK, this is what the code
                           // sez.
    CONC_DAMAGE,           // WP_CONCUSSION

    0, // WP_MELEE				// handled by the melee attack
       // function
...
const int defaultSplashDamage[] = {
    ...
    FLECHETTE_MINE_SPLASH_DAMAGE, // WP_DET_PACK		// HACK, this is what the
                                  // code sez.
...
const float defaultSplashRadius[] = {
    ...
    FLECHETTE_MINE_SPLASH_RADIUS, // WP_DET_PACK		// HACK, this is what the
                                  // code sez.
...
const float defaultAltSplashRadius[] = {
    ...
    LT_SPLASH_RAD,              // WP_TRIP_MINE
    FLECHETTE_ALT_SPLASH_RAD,   // WP_DET_PACK		// HACK, this is what
                                // the code sez.
    0.0f,                       // WP_CONCUSSION
