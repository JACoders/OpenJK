...
const vidmode_t r_vidModes[] = {{"Mode  0: 320x240", 320, 240},
...
void R_Register(void) {
  ...
  r_colorbits =
      ri.Cvar_Get("r_colorbits", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_stereo = ri.Cvar_Get("r_stereo", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_stencilbits =
      ri.Cvar_Get("r_stencilbits", "8", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_depthbits =
      ri.Cvar_Get("r_depthbits", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_overBrightBits =
      ri.Cvar_Get("r_overBrightBits", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_ignorehwgamma =
      ri.Cvar_Get("r_ignorehwgamma", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_mode = ri.Cvar_Get("r_mode", "4", CVAR_ARCHIVE | CVAR_LATCH, "");
  r_fullscreen =
      ri.Cvar_Get("r_fullscreen", "0", CVAR_ARCHIVE | CVAR_LATCH, "");
  ...
  r_vertexLight =
      ri.Cvar_Get("r_vertexLight", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
