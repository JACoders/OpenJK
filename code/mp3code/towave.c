...
//sizeof(MP3STREAM); 	iBitRate =
//iIgnoreThisForNowIJustNeedItToBreakpointOnToReadAValue;	// get rid of
//unused-variable warning
  ...
  //via panning)
  //
  if (head.mode != 3 && !bStereoDesired &&
      iDataLen > 98000)      // 3 seems to mean mono
