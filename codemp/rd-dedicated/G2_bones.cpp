...
#ifdef _DEBUG_BONE_NAMES
static inline void G2_RagDebugBox(vec3_t mins, vec3_t maxs, int duration) { return; }

static inline void G2_RagDebugLine(vec3_t start, vec3_t end, int time, int color, int radius) { return; }
#endif
...
static inline void G2_BoneSnap(CGhoul2Info_v &ghoul2V, boneInfo_t &bone, CRagDollUpdateParams *params) { return; }
