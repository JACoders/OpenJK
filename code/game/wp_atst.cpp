...
//---------------------------------------------------------
{
  ...
  gentity_t *missile =
      CreateMissile(muzzle, forwardVec, vel, 10000, ent, qtrue);
  ...
  VectorSet(missile->maxs, ATST_SIDE_ALT_ROCKET_SIZE, ATST_SIDE_ALT_ROCKET_SIZE,
            ATST_SIDE_ALT_ROCKET_SIZE);
  VectorScale(missile->maxs, -1, missile->mins);
  ...
  missile->splashDamage =
      weaponData[WP_ATST_SIDE].altSplashDamage *
      (ent->s.number == 0 ? 1.0f : ATST_SIDE_ALT_ROCKET_SPLASH_SCALE);
...
//---------------------------------------------------------
{
  ...
  gentity_t *missile = CreateMissile(
      muzzle, forwardVec, ATST_SIDE_MAIN_VELOCITY, 10000, ent, qfalse);
  ...
  VectorSet(missile->maxs, ATST_SIDE_MAIN_SIZE, ATST_SIDE_MAIN_SIZE,
            ATST_SIDE_MAIN_SIZE);
  VectorScale(missile->maxs, -1, missile->mins);
  ...
  missile->splashDamage =
      weaponData[WP_REPEATER].splashDamage * (ent->s.number == 0 ? 1.0f : 0.6f);
