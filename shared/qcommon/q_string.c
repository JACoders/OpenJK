...
qboolean Q_isintegral(float f) { return (qboolean)((int)f == f); }
...
void Q_strcat(char *dest, int size, const char *src) {
	...
	if (strlen(src) + 1 > (size_t)(size - l1)) { // do the error here instead of in Q_strncpyz to get a meaningful msg
