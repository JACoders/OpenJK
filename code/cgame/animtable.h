...
stringID_table_t animTable[MAX_ANIMATIONS + 1] = {
    ...
    ENUM2STRING(BOTH_A6_TR_BL), //# Fast weak diagonal attack bottom left to
                                //right Saber Arc and Spin Transitions
    ...
    ENUM2STRING(BOTH_T6_BL__L), //# Fast arc bottom left to left
                                // Saber Arc Transitions that use existing
                                // animations played backwards
    ENUM2STRING(BOTH_T6_BR_TR), //# Fast arc bottom right to top right
                                //(use: ENUM2STRING(BOTH_T6_TR_BR)
    ENUM2STRING(BOTH_T6_BR_T_), //# Fast arc bottom right to top
                                //(use: ENUM2STRING(BOTH_T6_T__BR)
    ENUM2STRING(BOTH_T6__R_BR), //# Fast arc right to bottom right
                                //(use: ENUM2STRING(BOTH_T6_BR__R)
    ENUM2STRING(BOTH_T6__R_T_), //# Fast ar right to top
                                //(use: ENUM2STRING(BOTH_T6_T___R)
    ENUM2STRING(BOTH_T6_TR__R), //# Fast arc top right to right
                                //(use: ENUM2STRING(BOTH_T6__R_TR)
    ENUM2STRING(BOTH_T6_TR_T_), //# Fast arc top right to top
                                //(use: ENUM2STRING(BOTH_T6_T__TR)
    ENUM2STRING(BOTH_T6_TL__R), //# Fast arc top left to right
                                //(use: ENUM2STRING(BOTH_T6__R_TL)
    ENUM2STRING(BOTH_T6_TL_TR), //# Fast arc top left to top right
                                //(use: ENUM2STRING(BOTH_T6_TR_TL)
    ENUM2STRING(BOTH_T6_TL_T_), //# Fast arc top left to top
                                //(use: ENUM2STRING(BOTH_T6_T__TL)
    ENUM2STRING(BOTH_T6_TL__L), //# Fast arc top left to left
                                //(use: ENUM2STRING(BOTH_T6__L_TL)
    ENUM2STRING(BOTH_T6__L_TR), //# Fast arc left to top right
                                //(use: ENUM2STRING(BOTH_T6_TR__L)
    ENUM2STRING(BOTH_T6__L_T_), //# Fast arc left to top
                                //(use: ENUM2STRING(BOTH_T6_T___L)
    ENUM2STRING(BOTH_T6__L_BL), //# Fast arc left to bottom left
                                //(use: ENUM2STRING(BOTH_T6_BL__L)
    ENUM2STRING(BOTH_T6_BL_T_), //# Fast arc bottom left to top
                                //(use: ENUM2STRING(BOTH_T6_T__BL)
    ENUM2STRING(BOTH_T6_BL_TL), //# Fast arc bottom left to top left
                                //(use: ENUM2STRING(BOTH_T6_TL_BL) Saber Attack
                                // Start Transitions
    ENUM2STRING(BOTH_S6_S6_T_), //# Fast plain transition from stance1 to
                                //top-to-bottom Fast weak attack
    ENUM2STRING(BOTH_S6_S6__L), //# Fast plain transition from stance1 to
                                //left-to-right Fast weak attack
    ENUM2STRING(BOTH_S6_S6__R), //# Fast plain transition from stance1 to
                                //right-to-left Fast weak attack
    ENUM2STRING(BOTH_S6_S6_TL), //# Fast plain transition from stance1 to
                                //top-left-to-bottom-right Fast weak attack
    ENUM2STRING(BOTH_S6_S6_BR), //# Fast plain transition from stance1 to
                                //bottom-right-to-top-left Fast weak attack
    ENUM2STRING(BOTH_S6_S6_BL), //# Fast plain transition from stance1 to
                                //bottom-left-to-top-right Fast weak attack
    ENUM2STRING(BOTH_S6_S6_TR), //# Fast plain transition from stance1 to
                                //top-right-to-bottom-left Fast weak attack
                                // Saber Attack Return Transitions
    ENUM2STRING(BOTH_R6_B__S6), //# Fast plain transition from top-to-bottom
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R6__L_S6), //# Fast plain transition from left-to-right
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R6__R_S6), //# Fast plain transition from right-to-left
                                //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R6_TL_S6), //# Fast plain transition from top-left-to-bottom-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R6_BR_S6), //# Fast plain transition from bottom-right-to-top-left
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R6_BL_S6), //# Fast plain transition from bottom-left-to-top-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R6_TR_S6), //# Fast plain transition from top-right-to-bottom-left
                        //Fast weak attack Saber Attack Bounces (first 4 frames
                        // of an attack), played backwards)
    ...
    ENUM2STRING(BOTH_A7_TR_BL), //# Fast weak diagonal attack bottom left to
                                //right Saber Arc and Spin Transitions
    ...
    ENUM2STRING(BOTH_T7_BL__L), //# Fast arc bottom left to left
                                // Saber Arc Transitions that use existing
                                // animations played backwards
    ENUM2STRING(BOTH_T7_BR_TR), //# Fast arc bottom right to top right
                                //(use: ENUM2STRING(BOTH_T7_TR_BR)
    ENUM2STRING(BOTH_T7_BR_T_), //# Fast arc bottom right to top
                                //(use: ENUM2STRING(BOTH_T7_T__BR)
    ENUM2STRING(BOTH_T7__R_BR), //# Fast arc right to bottom right
                                //(use: ENUM2STRING(BOTH_T7_BR__R)
    ENUM2STRING(BOTH_T7__R_T_), //# Fast ar right to top
                                //(use: ENUM2STRING(BOTH_T7_T___R)
    ENUM2STRING(BOTH_T7_TR__R), //# Fast arc top right to right
                                //(use: ENUM2STRING(BOTH_T7__R_TR)
    ENUM2STRING(BOTH_T7_TR_T_), //# Fast arc top right to top
                                //(use: ENUM2STRING(BOTH_T7_T__TR)
    ENUM2STRING(BOTH_T7_TL__R), //# Fast arc top left to right
                                //(use: ENUM2STRING(BOTH_T7__R_TL)
    ENUM2STRING(BOTH_T7_TL_TR), //# Fast arc top left to top right
                                //(use: ENUM2STRING(BOTH_T7_TR_TL)
    ENUM2STRING(BOTH_T7_TL_T_), //# Fast arc top left to top
                                //(use: ENUM2STRING(BOTH_T7_T__TL)
    ENUM2STRING(BOTH_T7_TL__L), //# Fast arc top left to left
                                //(use: ENUM2STRING(BOTH_T7__L_TL)
    ENUM2STRING(BOTH_T7__L_TR), //# Fast arc left to top right
                                //(use: ENUM2STRING(BOTH_T7_TR__L)
    ENUM2STRING(BOTH_T7__L_T_), //# Fast arc left to top
                                //(use: ENUM2STRING(BOTH_T7_T___L)
    ENUM2STRING(BOTH_T7__L_BL), //# Fast arc left to bottom left
                                //(use: ENUM2STRING(BOTH_T7_BL__L)
    ENUM2STRING(BOTH_T7_BL_T_), //# Fast arc bottom left to top
                                //(use: ENUM2STRING(BOTH_T7_T__BL)
    ENUM2STRING(BOTH_T7_BL_TL), //# Fast arc bottom left to top left
                                //(use: ENUM2STRING(BOTH_T7_TL_BL) Saber Attack
                                // Start Transitions
    ENUM2STRING(BOTH_S7_S7_T_), //# Fast plain transition from stance1 to
                                //top-to-bottom Fast weak attack
    ENUM2STRING(BOTH_S7_S7__L), //# Fast plain transition from stance1 to
                                //left-to-right Fast weak attack
    ENUM2STRING(BOTH_S7_S7__R), //# Fast plain transition from stance1 to
                                //right-to-left Fast weak attack
    ENUM2STRING(BOTH_S7_S7_TL), //# Fast plain transition from stance1 to
                                //top-left-to-bottom-right Fast weak attack
    ENUM2STRING(BOTH_S7_S7_BR), //# Fast plain transition from stance1 to
                                //bottom-right-to-top-left Fast weak attack
    ENUM2STRING(BOTH_S7_S7_BL), //# Fast plain transition from stance1 to
                                //bottom-left-to-top-right Fast weak attack
    ENUM2STRING(BOTH_S7_S7_TR), //# Fast plain transition from stance1 to
                                //top-right-to-bottom-left Fast weak attack
                                // Saber Attack Return Transitions
    ENUM2STRING(BOTH_R7_B__S7), //# Fast plain transition from top-to-bottom
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R7__L_S7), //# Fast plain transition from left-to-right
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R7__R_S7), //# Fast plain transition from right-to-left
                                //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R7_TL_S7), //# Fast plain transition from top-left-to-bottom-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R7_BR_S7), //# Fast plain transition from bottom-right-to-top-left
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R7_BL_S7), //# Fast plain transition from bottom-left-to-top-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R7_TR_S7), //# Fast plain transition from top-right-to-bottom-left
                        //Fast weak attack Saber Attack Bounces (first 4 frames
                        // of an attack), played backwards)
    ...
    ENUM2STRING(BOTH_H7_S7_BR), //# saber knocked up-left from BR parry
                                ...
                                // BOTH_(DL, S, ST)_(DL, S, ST)_(T, S)_(L, B,
                                // SB)_1(_W, _L)
    //===Single
    //locks==================================================================
    // SINGLE vs. DUAL
    ...
    ENUM2STRING(BOTH_LK_S_S_S_L_1), // lock if I'm using single vs. a single and
                                    // I initiated
    ...
    ENUM2STRING(BOTH_LK_S_S_T_L_1), // lock if I'm using single vs. a single and
                                    // I initiated
    ...
    ENUM2STRING(BOTH_LK_ST_ST_S_L_1), // lock if I'm using staff vs. a staff and
                                      // I initiated
    ...
    ENUM2STRING(BOTH_LK_ST_ST_T_L_1), // lock if I'm using staff vs. a staff and
                                      // I initiated
    ...
    // Special cases for same saber style vs. each other (won't fit in nice
    // 5-anim size lists above)
    ENUM2STRING(BOTH_LK_S_S_S_L_2), // lock if I'm using single vs. a single and
                                    // other intitiated
    ENUM2STRING(BOTH_LK_S_S_T_L_2), // lock if I'm using single vs. a single and
                                    // other initiated
    ENUM2STRING(BOTH_LK_DL_DL_S_L_2), // lock if I'm using dual vs. dual and
                                      // other initiated
    ENUM2STRING(BOTH_LK_DL_DL_T_L_2), // lock if I'm using dual vs. dual and
                                      // other initiated
    ENUM2STRING(BOTH_LK_ST_ST_S_L_2), // lock if I'm using staff vs. a staff and
                                      // other initiated
    ENUM2STRING(BOTH_LK_ST_ST_T_L_2), // lock if I'm using staff vs. a staff and
                                      // other initiated
    //===End Saber
    //locks==================================================================
    ...
    ENUM2STRING(BOTH_S1_S6), //#	From stand1 to saberdual stance - turning on
                             //your dual sabers
    ENUM2STRING(BOTH_S6_S1), //#	From dualstaff stance to stand1 - turning off
                             //your dual sabers
    ENUM2STRING(BOTH_S1_S7), //#	From stand1 to saberstaff stance - turning on
                             //your saberstaff
    ENUM2STRING(BOTH_S7_S1), //#	From saberstaff stance to stand1 - turning off
                             //your saberstaff
    ...
    ENUM2STRING(BOTH_VS_MOUNTTHROW), //# Land on an occupied vehicle & throw off
                                     //current pilot
    ENUM2STRING(BOTH_VS_MOUNTTHROW_L), //# Land on an occupied vehicle & throw
                                       //off current pilot
    ENUM2STRING(BOTH_VS_MOUNTTHROW_R), //# Land on an occupied vehicle & throw
                                       //off current pilot
    ENUM2STRING(BOTH_VS_MOUNTTHROWEE), //# Current pilot getting thrown off by
                                       //another guy
    ...
    ENUM2STRING(BOTH_LOSE_SABER),   //# player losing saber (pulled from hand by
                                    //force pull 4 - Kyle?)
    ...
    ENUM2STRING(BOTH_ROSH_HEAL), //# healed/rejuvenated
                                 // Tavion
    ENUM2STRING(BOTH_TAVION_SCEPTERGROUND), //# stabbing ground with sith sword
                                            //shoots electricity everywhere
    ...
    ENUM2STRING(BOTH_PLAYER_PA_FLY), //# player getting knocked back from punch
                                     //at end of hold 1
    ENUM2STRING(BOTH_KYLE_PA_3),     //# hold 3
    ENUM2STRING(BOTH_PLAYER_PA_3),   //# player getting held 3
    ENUM2STRING(BOTH_PLAYER_PA_3_FLY), //# player getting thrown at end of hold
                                       //3 Rancor
