...
void R_FogColor_f(void) {
	...
	tr.world->fogs[tr.world->globalFog].colorInt =
		ColorBytes4(atof(ri.Cmd_Argv(1)) * tr.identityLight, atof(ri.Cmd_Argv(2)) * tr.identityLight, atof(ri.Cmd_Argv(3)) * tr.identityLight, 1.0);
}
...
//
void R_ClearStuffToStopGhoul2CrashingThings(void) { memset(&tr, 0, sizeof(tr)); }
