...
//
// This crosses both client and server.  It could all be crammed into bg_public,
// but isolation of this type of data is best.
...
#define FIRST_WEAPON                                                           \
  WP_BRYAR_PISTOL // this is the first weapon for next and prev weapon switching
#define MAX_PLAYER_WEAPONS                                                     \
  WP_NUM_WEAPONS -                                                             \
      1 // this is the max you can switch to and get with the give all.
