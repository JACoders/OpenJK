...
// Movedata Sounds
enum { MDS_NONE = 0, MDS_FORCE_JUMP, MDS_ROLL, MDS_SABER, MDS_MOVE_SOUNDS_MAX };
...
const char *datapadMoveTitleData[MD_MOVE_TITLE_MAX] = {
    "@MENUS_ACROBATICS",    "@MENUS_SINGLE_FAST", "@MENUS_SINGLE_MEDIUM",
    "@MENUS_SINGLE_STRONG", "@MENUS_DUAL_SABERS", "@MENUS_SABER_STAFF",
};
...
static datpadmovedata_t datapadMoveData[MD_MOVE_TITLE_MAX][MAX_MOVES] = {
    {
        // Acrobatics
        {"@MENUS_FORCE_JUMP1", "@MENUS_FORCE_JUMP1_DESC", "BOTH_FORCEJUMP1",
         MDS_FORCE_JUMP},
        {"@MENUS_FORCE_FLIP", "@MENUS_FORCE_FLIP_DESC", "BOTH_FLIP_F",
         MDS_FORCE_JUMP},
        {"@MENUS_ROLL", "@MENUS_ROLL_DESC", "BOTH_ROLL_F", MDS_ROLL},
        {"@MENUS_BACKFLIP_OFF_WALL", "@MENUS_BACKFLIP_OFF_WALL_DESC",
         "BOTH_WALL_FLIP_BACK1", MDS_FORCE_JUMP},
        {"@MENUS_SIDEFLIP_OFF_WALL", "@MENUS_SIDEFLIP_OFF_WALL_DESC",
         "BOTH_WALL_FLIP_RIGHT", MDS_FORCE_JUMP},
        {"@MENUS_WALL_RUN", "@MENUS_WALL_RUN_DESC", "BOTH_WALL_RUN_RIGHT",
         MDS_FORCE_JUMP},
        {"@MENUS_WALL_GRAB_JUMP", "@MENUS_WALL_GRAB_JUMP_DESC",
         "BOTH_FORCEWALLREBOUND_FORWARD", MDS_FORCE_JUMP},
        {"@MENUS_RUN_UP_WALL_BACKFLIP", "@MENUS_RUN_UP_WALL_BACKFLIP_DESC",
         "BOTH_FORCEWALLRUNFLIP_START", MDS_FORCE_JUMP},
        {"@MENUS_JUMPUP_FROM_KNOCKDOWN", "@MENUS_JUMPUP_FROM_KNOCKDOWN_DESC",
         "BOTH_KNOCKDOWN3", MDS_NONE},
        {"@MENUS_JUMPKICK_FROM_KNOCKDOWN",
         "@MENUS_JUMPKICK_FROM_KNOCKDOWN_DESC", "BOTH_KNOCKDOWN2", MDS_NONE},
        {"@MENUS_ROLL_FROM_KNOCKDOWN", "@MENUS_ROLL_FROM_KNOCKDOWN_DESC",
         "BOTH_KNOCKDOWN1", MDS_NONE},
    ...
    },
    {
        ...
        {"@MENUS_STAB_BACK", "@MENUS_STAB_BACK_DESC", "BOTH_A2_STABBACK1",
         MDS_SABER},
        {"@MENUS_LUNGE_ATTACK", "@MENUS_LUNGE_ATTACK_DESC", "BOTH_LUNGE2_B__T_",
         MDS_SABER},
        {"@MENUS_FAST_ATTACK_KATA", "@MENUS_FAST_ATTACK_KATA_DESC",
         "BOTH_A1_SPECIAL", MDS_SABER},
        {"@MENUS_ATTACK_ENEMYONGROUND", "@MENUS_ATTACK_ENEMYONGROUND_DESC",
         "BOTH_STABDOWN", MDS_FORCE_JUMP},
        {"@MENUS_CARTWHEEL", "@MENUS_CARTWHEEL_DESC", "BOTH_ARIAL_RIGHT",
         MDS_FORCE_JUMP},
        {"@MENUS_BOTH_ROLL_STAB", "@MENUS_BOTH_ROLL_STAB2_DESC",
         "BOTH_ROLL_STAB", MDS_SABER},
        {NULL, NULL, NULL, MDS_NONE},
        {NULL, NULL, NULL, MDS_NONE},
        {NULL, NULL, NULL, MDS_NONE},
        {NULL, NULL, NULL, MDS_NONE},
    ...
    },
    {
        ...
        {"@MENUS_SLASH_BACK", "@MENUS_SLASH_BACK_DESC", "BOTH_ATTACK_BACK",
         MDS_SABER},
        {"@MENUS_FLIP_ATTACK", "@MENUS_FLIP_ATTACK_DESC",
         "BOTH_JUMPFLIPSLASHDOWN1", MDS_FORCE_JUMP},
        {"@MENUS_MEDIUM_ATTACK_KATA", "@MENUS_MEDIUM_ATTACK_KATA_DESC",
         "BOTH_A2_SPECIAL", MDS_SABER},
        {"@MENUS_ATTACK_ENEMYONGROUND", "@MENUS_ATTACK_ENEMYONGROUND_DESC",
         "BOTH_STABDOWN", MDS_FORCE_JUMP},
        {"@MENUS_CARTWHEEL", "@MENUS_CARTWHEEL_DESC", "BOTH_ARIAL_RIGHT",
         MDS_FORCE_JUMP},
    ...
    },
    {
        ...
        {"@MENUS_SLASH_BACK", "@MENUS_SLASH_BACK_DESC", "BOTH_ATTACK_BACK",
         MDS_SABER},
        {"@MENUS_JUMP_ATTACK", "@MENUS_JUMP_ATTACK_DESC",
         "BOTH_FORCELEAP2_T__B_", MDS_FORCE_JUMP},
        {"@MENUS_STRONG_ATTACK_KATA", "@MENUS_STRONG_ATTACK_KATA_DESC",
         "BOTH_A3_SPECIAL", MDS_SABER},
        {"@MENUS_ATTACK_ENEMYONGROUND", "@MENUS_ATTACK_ENEMYONGROUND_DESC",
         "BOTH_STABDOWN", MDS_FORCE_JUMP},
        {"@MENUS_CARTWHEEL", "@MENUS_CARTWHEEL_DESC", "BOTH_ARIAL_RIGHT",
         MDS_FORCE_JUMP},
    ...
    },
    {
        ...
        {"@MENUS_SLASH_BACK", "@MENUS_SLASH_BACK_DESC", "BOTH_ATTACK_BACK",
         MDS_SABER},
        {"@MENUS_FLIP_FORWARD_ATTACK", "@MENUS_FLIP_FORWARD_ATTACK_DESC",
         "BOTH_JUMPATTACK6", MDS_FORCE_JUMP},
        {"@MENUS_DUAL_SABERS_TWIRL", "@MENUS_DUAL_SABERS_TWIRL_DESC",
         "BOTH_SPINATTACK6", MDS_SABER},
        {"@MENUS_ATTACK_ENEMYONGROUND", "@MENUS_ATTACK_ENEMYONGROUND_DESC",
         "BOTH_STABDOWN_DUAL", MDS_FORCE_JUMP},
        {"@MENUS_DUAL_SABER_BARRIER", "@MENUS_DUAL_SABER_BARRIER_DESC",
         "BOTH_A6_SABERPROTECT", MDS_SABER},
        {"@MENUS_DUAL_STAB_FRONT_BACK", "@MENUS_DUAL_STAB_FRONT_BACK_DESC",
         "BOTH_A6_FB", MDS_SABER},
        {"@MENUS_DUAL_STAB_LEFT_RIGHT", "@MENUS_DUAL_STAB_LEFT_RIGHT_DESC",
         "BOTH_A6_LR", MDS_SABER},
        {"@MENUS_CARTWHEEL", "@MENUS_CARTWHEEL_DESC", "BOTH_ARIAL_RIGHT",
         MDS_FORCE_JUMP},
        {"@MENUS_BOTH_ROLL_STAB", "@MENUS_BOTH_ROLL_STAB_DESC",
         "BOTH_ROLL_STAB", MDS_SABER},
        {NULL, NULL, NULL, MDS_NONE},
        {NULL, NULL, NULL, MDS_NONE},
        {NULL, NULL, NULL, MDS_NONE},
    ...
    {// Saber Staff
     {"@MENUS_STAB_BACK", "@MENUS_STAB_BACK_DESC", "BOTH_A2_STABBACK1",
      MDS_SABER},
     {"@MENUS_BACK_FLIP_ATTACK", "@MENUS_BACK_FLIP_ATTACK_DESC",
      "BOTH_JUMPATTACK7", MDS_FORCE_JUMP},
     {"@MENUS_SABER_STAFF_TWIRL", "@MENUS_SABER_STAFF_TWIRL_DESC",
      "BOTH_SPINATTACK7", MDS_SABER},
     {"@MENUS_ATTACK_ENEMYONGROUND", "@MENUS_ATTACK_ENEMYONGROUND_DESC",
      "BOTH_STABDOWN_STAFF", MDS_FORCE_JUMP},
     {"@MENUS_SPINNING_KATA", "@MENUS_SPINNING_KATA_DESC", "BOTH_A7_SOULCAL",
      MDS_SABER},
     {"@MENUS_KICK1", "@MENUS_KICK1_DESC", "BOTH_A7_KICK_F", MDS_FORCE_JUMP},
     {"@MENUS_JUMP_KICK", "@MENUS_JUMP_KICK_DESC", "BOTH_A7_KICK_F_AIR",
      MDS_FORCE_JUMP},
     {"@MENUS_BUTTERFLY_ATTACK", "@MENUS_BUTTERFLY_ATTACK_DESC",
      "BOTH_BUTTERFLY_FR1", MDS_SABER},
     {"@MENUS_BOTH_ROLL_STAB", "@MENUS_BOTH_ROLL_STAB2_DESC", "BOTH_ROLL_STAB",
      MDS_SABER},
     {NULL, NULL, NULL, MDS_NONE},
     {NULL, NULL, NULL, MDS_NONE},
     {NULL, NULL, NULL, MDS_NONE},
...
// This is just the bare essentials of what we need to load animations properly
// for ui ghoul2 models. This function doesn't need to be sync'd with the BG_
// version in bg_panimate.c unless some sort of fundamental change is made. Just
// make sure the variables/functions accessed in ui_shared.c exist in both
// modules.
qboolean UIPAFtextLoaded = qfalse;
animation_t
    uiHumanoidAnimations[MAX_TOTALANIMATIONS]; // humanoid animations are the
                                               // only ones that are statically
                                               // allocated.

bgLoadedAnim_t bgAllAnims[MAX_ANIM_FILES];
int uiNumAllAnims =
    1; // start off at 0, because 0 will always be assigned to humanoid.

animation_t *UI_AnimsetAlloc(void) {
  assert(uiNumAllAnims < MAX_ANIM_FILES);
  bgAllAnims[uiNumAllAnims].anims =
...
int UI_ParseAnimationFile(const char *filename, animation_t *animset,
  ...
  if (!UIPAFtextLoaded ||
    ...
    if (len >= sizeof(UIPAFtext) - 1) {
      trap->FS_Close(f);
      Com_Error(ERR_DROP, "%s exceeds the allowed ui-side animation buffer!",
                filename);
    }
...
//#ifndef FINAL_BUILD
  ...
  for(i = 0; i < MAX_ANIMATIONS; i++)
  {
          if (animTable[i].name != NULL)		// This animation reference
  exists.
          {
                  if (animset[i].firstFrame <= 0 && animset[i].numFrames <=0)
                  {	// This is an empty animation reference.
                          Com_Printf("***ANIMTABLE reference #%d (%s) is
  empty!\n", i, animTable[i].name);
                  }
          }
  }
  */
  ...
  if (isHumanoid) {
    ...
    Q_strncpyz(bgAllAnims[0].filename, filename,
               sizeof(bgAllAnims[0].filename));
    UIPAFtextLoaded = qtrue;

    usedIndex = 0;
  } else {
    bgAllAnims[nextIndex].anims = animset;
    Q_strncpyz(bgAllAnims[nextIndex].filename, filename,
               sizeof(bgAllAnims[nextIndex].filename));

    usedIndex = nextIndex;

    if (nextIndex) { // don't bother increasing the number if this ended up as a
                     // humanoid load.
      uiNumAllAnims++;
    } else {
      UIPAFtextLoaded = qtrue;
...
int uiHoldSkinColor =
    TEAM_FREE; // Stores the skin color so that in non-team games, the player
               // screen remembers the team you chose, in case you're coming
               // back from the force powers screen.
...
//
static const char *GetCRDelineatedString(const char *psStripFileRef,
                                         const char *psStripStringRef,
                                         int iIndex) {
...
static const char *GetNetSourceString(int iSource) {
  ...
  Q_strncpyz(
      result,
      GetCRDelineatedString("MP_INGAME", "NET_SOURCES", UI_SourceForLAN()),
      sizeof(result));
...
void AssetCache(void) {
  ...
  uiInfo.uiDC.Assets.gradientBar =
      trap->R_RegisterShaderNoMip(ASSET_GRADIENTBAR);
  ...
  uiInfo.uiDC.Assets.fxPic[1] = trap->R_RegisterShaderNoMip(
      ART_FX_ORANGE); // trap->R_RegisterShaderNoMip( ART_FX_YELLOW );
  uiInfo.uiDC.Assets.fxPic[2] = trap->R_RegisterShaderNoMip(
      ART_FX_YELLOW); // trap->R_RegisterShaderNoMip( ART_FX_GREEN );
  uiInfo.uiDC.Assets.fxPic[3] = trap->R_RegisterShaderNoMip(
      ART_FX_GREEN); // trap->R_RegisterShaderNoMip( ART_FX_TEAL );
  uiInfo.uiDC.Assets.fxPic[4] = trap->R_RegisterShaderNoMip(ART_FX_BLUE);
  uiInfo.uiDC.Assets.fxPic[5] = trap->R_RegisterShaderNoMip(
      ART_FX_PURPLE); // trap->R_RegisterShaderNoMip( ART_FX_CYAN );
  ...
  uiInfo.uiDC.Assets.scrollBarArrowDown =
      trap->R_RegisterShaderNoMip(ASSET_SCROLLBAR_ARROWDOWN);
  uiInfo.uiDC.Assets.scrollBarArrowUp =
      trap->R_RegisterShaderNoMip(ASSET_SCROLLBAR_ARROWUP);
  uiInfo.uiDC.Assets.scrollBarArrowLeft =
      trap->R_RegisterShaderNoMip(ASSET_SCROLLBAR_ARROWLEFT);
  uiInfo.uiDC.Assets.scrollBarArrowRight =
      trap->R_RegisterShaderNoMip(ASSET_SCROLLBAR_ARROWRIGHT);
  uiInfo.uiDC.Assets.scrollBarThumb =
      trap->R_RegisterShaderNoMip(ASSET_SCROLL_THUMB);
  uiInfo.uiDC.Assets.sliderBar = trap->R_RegisterShaderNoMip(ASSET_SLIDER_BAR);
  uiInfo.uiDC.Assets.sliderThumb =
      trap->R_RegisterShaderNoMip(ASSET_SLIDER_THUMB);

  // Icons for various server settings.
  uiInfo.uiDC.Assets.needPass =
      trap->R_RegisterShaderNoMip("gfx/menus/needpass");
  uiInfo.uiDC.Assets.noForce = trap->R_RegisterShaderNoMip("gfx/menus/noforce");
  uiInfo.uiDC.Assets.forceRestrict =
      trap->R_RegisterShaderNoMip("gfx/menus/forcerestrict");
  uiInfo.uiDC.Assets.saberOnly =
      trap->R_RegisterShaderNoMip("gfx/menus/saberonly");
  uiInfo.uiDC.Assets.trueJedi =
      trap->R_RegisterShaderNoMip("gfx/menus/truejedi");

  for (n = 0; n < NUM_CROSSHAIRS; n++) {
    uiInfo.uiDC.Assets.crosshairShader[n] =
        trap->R_RegisterShaderNoMip(va("gfx/2d/crosshair%c", 'a' + n));
  }
}
...
void Text_PaintWithCursor(float x, float y, float scale, vec4_t color,
  ...
  // now print the cursor as well...  (excuse the braces, it's for porting C++
  // to C)
  //
  {
    char sTemp[1024];
    int iCopyCount =
        limit > 0 ? Q_min((int)strlen(text), limit) : (int)strlen(text);
...

    {
      ...
      Text_Paint(x + iNextXpos, y, scale, color, va("%c", cursor), 0, limit,
                 style | ITEM_TEXTSTYLE_BLINK, iMenuFont);
    }
  }
}

// maxX param is initially an X limit, but is also used as feedback. 0 = text
// was clipped to fit within, else maxX = next pos
//
static void Text_Paint_Limit(float *maxX, float x, float y, float scale,
  ...
  if (x + iPixelLen > *maxX) {
    ...
    //  Ok, this is slow and tacky, but only called occasionally, and it
    //  works...
    //
    ...
    while (*psText &&
           (x + trap->R_Font_StrLenPixels(sTemp, iFontIndex, scale) <= *maxX) &&
      ...
      uiLetter =
          trap->R_AnyLanguage_ReadCharFromString(psText, &iAdvanceCount, NULL);
    ...
    *maxX = 0; // feedback
    Text_Paint(x, y, scale, color, sTemp, adjust, limit, ITEM_TEXTSTYLE_NORMAL,
               iMenuFont);
  } else {
    // whole text fits fine, so print it all...
    //
    *maxX = x + iPixelLen; // feedback the next position, as the caller expects
    Text_Paint(x, y, scale, color, text, adjust, limit, ITEM_TEXTSTYLE_NORMAL,
               iMenuFont);
  }
}
  ...
  for (n = 0; n < count; n++) {
    ...
    if (info[0]) {
      Q_strncpyz(uiInfo.playerNames[uiInfo.playerCount],
                 Info_ValueForKey(info, "n"), MAX_NETNAME);
...
void UI_SetActiveMenu(uiMenuCommand_t menu) {
  ...
  if (Menu_Count() > 0) {
    ...
    case UIMENU_MAIN: {
      ...
      //CHAN_LOCAL_SOUND );
      //	trap->S_StartBackgroundTrack("sound/misc/menu_background.wav",
      //NULL);
...
void Text_PaintCenter(float x, float y, float scale, vec4_t color,
                      const char *text, float adjust, int iMenuFont);

const char *UI_GetStringEdString(const char *refSection, const char *refName) {
  static char text[1024] = {0};

  trap->SE_GetStringTextString(va("%s_%s", refSection, refName), text,
                               sizeof(text));
  return text;
}

void UI_SetColor(const float *rgba) { trap->R_SetColor(rgba); }
  ...
  while (1) {
    ...
    if (Q_stricmp(token.string, "cursor") == 0) {
      ...
      uiInfo.uiDC.Assets.cursor =
          trap->R_RegisterShaderNoMip(uiInfo.uiDC.Assets.cursorStr);
      continue;
    }
    ...
    if (Q_stricmp(token.string, "gradientbar") == 0) {
      ...
      uiInfo.uiDC.Assets.gradientBar =
          trap->R_RegisterShaderNoMip(token.string);
      continue;
    }
    ...
    if (Q_stricmp(token.string, "datapadmoveSaberSound1") == 0) {
      if (trap->PC_ReadToken(handle, &token)) {
        uiInfo.uiDC.Assets.datapadmoveSaberSound1 =
            trap->S_RegisterSound(token.string);
      }
    ...
    if (Q_stricmp(token.string, "datapadmoveSaberSound2") == 0) {
      if (trap->PC_ReadToken(handle, &token)) {
        uiInfo.uiDC.Assets.datapadmoveSaberSound2 =
            trap->S_RegisterSound(token.string);
      }
    ...
    if (Q_stricmp(token.string, "datapadmoveSaberSound3") == 0) {
      if (trap->PC_ReadToken(handle, &token)) {
        uiInfo.uiDC.Assets.datapadmoveSaberSound3 =
            trap->S_RegisterSound(token.string);
      }
    ...
    if (Q_stricmp(token.string, "datapadmoveSaberSound4") == 0) {
      if (trap->PC_ReadToken(handle, &token)) {
        uiInfo.uiDC.Assets.datapadmoveSaberSound4 =
            trap->S_RegisterSound(token.string);
      }
    ...
    if (Q_stricmp(token.string, "datapadmoveSaberSound5") == 0) {
      if (trap->PC_ReadToken(handle, &token)) {
        uiInfo.uiDC.Assets.datapadmoveSaberSound5 =
            trap->S_RegisterSound(token.string);
      }
...
void UI_LoadMenus(const char *menuFile, qboolean reset) {
  ...
  if (!handle) {
    ...
    if (!handle) {
      trap->Error(ERR_DROP,
                  S_COLOR_RED "default menu file not found: ui/jampmenus.txt, "
                              "unable to continue!\n");
    }
  }
...
static void UI_DrawClanName(rectDef_t *rect, float scale, vec4_t color,
  ...
  Text_Paint(rect->x, rect->y, scale, color,
             UI_Cvar_VariableString("ui_teamName"), 0, 0, textStyle, iMenuFont);
}
...
static const char *UI_GetGameTypeName(int gtEnum) {
  ...
  case GT_CTF:
    return UI_GetStringEdString("MENUS",
                                "CAPTURE_THE_FLAG"); //"Capture the Flag";
  case GT_CTY:
    return UI_GetStringEdString(
...
static void UI_DrawGameType(rectDef_t *rect, float scale, vec4_t color,
                            int textStyle, int iMenuFont) {
  Text_Paint(rect->x, rect->y, scale, color,
             UI_GetGameTypeName(uiInfo.gameTypes[ui_gametype.integer].gtEnum),
...
static void UI_DrawNetGameType(rectDef_t *rect, float scale, vec4_t color,
  ...
  Text_Paint(
      ...
      UI_GetGameTypeName(uiInfo.gameTypes[ui_netGametype.integer].gtEnum), 0, 0,
      textStyle, iMenuFont);
}

static void UI_DrawAutoSwitch(rectDef_t *rect, float scale, vec4_t color,
                              int textStyle, int iMenuFont) {
  ...
  if (stripString) {
    Text_Paint(rect->x, rect->y, scale, color, stripString, 0, 0, textStyle,
               iMenuFont);
  }
}
...
static void UI_DrawJoinGameType(rectDef_t *rect, float scale, vec4_t color,
  ...
  Text_Paint(
      rect->x, rect->y, scale, color,
      UI_GetGameTypeName(uiInfo.joinGameTypes[ui_joinGametype.integer].gtEnum),
      0, 0, textStyle, iMenuFont);
}
  ...
  if (i >= 0 && i < uiInfo.teamCount) {
    ...
    if (uiInfo.teamList[i].teamIcon == -1) {
      uiInfo.teamList[i].teamIcon =
          trap->R_RegisterShaderNoMip(uiInfo.teamList[i].imageName);
      uiInfo.teamList[i].teamIcon_Metal = trap->R_RegisterShaderNoMip(
          va("%s_metal", uiInfo.teamList[i].imageName));
      uiInfo.teamList[i].teamIcon_Name = trap->R_RegisterShaderNoMip(
    ...
    if (uiInfo.teamList[i].cinematic >= -2) {
      if (uiInfo.teamList[i].cinematic == -1) {
        uiInfo.teamList[i].cinematic =
            trap->CIN_PlayCinematic(va("%s.roq", uiInfo.teamList[i].imageName),
                                    0, 0, 0, 0, (CIN_loop | CIN_silent));
      }
      if (uiInfo.teamList[i].cinematic >= 0) {
        trap->CIN_RunCinematic(uiInfo.teamList[i].cinematic);
        trap->CIN_SetExtents(uiInfo.teamList[i].cinematic, rect->x, rect->y,
                             rect->w, rect->h);
...
static void UI_DrawPreviewCinematic(rectDef_t *rect, float scale,
  ...
  if (uiInfo.previewMovie > -2) {
    uiInfo.previewMovie = trap->CIN_PlayCinematic(
        va("%s.roq", uiInfo.movieList[uiInfo.movieIndex]), 0, 0, 0, 0,
        (CIN_loop | CIN_silent));
    if (uiInfo.previewMovie >= 0) {
      trap->CIN_RunCinematic(uiInfo.previewMovie);
      trap->CIN_SetExtents(uiInfo.previewMovie, rect->x, rect->y, rect->w,
                           rect->h);
...
static void UI_DrawSkill(rectDef_t *rect, float scale, vec4_t color,
  ...
  Text_Paint(
      rect->x, rect->y, scale, color,
      (char *)UI_GetStringEdString("MP_INGAME", (char *)skillLevels[i - 1]), 0,
      0, textStyle, iMenuFont);
}

static void UI_DrawGenericNum(rectDef_t *rect, float scale, vec4_t color,
                              int textStyle, int val, int min, int max,
...
static void UI_DrawForceMastery(rectDef_t *rect, float scale, vec4_t color,
                                int textStyle, int val, int min, int max,
                                int iMenuFont) {
  int i;
  char *s;
...
static void UI_DrawSkinColor(rectDef_t *rect, float scale, vec4_t color,
                             int textStyle, int val, int min, int max,
                             int iMenuFont) {
  char s[256];
...
static void UI_DrawForceSide(rectDef_t *rect, float scale, vec4_t color,
                             int textStyle, int val, int min, int max,
                             int iMenuFont) {
  char s[256];
  menuDef_t *menu;
  ...
  if (val == FORCE_LIGHTSIDE) {
    ...
    if (menu) {
      ...
      Menu_ShowItemByName(menu, "lightpowers_team",
                          qtrue); //(ui_gameType.integer >= GT_TEAM));
    }
    ...
    if (menu) {
      ...
      Menu_ShowItemByName(menu, "darkpowers_team",
                          qtrue); //(ui_gameType.integer >= GT_TEAM));
    }
    menu = Menus_FindByName("ingame_playerforce");
    if (menu) {
...
qboolean UI_TrueJediEnabled(void) {
  ...
  // already have serverinfo at this point for stuff below. Don't bother trying
  // to use ui_forcePowerDisable. if (ui_forcePowerDisable.integer) if
  // (atoi(Info_ValueForKey(info, "g_forcePowerDisable")))
  ...
  if (gametype == GT_HOLOCRON || gametype == GT_JEDIMASTER || saberOnly ||
      allForceDisabled) {
    trueJedi = 0;
  } else {
...
static void UI_DrawJediNonJedi(rectDef_t *rect, float scale, vec4_t color,
                               int textStyle, int val, int min, int max,
                               int iMenuFont) {
  int i;
  char s[256];
  ...
  if (!UI_TrueJediEnabled()) { // true jedi mode is not on, do not draw this
                               // button type
    return;
  }
...
static void UI_DrawTeamName(rectDef_t *rect, float scale, vec4_t color,
                            qboolean blue, int textStyle, int iMenuFont) {
  int i;
...
static void UI_DrawTeamMember(rectDef_t *rect, float scale, vec4_t color,
  ...
  // 1 - Human
  // 2..NumCharacters - Bot
  int value = trap->Cvar_VariableValue(
  ...
  Text_Paint(rect->x, rect->y, scale, finalColor, text, 0, 0, textStyle,
             iMenuFont);
}
...
static void UI_DrawMapPreview(rectDef_t *rect, float scale, vec4_t color,
  ...
  if (uiInfo.mapList[map].levelShot == -1) {
    uiInfo.mapList[map].levelShot =
        trap->R_RegisterShaderNoMip(uiInfo.mapList[map].imageName);
  }
  ...
  if (uiInfo.mapList[map].levelShot > 0) {
    ...
    UI_DrawHandlePic(rect->x, rect->y, rect->w, rect->h,
                     trap->R_RegisterShaderNoMip("menu/art/unknownmap_mp"));
  }
}
  ...
  if (uiInfo.mapList[map].cinematic >= -1) {
    if (uiInfo.mapList[map].cinematic == -1) {
      uiInfo.mapList[map].cinematic =
          trap->CIN_PlayCinematic(va("%s.roq", uiInfo.mapList[map].mapLoadName),
                                  0, 0, 0, 0, (CIN_loop | CIN_silent));
    }
    if (uiInfo.mapList[map].cinematic >= 0) {
      trap->CIN_RunCinematic(uiInfo.mapList[map].cinematic);
      trap->CIN_SetExtents(uiInfo.mapList[map].cinematic, rect->x, rect->y,
                           rect->w, rect->h);
...
// The game type on create server has changed - make the HUMAN/BOTS fields
// active
...
void UpdateForceStatus() {
  ...
  */
  ...
  if (menu) {
    ...
    // trying to use ui_forcePowerDisable. if (ui_forcePowerDisable.integer) if
    // (atoi(Info_ValueForKey(info, "g_forcePowerDisable")))
    disabledForce = atoi(Info_ValueForKey(info, "g_forcePowerDisable"));
    allForceDisabled = UI_AllForceDisabled(disabledForce);
    ...
    if (allForceDisabled == qtrue ||
        (trueJedi && uiJediNonJedi == FORCE_NONJEDI)) { // No force stuff
      Menu_ShowItemByName(menu, "noforce", qtrue);
      Menu_ShowItemByName(menu, "yesforce", qfalse);
      // We don't want the saber explanation to say "configure saber attack 1"
      // since we can't.
    ...
    if (uiForcePowersRank[FP_SABER_OFFENSE] > 0 ||
        ui_freeSaber.integer) { // Show lightsaber stuff.
    ...
    // The leftmost button should be "apply" unless you are in spectator, where
    ...
    if ((int)(trap->Cvar_VariableValue("ui_myteam")) != TEAM_SPECTATOR) {
      ...
      if (atoi(Info_ValueForKey(info, "g_gametype")) >=
          GT_TEAM) { // This is a team-based game.
        Menu_ShowItemByName(menu, "playerforcespectate", qtrue);

        // This is disabled, always show both sides from spectator.
        if (0 && atoi(Info_ValueForKey(
                     info, "g_forceBasedTeams"))) { // Show red or blue based on
                                                    // what side is chosen.
  ...
  if (!UI_TrueJediEnabled()) { // Take the current team and force a skin color
                               // based on it.
    char info[MAX_INFO_STRING];
    ...
    default:
      ...
      } else // A bit of a hack so non-team games will remember which skin set
             // you chose in the player menu
      {
...
static void UI_DrawNetSource(rectDef_t *rect, float scale, vec4_t color,
  ...
  trap->SE_GetStringTextString("MENUS_SOURCE", holdSPString,
                               sizeof(holdSPString));
  Text_Paint(
      rect->x, rect->y, scale, color,
      va("%s %s", holdSPString, GetNetSourceString(ui_netSource.integer)), 0, 0,
      textStyle, iMenuFont);
}
...
static void UI_DrawNetMapCinematic(rectDef_t *rect, float scale, vec4_t color) {
  ...
  if (uiInfo.serverStatus.currentServerCinematic >= 0) {
    ...
    trap->CIN_SetExtents(uiInfo.serverStatus.currentServerCinematic, rect->x,
...
static void UI_DrawNetFilter(rectDef_t *rect, float scale, vec4_t color,
                             int textStyle, int iMenuFont) {
  trap->SE_GetStringTextString("MENUS_GAME", holdSPString,
                               sizeof(holdSPString));

  Text_Paint(rect->x, rect->y, scale, color,
             va("%s %s", holdSPString,
                UI_FilterDescription(ui_serverFilterType.integer)),
             0, 0, textStyle, iMenuFont);
}
...
static void UI_DrawOpponent(rectDef_t *rect) {
  ...
  char team[256];
    ...
    UI_PlayerInfo_SetInfo( &info2, TORSO_WEAPONREADY3, TORSO_WEAPONREADY3,
viewangles, vec3_origin, WP_BRYAR_PISTOL, qfalse ); UI_RegisterClientModelname(
&info2, model, headmodel, team); updateOpponentModel = qfalse;
  }
...
static int UI_OwnerDrawWidth(int ownerDraw, float scale) {
  ...
  case UI_BLUETEAMNAME:
    ...
    if (i >= 0 && i < uiInfo.teamCount) {
      s = va("%s: %s", (char *)UI_GetStringEdString("MENUS", "TEAM_BLUE"),
  ...
  case UI_REDTEAMNAME:
    ...
    if (i >= 0 && i < uiInfo.teamCount) {
      s = va("%s: %s", (char *)UI_GetStringEdString("MENUS", "TEAM_RED"),
             uiInfo.teamList[i].teamName);
    }
    break;
  case UI_BLUETEAM1:
  ...
  case UI_BLUETEAM8:
    if (ownerDraw <= UI_BLUETEAM5) {
      ...
      iUse = ownerDraw - 274; // unpleasent hack because I don't want to move up
                              // all the UI_BLAHTEAM# defines
    }
  ...
  case UI_REDTEAM8:
    if (ownerDraw <= UI_REDTEAM5) {
      ...
      iUse = ownerDraw - 277; // unpleasent hack because I don't want to move up
                              // all the UI_BLAHTEAM# defines
    }
...
static void UI_DrawBotSkill(rectDef_t *rect, float scale, vec4_t color,
  ...
  if (uiInfo.skillIndex >= 0 && uiInfo.skillIndex < numSkillLevels) {
    Text_Paint(rect->x, rect->y, scale, color,
               (char *)UI_GetStringEdString(
                   "MP_INGAME", (char *)skillLevels[uiInfo.skillIndex]),
               0, 0, textStyle, iMenuFont);
  }
}
...
static void UI_DrawRedBlue(rectDef_t *rect, float scale, vec4_t color,
                           int textStyle, int iMenuFont) {
  Text_Paint(rect->x, rect->y, scale, color,
             (uiInfo.redBlue == 0) ? UI_GetStringEdString("MP_INGAME", "RED")
...
static void UI_DrawCrosshair(rectDef_t *rect, float scale, vec4_t color) {
  ...
  UI_DrawHandlePic(rect->x, rect->y, size, size,
...
static void UI_DrawSelectedPlayer(rectDef_t *rect, float scale, vec4_t color,
  ...
  Text_Paint(rect->x, rect->y, scale, color,
             UI_Cvar_VariableString("cg_selectedPlayerName"), 0, 0, textStyle,
             iMenuFont);
}
...
static void UI_DrawServerRefreshDate(rectDef_t *rect, float scale, vec4_t color,
  ...
  if (uiInfo.serverStatus.refreshActive) {
    ...
    LerpColor(color, lowLight, newColor,
              0.5 + 0.5 * sin((float)(uiInfo.uiDC.realTime / PULSE_DIVISOR)));

    trap->SE_GetStringTextString("MP_INGAME_GETTINGINFOFORSERVERS",
                                 holdSPString, sizeof(holdSPString));
    Text_Paint(
        rect->x, rect->y, scale, newColor,
        va((char *)holdSPString, trap->LAN_GetServerCount(UI_SourceForLAN())),
        0, 0, textStyle, iMenuFont);
  } else {
    char buff[64];
    Q_strncpyz(buff,
               UI_Cvar_VariableString(
                   va("ui_lastServerRefresh_%i", ui_netSource.integer)),
               sizeof(buff));
    trap->SE_GetStringTextString("MP_INGAME_SERVER_REFRESHTIME", holdSPString,
                                 sizeof(holdSPString));

    Text_Paint(rect->x, rect->y, scale, color, va("%s: %s", holdSPString, buff),
               0, 0, textStyle, iMenuFont);
  }
}
  ...
  if (uiInfo.serverStatus.motdLen) {
    ...
    if (uiInfo.serverStatus.motdPaintX2 >= 0) {
      ...
      Text_Paint_Limit(&maxX2, uiInfo.serverStatus.motdPaintX2,
                       ...
                       uiInfo.serverStatus.motdOffset, iMenuFont);
    }
...
static void UI_DrawKeyBindStatus(rectDef_t *rect, float scale, vec4_t color,
  ...
  if (Display_KeyBindPending()) {
    Text_Paint(rect->x, rect->y, scale, color,
               UI_GetStringEdString("MP_INGAME", "WAITING_FOR_NEW_KEY"), 0, 0,
               textStyle, iMenuFont);
  } else {
    //		Text_Paint(rect->x, rect->y, scale, color, "Press ENTER or CLICK to
    //change, Press BACKSPACE to clear", 0, 0, textStyle,iMenuFont);
  }
}
...
static void UI_DrawGLInfo(rectDef_t *rect, float scale, vec4_t color,
  ...
  Text_Paint(rect->x + 2, rect->y, scale, color,
             va("GL_VENDOR: %s", uiInfo.uiDC.glconfig.vendor_string), 0,
             rect->w, textStyle, iMenuFont);
  Text_Paint(rect->x + 2, rect->y + 15, scale, color,
             va("GL_VERSION: %s: %s", uiInfo.uiDC.glconfig.version_string,
                uiInfo.uiDC.glconfig.renderer_string),
             0, rect->w, textStyle, iMenuFont);
  ...
  while (y < rect->y + rect->h && extensionName != NULL) {
    if ((i % 2) == 0) {
      Text_Paint(rect->x + 2, y, scale, color, extensionName, 0, (rect->w / 2),
                 textStyle, iMenuFont);
    } else {
      Text_Paint(rect->x + rect->w / 2, y, scale, color, extensionName, 0,
                 (rect->w / 2), textStyle, iMenuFont);
      y += 11;
    }
...
static void UI_Version(rectDef_t *rect, float scale, vec4_t color,
  ...
  uiInfo.uiDC.drawText(rect->x - width, rect->y, scale, color, JK_VERSION, 0, 0,
                       0, iMenuFont);
}
...
static void UI_OwnerDraw(float x, float y, float w, float h, float text_x,
  ...
  case UI_HANDICAP:
    ...
    break;
  case UI_SKIN_COLOR:
    UI_DrawSkinColor(&rect, scale, color, textStyle, uiSkinColor, TEAM_FREE,
                     TEAM_BLUE, iMenuFont);
    break;
  case UI_FORCE_SIDE:
    UI_DrawForceSide(&rect, scale, color, textStyle, uiForceSide, 1, 2,
                     iMenuFont);
    break;
  case UI_JEDI_NONJEDI:
    UI_DrawJediNonJedi(&rect, scale, color, textStyle, uiJediNonJedi, 0, 1,
                       iMenuFont);
    break;
  case UI_FORCE_POINTS:
    UI_DrawGenericNum(&rect, scale, color, textStyle, uiForceAvailable, 1,
                      forceMasteryPoints[MAX_FORCE_RANK], ownerDraw, iMenuFont);
    break;
  case UI_FORCE_MASTERY_SET:
    UI_DrawForceMastery(&rect, scale, color, textStyle, uiForceRank, 0,
                        MAX_FORCE_RANK, iMenuFont);
    break;
  case UI_FORCE_RANK:
    UI_DrawForceMastery(&rect, scale, color, textStyle, uiForceRank, 0,
                        MAX_FORCE_RANK, iMenuFont);
  ...
  case UI_FORCE_RANK_SABERTHROW:
    ...
    */
    ...
    if (uiForcePowerDarkLight[findex] &&
        uiForceSide != uiForcePowerDarkLight[findex]) {
      color[0] *= 0.5;
      color[1] *= 0.5;
      color[2] *= 0.5;
    }
    /*		else if (uiForceRank <
       UI_ForceColorMinRank[bgForcePowerCost[findex][FORCE_LEVEL_1]])
                    {
                            color[0] *= 0.5;
                            color[1] *= 0.5;
                            color[2] *= 0.5;
    ...
    */
    ...
    UI_DrawForceStars(&rect, scale, color, textStyle, findex, drawRank, 0,
  ...
  while (flags) {
    ...
    if (flags & UI_SHOW_LEADER) {
      ...
      if (!uiInfo.teamLeader) {
        ...
        // if showing yourself
        if (cg_selectedPlayer.integer < uiInfo.myTeamCount &&
            uiInfo.teamClientNums[cg_selectedPlayer.integer] ==
                uiInfo.playerNumber) {
          vis = qfalse;
        }
      }
...
static qboolean UI_InSoloMenu(void) {
  ...
  menu = Menu_GetFocused(); // Get current menu (either video or ingame video, I
                            // would assume)
...
static qboolean UI_NetGameType_HandleKey(int flags, float *special, int key) {
  if (key == A_MOUSE1 || key == A_MOUSE2 || key == A_ENTER ||
    ...
    trap->Cvar_Update(&ui_netGametype);
    trap->Cvar_Set("ui_actualNetGametype",
...
static qboolean UI_TeamName_HandleKey(int flags, float *special, int key,
  ...
  if (key == A_MOUSE1 || key == A_MOUSE2 || key == A_ENTER ||
    ...
    trap->Cvar_Set((blue) ? "ui_blueTeam" : "ui_redTeam",
                   uiInfo.teamList[i].teamName);
...
static qboolean UI_OwnerDrawHandleKey(int ownerDraw, int flags, float *special,
  ...
  case UI_HANDICAP:
    ...
    break;
  case UI_SKIN_COLOR:
    return UI_SkinColor_HandleKey(flags, special, key, uiSkinColor, TEAM_FREE,
                                  TEAM_BLUE, ownerDraw);
    break;
  case UI_FORCE_SIDE:
    return UI_ForceSide_HandleKey(flags, special, key, uiForceSide, 1, 2,
                                  ownerDraw);
    break;
  case UI_JEDI_NONJEDI:
    return UI_JediNonJedi_HandleKey(flags, special, key, uiJediNonJedi, 0, 1,
                                    ownerDraw);
    break;
  case UI_FORCE_MASTERY_SET:
    return UI_ForceMaxRank_HandleKey(flags, special, key, uiForceRank, 1,
                                     MAX_FORCE_RANK, ownerDraw);
    break;
  case UI_FORCE_RANK:
    break;
  case UI_CHAT_MAIN:
  ...
  case UI_FORCE_RANK_SABERTHROW:
    ...
    // this will give us the index as long as UI_FORCE_RANK is always one below
    // the first force rank index
    return UI_ForcePowerRank_HandleKey(flags, special, key,
                                       uiForcePowersRank[findex], 0,
...
*/
static int QDECL UI_ServersQsortCompare(const void *arg1, const void *arg2) {
  return trap->LAN_CompareServers(
...
static void UI_LoadMods() {
  ...
  if (strstr(version, "2003")) {
    trap->SE_GetStringTextString("MENUS_JEDI_ACADEMY", sJediAcademy,
                                 sizeof(sJediAcademy));
...
static void UI_LoadDemosInDirectory(loadDemoContext_t *ctx,
  ...
  if (ctx->depth > MAX_DEMO_FOLDER_DEPTH) {
    if (!ctx->warned) {
      ...
      Com_Printf(S_COLOR_YELLOW
                 "WARNING: Maximum demo folder depth (%d) was reached.\n",
  ...
  uiInfo.demoCount += trap->FS_GetFileList(directory, demoExt, ctx->demoList,
                                           sizeof(ctx->demoList));
  ...
  for (j = 0; j < 2; j++) {
    ...
    for (; uiInfo.loadedDemos < uiInfo.demoCount; uiInfo.loadedDemos++) {
      ...
      len = strlen(demoname);
      Com_sprintf(uiInfo.demoList[uiInfo.loadedDemos],
                  sizeof(uiInfo.demoList[0]), "%s%s", dirPath + 1, demoname);
      demoname += len + 1;
    }

    if (!j) {
      if (protocolLegacy > 0 && uiInfo.demoCount < MAX_DEMOS) {
        Com_sprintf(demoExt, sizeof(demoExt), ".%s%d", DEMO_EXTENSION,
                    protocolLegacy);
        uiInfo.demoCount += trap->FS_GetFileList(
            directory, demoExt, ctx->demoList, sizeof(ctx->demoList));
        demoname = ctx->demoList;
      } else
        break;
    }
  ...
  if (ctx->dirListHead < dirListEnd) {
    ...
    int numFiles = trap->FS_GetFileList(directory, "/", ctx->dirListHead,
                                        dirListSpaceRemaining);
    char *dirList;
    char *childDirListBase;
    char *fileName;

    // Find end of this list so we have a base pointer for the child folders to
    // use
...
void UI_UpdateVideoSetup(void) {
  ...
  trap->Cvar_Set("r_detailtextures",
                 UI_Cvar_VariableString("ui_r_detailtextures"));
  trap->Cvar_Set("r_ext_compress_textures",
                 UI_Cvar_VariableString("ui_r_ext_compress_textures"));
  ...
  trap->Cvar_Set("r_allowExtensions",
                 UI_Cvar_VariableString("ui_r_allowExtensions"));
...
void UI_GetVideoSetup(void) {
  ...
  trap->Cvar_Register(NULL, "ui_r_detailtextures", "0",
                      CVAR_ROM | CVAR_INTERNAL);
  trap->Cvar_Register(NULL, "ui_r_ext_compress_textures", "0",
                      CVAR_ROM | CVAR_INTERNAL);
  ...
  trap->Cvar_Register(NULL, "ui_r_allowExtensions", "0",
                      CVAR_ROM | CVAR_INTERNAL);
  ...
  trap->Cvar_Set("ui_r_detailtextures",
                 UI_Cvar_VariableString("r_detailtextures"));
  trap->Cvar_Set("ui_r_ext_compress_textures",
                 UI_Cvar_VariableString("r_ext_compress_textures"));
  ...
  trap->Cvar_Set("ui_r_allowExtensions",
                 UI_Cvar_VariableString("r_allowExtensions"));
  trap->Cvar_Set("ui_cg_shadows", UI_Cvar_VariableString("cg_shadows"));
  trap->Cvar_Set("ui_r_modified", "0");
}

// If the game type is siege, hide the addbot button. I would have done a cvar
// text on that item, but it already had one on it.
static void UI_SetBotButton(void) {
  ...
  if ((gameType == GT_SIEGE) ||
      (server == 0)) // If it's not siege, don't worry about it
  {
    menu = Menu_GetFocused(); // Get current menu (either video or ingame video,
                              // I would assume)
...
static void UI_UpdateCharacterCvars(void) {
  ...
  trap->Cvar_Set("char_color_green",
                 UI_Cvar_VariableString("ui_char_color_green"));
  trap->Cvar_Set("char_color_blue",
                 UI_Cvar_VariableString("ui_char_color_blue"));
...
static void UI_GetCharacterCvars(void) {
  ...
  trap->Cvar_Set("ui_char_color_green",
                 UI_Cvar_VariableString("char_color_green"));
  trap->Cvar_Set("ui_char_color_blue",
                 UI_Cvar_VariableString("char_color_blue"));
...
void UI_SetSiegeObjectiveGraphicPos(menuDef_t *menu, const char *itemName,
                                    const char *cvarName) {
  itemDef_t *item;
  char cvarBuf[1024];
  const char *holdVal;
...
void UI_UpdateSiegeObjectiveGraphics(void) {
  ...
  // Hiding a bunch of fields because the opening section of the siege menu was
  // getting too long
  ...
  for (teamI = 1; teamI < 3; teamI++) {
    for (objI = 1; objI < 8; objI++) {
      UI_SetSiegeObjectiveGraphicPos(
          menu, va("tm%i_icon%i", teamI, objI),
...
static void UI_GetSaberCvars(void) {
  //	trap->Cvar_Set ( "ui_saber_type", UI_Cvar_VariableString (
  //"g_saber_type" ) );
  trap->Cvar_Set("ui_saber", UI_Cvar_VariableString("saber1"));
  trap->Cvar_Set("ui_saber2", UI_Cvar_VariableString("saber2"));

  trap->Cvar_Set("g_saber_color",
                 SaberColorToString(trap->Cvar_VariableValue("color1")));
  trap->Cvar_Set("g_saber2_color",
                 SaberColorToString(trap->Cvar_VariableValue("color2")));
...
extern qboolean ItemParse_model_g2anim_go(itemDef_t *item,
                                          const char *animName);
...
void UI_UpdateCharacterSkin(void) {
  ...
  if (!item) {
    Com_Error(
        ERR_FATAL,
        "UI_UpdateCharacterSkin: Could not find item (character) in menu (%s)",
        menu->window.name);
  }
  ...
  Com_sprintf(skin, sizeof(skin), "models/players/%s/|%s|%s|%s", model, head,
              torso, legs);
...
void WP_SaberGetHiltInfo(const char *singleHilts[MAX_SABER_HILTS],
                         const char *staffHilts[MAX_SABER_HILTS]);
...
static void UI_UpdateCharacter(qboolean changedModel) {
  ...
  if (!item) {
    Com_Error(
        ERR_FATAL,
        "UI_UpdateCharacter: Could not find item (character) in menu (%s)",
        menu->window.name);
  }
  ...
  if (changedModel) { // set all skins to first skin since we don't know you
                      // always have all skins
    // FIXME: could try to keep the same spot in each list as you swtich models
    UI_FeederSelection(FEEDER_PLAYER_SKIN_HEAD, 0,
                       item); // fixme, this is not really the right item!!
...
static qboolean UI_CheckPassword(void) {
  ...
  if ((index < 0) ||
      (index >= uiInfo.serverStatus.numDisplayServers)) { // warning?
    return qfalse;
  }
  ...
  // This isn't going to make it (too late in dev), like James said I should
  // check to see when we receive a packet *if* we do indeed get a 0 ping just
  // make it 1 so then a 0 ping is guaranteed to be bad
  /*
  // also check ping!
ping = atoi(Info_ValueForKey(info, "ping"));
  // NOTE : PING -- it's very questionable as to whether a ping of < 0 or <= 0
indicates a bad server
  // what I do know, is that getting "ping" from the ServerInfo on a bad server
returns 0.
  // So I'm left with no choice but to not allow you to enter a server with a
ping of 0 if( ping <= 0 )
  {
...
static void UI_JoinServer(void) {
  ...
  if (uiInfo.serverStatus.currentServer >= 0 &&
    ...
    trap->LAN_GetServerAddressString(
        UI_SourceForLAN() /*ui_netSource.integer*/,
...
// called every time a class is selected from a feeder, sets info for shaders to
// be displayed in the menu about the class -rww
void UI_SiegeSetCvarsForClass(siegeClass_t *scl) {
  ...
  i = 0;
  trap->Cvar_Set(va("ui_class_weapondesc%i", count),
                 " "); // Blank it out to start with
  while (i < WP_NUM_WEAPONS) {

    if (scl->weapons & (1 << i)) {
      if (i == WP_SABER) { // we want to see what kind of saber they have, and
                           // set the cvar based on that
        char saberType[1024];

        if (scl->saber1[0] && scl->saber2[0]) {
          Q_strncpyz(saberType, "gfx/hud/w_icon_duallightsaber",
                     sizeof(saberType));
        } // fixme: need saber data access on ui to determine if staff,
          // "gfx/hud/w_icon_saberstaff"
        else {
          char buf[1024];
          if (scl->saber1[0] && UI_SaberTypeForSaber(scl->saber1, buf)) {
            if (!Q_stricmp(buf, "SABER_STAFF")) {
              Q_strncpyz(saberType, "gfx/hud/w_icon_saberstaff",
                         sizeof(saberType));
            } else {
              Q_strncpyz(saberType, "gfx/hud/w_icon_lightsaber",
                         sizeof(saberType));
            }
          } else {
            Q_strncpyz(saberType, "gfx/hud/w_icon_lightsaber",
  ...
  while (i < NUM_FORCE_POWERS) {
    trap->Cvar_Set(va("ui_class_powerlevel%i", i),
                   "0"); // Zero this out to start.
    if (i < 9) {
      trap->Cvar_Set(va("ui_class_powerlevelslot%i", i),
                     "0"); // Zero this out to start.
    }

    if (scl->forcePowerLevels[i]) {
      trap->Cvar_Set(va("ui_class_powerlevel%i", count),
                     va("%i", scl->forcePowerLevels[i]));
...
void UI_UpdateCvarsForClass(const int team, const int baseClass,
                            const int index) {
      ...
      if ((index >= 0) && (index < BG_SiegeCountBaseClass(team, baseClass))) {
        if (!g_siegedFeederForcedSet) {
          ...
          if (holdClass) // clicked a valid item
          {
            ...
            trap->Cvar_Set(
                "ui_classDesc",
                g_UIClassDescriptions[g_UIGloballySelectedSiegeClass].desc);
...
void UI_UpdateSiegeStatusIcons(void) {
  ...
  if (menu) {
    int i = 0;
    for (i = 0; i < 7; i++)
      Menu_SetItemBackground(menu, va("wpnicon0%d", i),
                             va("*ui_class_weapon%d", i));
    for (i = 0; i < 7; i++)
      Menu_SetItemBackground(menu, va("itemicon0%d", i),
                             va("*ui_class_item%d", i));
    for (i = 0; i < 10; i++)
      Menu_SetItemBackground(menu, va("forceicon0%d", i),
                             va("*ui_class_power%d", i));
    for (i = 10; i < 15; i++)
      Menu_SetItemBackground(menu, va("forceicon%d", i),
                             va("*ui_class_power%d", i));
  }
}
...
static void UI_RunMenuScript(char **args) {
  ...
  if (String_Parse(args, &name)) {
    if (Q_stricmp(name, "StartServer") == 0) {
      ...
      //	trap->Cvar_Set("cg_thirdPerson", "0");
      trap->Cvar_Set("cg_cameraOrbit", "0");
      // for Solo games I set this to 1 in the menu and don't want it stomped
      // here, this cvar seems to be reset to 0 in all the proper places so...
      // -dmv
      //	trap->Cvar_Set("ui_singlePlayerActive", "0");

      // if a solo game is started, automatically turn dedicated off here (don't
      // want to do it in the menu, might get annoying)
      ...
      trap->Cvar_SetValue(
          "g_gametype",
          Com_Clamp(0, GT_MAX_GAME_TYPE,
                    uiInfo.gameTypes[ui_netGametype.integer].gtEnum));
      // trap->Cvar_Set("g_redTeam", UI_Cvar_VariableString("ui_teamName"));
      // trap->Cvar_Set("g_blueTeam",
      ...
      if (trap->Cvar_VariableValue("g_gametype") == GT_DUEL ||
          trap->Cvar_VariableValue("g_gametype") ==
              GT_POWERDUEL) { // always set fraglimit 1 when starting a duel
                              // game
      ...
      for (i = 0; i < PLAYERS_PER_TEAM; i++) {
        ...
        if (added >= maxcl) { // this means the client filled up all their slots
                              // in the UI with bots. So stretch out an extra
                              // slot for them, and then stop adding bots.
      ...
      UI_SetCapFragLimits(qtrue);
      UI_MapCountByGameType(qtrue);
      trap->Cvar_SetValue("ui_mapIndex",
      ...
      UI_LoadArenas();
      UI_MapCountByGameType(qfalse);
      Menu_SetFeederSelection(NULL, FEEDER_ALLMAPS, gUISelectedMap,
                              "createserver");
    ...
    // On the solo game creation screen, we can't see siege maps
      ...
      if (uiInfo.playerIndex >= 0 && uiInfo.playerIndex < uiInfo.playerCount) {
        // trap->Cmd_ExecuteText( EXEC_APPEND, va("callvote kick
      ...
      //	if (ui_netSource.integer == UIAS_FAVORITES)
      // rww - don't know why this check was here.. why would you want to only
      // add new favorites when the filter was favorites?
      {
        char name[MAX_HOSTNAMELENGTH] = {0};
        char addr[MAX_ADDRESSLENGTH] = {0};
        int res;
      ...
      if (String_Parse(args, &orders)) {
        ...
        if (selectedPlayer < uiInfo.myTeamCount) {
          ...
          trap->Cmd_ExecuteText(
              EXEC_APPEND, va(buff, uiInfo.teamClientNums[selectedPlayer]));
          trap->Cmd_ExecuteText(EXEC_APPEND, "\n");
        } else {
          int i;
        ...
        if (Q_stricmp("none", teamArg) == 0) {
          ...
          if (myTeam != TEAM_SPECTATOR) {
            UI_UpdateClientForcePowers(
                UI_TeamName(myTeam)); // will cause him to respawn, if it's been
                                      // 5 seconds since last one
          } else {
      ...
      trap->Cvar_VariableStringBuffer("ui_mySiegeClass", newclassString,
                                      sizeof(newclassString));
      trap->Cvar_VariableStringBuffer("ui_startsiegeclass", startclassString,
                                      sizeof(startclassString));

      // Was just a spectator - is still just a spectator
      if ((oldteam == team) && (oldteam == 3)) {
        goTeam = qfalse;
      }
      // If new team and class match old team and class, just return to the
      // game.
      else if (oldteam == team) { // Classes match?
        if (g_UIGloballySelectedSiegeClass != -1) {
          if (!strcmp(startclassString,
      ...
      if (menu) {
        itemDef_t *item =
            (itemDef_t *)Menu_FindItemByName((menuDef_t *)menu, "character");
        if (item) {
      ...
      if (menu) {
        ...
        if (item) {
          ...
          if (modelPtr) {
            ...
            uiInfo.movesBaseAnim =
                datapadMoveTitleBaseAnims[uiInfo.movesTitleIndex];
            ItemParse_model_g2anim_go(item, uiInfo.movesBaseAnim);
            uiInfo.moveAnimTime = 0;

            Com_sprintf(modelPath, sizeof(modelPath),
                        "models/players/%s/model.glm",
                        UI_Cvar_VariableString("ui_char_model"));
            ItemParse_asset_model_go(item, modelPath, &animRunLength);
...
#endif
    // If this is siege, change all the bots to humans, because we faked it
    // earlier
    //  swapping humans for bots on the menu
      ...
      menu = Menu_GetFocused(); // Get current menu
      if (menu) {
        item = (itemDef_t *)Menu_FindItemByName((menuDef_t *)menu,
                                                "hiltbut_staves");
        if (item) {
          if (saberSingleHiltInfo[item->cursorPos]) {
      ...
      if (menu) {
        ...
        if (String_Parse(args, &itemArg)) {
          ...
          trap->Cvar_VariableStringBuffer("currentObjMapIconItem", string,
                                          sizeof(string));
          item = (itemDef_t *)Menu_FindItemByName((menuDef_t *)menu, string);
          if (item) {
            // A cvar holding the name of a cvar - how crazy is that?
            trap->Cvar_VariableStringBuffer("currentObjMapIconBackground",
          ...
          if (item) { // store item name
            ...
            if (String_Parse(args, &cvarNormalArg)) { // Store normal background
              ...
              if (String_Parse(args,
                               &cvarLitArg)) { // set hightlight background
                trap->Cvar_VariableStringBuffer(cvarLitArg, string,
                                                sizeof(string));
    ...
    // Save current team and class
      ...
      trap->Cvar_VariableStringBuffer("ui_mySiegeClass", classString,
                                      sizeof(classString));
      ...
      if (menu) {
        item = (itemDef_t *)Menu_FindItemByName((menuDef_t *)menu,
                                                "base_class_weapons_feed");
        if (item) {
          char info[MAX_INFO_VALUE];
          trap->Cvar_VariableStringBuffer(
              va("ui_class_weapondesc%i", item->cursorPos), info, sizeof(info));
      ...
      if (menu) {
        item = (itemDef_t *)Menu_FindItemByName((menuDef_t *)menu,
                                                "base_class_inventory_feed");
        if (item) {
          char info[MAX_INFO_VALUE];
          trap->Cvar_VariableStringBuffer(
              va("ui_class_itemdesc%i", item->cursorPos), info, sizeof(info));
          trap->Cvar_Set("ui_itemforceinvdesc", info);
        }
      }
      ...
      if (menu) {
        item = (itemDef_t *)Menu_FindItemByName((menuDef_t *)menu,
                                                "base_class_force_feed");
        if (item) {
          int i;
          char info[MAX_STRING_CHARS];

          trap->Cvar_VariableStringBuffer(
              va("ui_class_power%i", item->cursorPos), info, sizeof(info));
      ...
      if (menu) {
        item =
            (itemDef_t *)Menu_FindItemByName((menuDef_t *)menu, "description");
        if (item) {
          listBoxDef_t *listPtr = item->typeData.listbox;
          if (listPtr) {
            listPtr->startPos = 0;
      ...
      trap->Cvar_Set("ui_mousePitch",
                     (trap->Cvar_VariableValue("m_pitch") >= 0) ? "0" : "1");
...
void UI_SetSiegeTeams(void) {
  ...
  // If the server we are connected to is not siege we cannot choose a class
  // anyway
  if (gametype != GT_SIEGE) {
    return;
  }
...
static void UI_BuildServerDisplayList(int force) {
  ...
  trap->Cvar_VariableStringBuffer("cl_motdString", uiInfo.serverStatus.motd,
                                  sizeof(uiInfo.serverStatus.motd));
  len = strlen(uiInfo.serverStatus.motd);
  if (len == 0) {
    Q_strncpyz(uiInfo.serverStatus.motd, "Welcome to Jedi Academy MP!",
               sizeof(uiInfo.serverStatus.motd));
    len = strlen(uiInfo.serverStatus.motd);
  }
  ...
  for (i = 0; i < count; i++) {
    ...
    if (ping > 0 || ui_netSource.integer == UIAS_FAVORITES) {
      ...
      if (ui_browserFilterInvalidInfo.integer != 0 &&
          !UI_ServerInfoIsValid(info)) {
      ...
      if (ui_serverFilterType.integer > 0 &&
        ...
        if (Q_stricmp(Info_ValueForKey(info, "game"),
                      UI_FilterDir(ui_serverFilterType.integer)) != 0) {
          trap->LAN_MarkServerVisible(lanSource, i, qfalse);
          continue;
        }
      }
...
static void UI_BuildFindPlayerList(qboolean force) {
  ...
  if (!force) {
    ...
    trap->SE_GetStringTextString("MENUS_SEARCHING", holdSPString,
                                 sizeof(holdSPString));
    trap->Cvar_Set("ui_playerServersFound",
                   va(holdSPString, uiInfo.pendingServerStatus.num, numFound));
  ...
  if (i < MAX_SERVERSTATUSREQUESTS) {
    ...
    trap->SE_GetStringTextString("MENUS_SERVERS_FOUNDWITH", holdSPString,
                                 sizeof(holdSPString));
    // add a line that shows the number of servers found
    if (!uiInfo.numFoundPlayerServers) {
      trap->Cvar_Set("ui_playerServersFound",
                     va(holdSPString, 0, "s", uiInfo.findPlayerName));
    } else {
      trap->Cvar_Set("ui_playerServersFound",
                     va(holdSPString, uiInfo.numFoundPlayerServers - 1,
...
static int UI_FeederCount(float feederID) {
  ...
  case FEEDER_SERVERSTATUS:
    return Com_Clampi(0, MAX_SERVERSTATUS_LINES,
                      uiInfo.serverStatusInfo.numLines);
  ...
  case FEEDER_SIEGE_CLASS_INVENTORY:
    ...
    for (i = 0; i < HI_NUM_HOLDABLE; i++) {
      trap->Cvar_VariableStringBuffer(va("ui_class_item%i", i), info,
                                      sizeof(info));
  ...
  case FEEDER_SIEGE_CLASS_FORCE:
    // count them up
    for (i = 0; i < NUM_FORCE_POWERS; i++) {
      trap->Cvar_VariableStringBuffer(va("ui_class_power%i", i), info,
                                      sizeof(info));
      if (Q_stricmp(info, "gfx/2d/select") != 0) {
        count++;
      }
...
static const char *UI_FeederItemText(float feederID, int index, int column,
                                     ...
                                     qhandle_t *handle3) {
  static char
      info[MAX_STRING_CHARS]; // don't change this size without changing the
                              // sizes inside the SaberProperName calls
  ...
  *handle1 = *handle2 = *handle3 = -1;
  ...
  if (feederID == FEEDER_SABER_SINGLE_INFO) {
    ...
    */
    ...
    if (index >= 0 && index < uiInfo.forceConfigCount) {
      if (index == 0) { // always show "custom"
        ...
        if (uiForceSide == FORCE_LIGHTSIDE) {
          ...
          if (index > uiInfo.forceConfigLightIndexBegin) { // dark gets read in
                                                           // before light
            return NULL;
          }
          if (index >= uiInfo.forceConfigCount) {
      ...
      case SORT_HOST:
        if (ping <= 0) {
          ...
          if (gametype != GT_JEDIMASTER) {
            ...
            if (UI_AllForceDisabled(
                    restrictedForce)) { // all force powers are disabled
              allForceDisabled = qtrue;
              *handle2 = uiInfo.uiDC.Assets.noForce;
            } else if (restrictedForce) { // at least one force power is
                                          // disabled
            ...
            if (saberOnly) {
              *handle1 = uiInfo.uiDC.Assets.saberOnly;
              ...
              if (gametype != GT_HOLOCRON && gametype != GT_JEDIMASTER &&
                  !saberOnly && !allForceDisabled) { // truejedi is on and
    ...
    if (index >= 0 &&
        index < uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].ColorCount) {
      *handle1 = trap->R_RegisterShaderNoMip(
          uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].Color[index].shader);
      return uiInfo.playerSpecies[uiInfo.playerSpeciesIndex]
          .Color[index]
          .shader;
    }
  } else if (feederID == FEEDER_PLAYER_SKIN_HEAD) {
    if (index >= 0 &&
        index < uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinHeadCount) {
      *handle1 = trap->R_RegisterShaderNoMip(
          va("models/players/%s/icon_%s",
             uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].Name,
    ...
    if (index >= 0 &&
        index <
            uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinTorsoCount) {
      *handle1 = trap->R_RegisterShaderNoMip(
          va("models/players/%s/icon_%s",
             uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].Name,
             uiInfo.playerSpecies[uiInfo.playerSpeciesIndex]
    ...
    if (index >= 0 &&
        index < uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinLegCount) {
      *handle1 = trap->R_RegisterShaderNoMip(va(
          "models/players/%s/icon_%s",
          uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].Name,
...
static qhandle_t UI_FeederItemImage(float feederID, int index) {
  ...
  if (feederID == FEEDER_SABER_SINGLE_INFO) {
    ...
    if (index >= 0 &&
        index < uiInfo.q3HeadCount) { // we want it to load them as it draws
                                      // them, like the TA feeder return
                                      // uiInfo.q3HeadIcons[index];
      ...
      if (!uiInfo.q3HeadIcons[index]) { // this isn't the best way of doing this
                                        // I guess, but I didn't want a whole
                                        // seperate string array for storing
                                        // shader names. I can't just replace
                                        // q3HeadNames with the shader name,
                                        // because we print what's in q3HeadNames
                                        // and the icon name would look funny.
        ...
        Com_sprintf(iconNameFromSkinName, sizeof(iconNameFromSkinName),
                    "models/players/%s", uiInfo.q3HeadNames[index]);
        ...
        // and now, for the final step, append the skin name from q3HeadNames
        // onto the end of iconNameFromSkinName
        i = strlen(iconNameFromSkinName);
        ...
        // and now we are ready to register (thankfully this will only happen
        // once)
        uiInfo.q3HeadIcons[index] =
            trap->R_RegisterShaderNoMip(iconNameFromSkinName);
      }
    ...
    if (index >= 0 && index < uiInfo.mapCount) {
      if (uiInfo.mapList[index].levelShot == -1) {
        uiInfo.mapList[index].levelShot =
            trap->R_RegisterShaderNoMip(uiInfo.mapList[index].imageName);
      }
    ...
    if (index >= 0 &&
        index < uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinHeadCount) {
      // return
      // uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinHeadIcons[index];
    ...
    if (index >= 0 &&
        index <
            uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinTorsoCount) {
      // return
      // uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinTorsoIcons[index];
      return trap->R_RegisterShaderNoMip(
          va("models/players/%s/icon_%s",
             uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].Name,
             uiInfo.playerSpecies[uiInfo.playerSpeciesIndex]
    ...
    if (index >= 0 &&
        index < uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinLegCount) {
      // return
      // uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinLegIcons[index];
      return trap->R_RegisterShaderNoMip(va(
          "models/players/%s/icon_%s",
          uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].Name,
          uiInfo.playerSpecies[uiInfo.playerSpeciesIndex].SkinLeg[index].name));
    }
    ...
    for (i = 0; i < NUM_FORCE_POWERS; i++) {
      ...
      if (Q_stricmp(info, "gfx/2d/select") != 0) {
        if (validCnt == index) {
          trap->Cvar_VariableStringBuffer(va("ui_class_powerlevel%i", validCnt),
                                          info2, sizeof(info2));
...
qboolean UI_FeederSelection(float feederFloat, int index, itemDef_t *item) {
  ...
  if (feederID == FEEDER_Q3HEADS) {
      ...
      if (item) {
        ...
        if (modelPtr) {
          ...
          ItemParse_model_g2anim_go(
              item, datapadMoveData[uiInfo.movesTitleIndex][index].anim);
          ...
          if (datapadMoveData[uiInfo.movesTitleIndex][index].anim) {
            ...
            // Play sound for anim
            if (datapadMoveData[uiInfo.movesTitleIndex][index].sound ==
                MDS_FORCE_JUMP) {
              trap->S_StartLocalSound(uiInfo.uiDC.Assets.moveJumpSound,
                                      CHAN_LOCAL);
            } else if (datapadMoveData[uiInfo.movesTitleIndex][index].sound ==
                       MDS_ROLL) {
              trap->S_StartLocalSound(uiInfo.uiDC.Assets.moveRollSound,
                                      CHAN_LOCAL);
            } else if (datapadMoveData[uiInfo.movesTitleIndex][index].sound ==
                       MDS_SABER) {
            ...
            if (datapadMoveData[uiInfo.movesTitleIndex][index].desc) {
              trap->Cvar_Set(
                  "ui_move_desc",
                  datapadMoveData[uiInfo.movesTitleIndex][index].desc);
            }
          }
          UI_SaberAttachToChar(item);
        }
    ...
    if (!g_siegedFeederForcedSet) {
      g_UIGloballySelectedSiegeClass =
          UI_SiegeClassNum(siegeTeam1->classes[index]);
      trap->Cvar_Set(
          "ui_classDesc",
          g_UIClassDescriptions[g_UIGloballySelectedSiegeClass].desc);
    ...
    if (!g_siegedFeederForcedSet) {
      g_UIGloballySelectedSiegeClass =
          UI_SiegeClassNum(siegeTeam2->classes[index]);
      trap->Cvar_Set(
          "ui_classDesc",
          g_UIClassDescriptions[g_UIGloballySelectedSiegeClass].desc);
    ...
    if (uiForceSide == FORCE_LIGHTSIDE) {
      ...
      if (newindex >= uiInfo.forceConfigCount ||
          newindex > uiInfo.forceConfigLightIndexBegin) { // dark gets read in
                                                          // before light
        return qfalse;
      }
    }
    ...
    if (!checkValid || !checkValid[0]) { // this isn't a valid map to select, so
    ...
    if (feederID == FEEDER_MAPS) {
      ...
      // trap->Cvar_Set("ui_opponentModel",
    ...
    //		trap->Cvar_VariableStringBuffer( va("ui_class_weapondesc%i", index),
    //info, sizeof(info) ); 		trap->Cvar_Set( "ui_itemforceinvdesc", info );
  } else if (feederID == FEEDER_SIEGE_CLASS_INVENTORY) {
    //		trap->Cvar_VariableStringBuffer( va("ui_class_itemdesc%i", index),
    //info, sizeof(info) ); 		trap->Cvar_Set( "ui_itemforceinvdesc", info );
  } else if (feederID == FEEDER_SIEGE_CLASS_FORCE) {
    int i;
    //		int validCnt = 0;

    trap->Cvar_VariableStringBuffer(va("ui_class_power%i", index), info,
                                    sizeof(info));
...
void UI_LoadForceConfig_List(void) {
  ...
  Com_sprintf(uiInfo.forceConfigNames[uiInfo.forceConfigCount],
              sizeof(uiInfo.forceConfigNames[uiInfo.forceConfigCount]),
              "Custom");
...
nextSearch:
  ...
  for (j = 0; j < numfiles && uiInfo.forceConfigCount < MAX_FORCE_CONFIGS;
       j++, fileptr += filelen + 1) {
    filelen = strlen(fileptr);
    COM_StripExtension(fileptr, configname, sizeof(configname));

    if (lightSearch) {
      uiInfo.forceConfigSide[uiInfo.forceConfigCount] =
          qtrue; // light side config
    } else {
      uiInfo.forceConfigSide[uiInfo.forceConfigCount] =
          qfalse; // dark side config
    }
...
static qboolean bIsImageFile(const char *dirptr, const char *skinname) {
  ...
  Com_sprintf(fpath, MAX_QPATH, "models/players/%s/icon_%s.jpg", dirptr,
              skinname);
  trap->FS_Open(fpath, &f, FS_READ);
  if (!f) { // not there, try png
    Com_sprintf(fpath, MAX_QPATH, "models/players/%s/icon_%s.png", dirptr,
                skinname);
    trap->FS_Open(fpath, &f, FS_READ);
  }
  if (!f) { // not there, try tga
    Com_sprintf(fpath, MAX_QPATH, "models/players/%s/icon_%s.tga", dirptr,
                skinname);
    trap->FS_Open(fpath, &f, FS_READ);
  }
  if (f) {
...
static void UI_BuildQ3Model_List(void) {
  ...
  dirptr = dirlist;
  for (i = 0; i < numdirs && uiInfo.q3HeadCount < MAX_Q3PLAYERMODELS;
       i++, dirptr += dirlen + 1) {
    ...
    numfiles = trap->FS_GetFileList(va("models/players/%s", dirptr), "skin",
                                    filelist, 2048);
    fileptr = filelist;
    for (j = 0; j < numfiles && uiInfo.q3HeadCount < MAX_Q3PLAYERMODELS;
         j++, fileptr += filelen + 1) {
      int skinLen = 0;
      ...
      /*
      Com_sprintf(fpath, 2048, "models/players/%s/icon%s.jpg", dirptr,
      skinname);
      ...
      */
      check = &skinname[1];
      if (bIsImageFile(dirptr, check)) { // if it exists
        ...
        uiInfo.q3HeadIcons[uiInfo.q3HeadCount++] =
            0; // trap->R_RegisterShaderNoMip(fpath);
        // rww - we are now registering them as they are drawn like the TA
        // feeder, so as to decrease UI load time.
      }
...
static qboolean UI_ParseColorData(char *buf, playerSpeciesInfo_t *species,
  ...
  species->ColorMax = 16;
  species->Color =
      (playerColor_t *)malloc(species->ColorMax * sizeof(playerColor_t));
  ...
  while (p) {
    ...
    if (species->ColorCount >= species->ColorMax) {
      species->ColorMax *= 2;
      species->Color = (playerColor_t *)realloc(
          species->Color, species->ColorMax * sizeof(playerColor_t));
    }
...
static void UI_BuildPlayerModel_List(qboolean inGameLoad) {
  ...
  for (i = 0; i < numdirs; i++, dirptr += dirlen + 1) {
    ...
    Com_sprintf(fpath, sizeof(fpath), "models/players/%s/PlayerChoice.txt",
                dirptr);
    ...
    if (f) {
      ...
      if (!UI_ParseColorData(buffer, species, fpath)) {
        Com_Printf(S_COLOR_RED
                   "UI_BuildPlayerModel_List: Errors parsing '%s'\n",
                   fpath);
      }
      ...
      species->SkinHead =
          (skinName_t *)malloc(species->SkinHeadMax * sizeof(skinName_t));
      species->SkinTorso =
          (skinName_t *)malloc(species->SkinTorsoMax * sizeof(skinName_t));
      species->SkinLeg =
          (skinName_t *)malloc(species->SkinLegMax * sizeof(skinName_t));
      ...
      for (j = 0; j < numfiles; j++, fileptr += filelen + 1) {
        if (trap->Cvar_VariableValue("fs_copyfiles") > 0) {
          trap->FS_Open(va("models/players/%s/%s", dirptr, fileptr), &f,
                        FS_READ);
          if (f)
            trap->FS_Close(f);
        }
        ...
        if (bIsImageFile(dirptr, skinname)) { // if it exists
          if (Q_stricmpn(skinname, "head_", 5) == 0) {
            ...
            Q_strncpyz(species->SkinLeg[species->SkinLegCount++].name, skinname,
                       SKIN_LENGTH);
            iSkinParts |= 1 << 2;
          }
        }
      }
      if (iSkinParts != 7) { // didn't get a skin for each, then skip this
                             // model.
      ...
      if (!inGameLoad && ui_PrecacheModels.integer) {
        int g2Model;
        void *ghoul2 = 0;
        Com_sprintf(fpath, sizeof(fpath), "models/players/%s/model.glm",
                    dirptr);
...
void UI_Init(qboolean inGameLoad) {
  ...
  uiInfo.languageCount =
      trap->SE_GetNumLanguages(); // this does a dir scan, so use carefully
  ...
  uiInfo.uiDC.AnyLanguage_ReadCharFromString =
      trap->R_AnyLanguage_ReadCharFromString;
  ...
  trap->Cvar_Set("ui_mousePitch",
                 (trap->Cvar_VariableValue("m_pitch") >= 0) ? "0" : "1");
  trap->Cvar_Set("ui_mousePitchVeh",
                 (trap->Cvar_VariableValue("m_pitchVeh") >= 0) ? "0" : "1");
...
void UI_Refresh(int realtime) {
  ...
  if (ui_rankChange.integer) {
    ...
    if (!parsedFPMessage[0] /*&& uiMaxRank > ui_rankChange.integer*/) {
      const char *printMessage =
          UI_GetStringEdString("MP_INGAME", "SET_NEW_RANK");
    ...
    // if (uiMaxRank > ui_rankChange.integer)
    {
      ...
      */
      ...
      // Use BG_LegalizedForcePowers and transfer the result into the UI force
      // settings
      UI_ReadLegalForce();
    }
  ...
  if (parsedFPMessage[0] && FPMessageTime > realtime)
  {
          ...
          Text_Paint(10, 0, 1, txtCol, parsedFPMessage, 0, 1024, txtStyle,
  FONT_MEDIUM);
  }
  */
...
static void UI_DisplayDownloadInfo(const char *downloadName, float centerPoint,
  ...
  s = GetCRDelineatedString("MENUS", "DOWNLOAD_STUFF",
  ...
  Text_PaintCenter(centerPoint, yStart + 112, scale, colorWhite, sDownLoading,
                   0, iMenuFont);
  Text_PaintCenter(centerPoint, yStart + 192, scale, colorWhite,
                   sEstimatedTimeLeft, 0, iMenuFont);
  Text_PaintCenter(centerPoint, yStart + 248, scale, colorWhite, sTransferRate,
                   0, iMenuFont);
  ...
  if (downloadCount < 4096 || !downloadTime) {
    ...
    Text_PaintCenter(leftWidth, yStart + 160, scale, colorWhite,
                     va("(%s %s %s %s)", dlSizeBuf, sOf, totalSizeBuf, sCopied),
                     0, iMenuFont);
  } else {
    ...
    if (downloadSize && xferRate) {
      ...
      Text_PaintCenter(leftWidth, yStart + 216, scale, colorWhite, dlTimeBuf, 0,
                       iMenuFont);
      Text_PaintCenter(
          leftWidth, yStart + 160, scale, colorWhite,
          va("(%s %s %s %s)", dlSizeBuf, sOf, totalSizeBuf, sCopied), 0,
          iMenuFont);
    } else {
      Text_PaintCenter(leftWidth, yStart + 216, scale, colorWhite, "estimating",
                       0, iMenuFont);
      if (downloadSize) {
        ...
        Text_PaintCenter(leftWidth, yStart + 160, scale, colorWhite,
                         va("(%s %s)", dlSizeBuf, sCopied), 0, iMenuFont);
      }
    }

    if (xferRate) {
      Text_PaintCenter(leftWidth, yStart + 272, scale, colorWhite,
                       va("%s/%s", xferRateBuf, sSec), 0, iMenuFont);
    }
  }
}
...
void UI_DrawConnectScreen(qboolean overlay) {
  ...
  info[0] = '\0';
  if (trap->GetConfigString(CS_SERVERINFO, info, sizeof(info))) {
    trap->SE_GetStringTextString("MENUS_LOADING_MAPNAME", sStringEdTemp,
                                 sizeof(sStringEdTemp));
    Text_PaintCenter(
        centerPoint, yStart, scale, colorWhite,
        va(/*"Loading %s"*/ sStringEdTemp, Info_ValueForKey(info, "mapname")),
        0, FONT_MEDIUM);
  }

  if (!Q_stricmp(cstate.servername, "localhost")) {
    trap->SE_GetStringTextString("MENUS_STARTING_UP", sStringEdTemp,
                                 sizeof(sStringEdTemp));
    Text_PaintCenter(centerPoint, yStart + 48, scale, colorWhite, sStringEdTemp,
                     ITEM_TEXTSTYLE_SHADOWEDMORE, FONT_MEDIUM);
  } else {
    trap->SE_GetStringTextString("MENUS_CONNECTING_TO", sStringEdTemp,
                                 sizeof(sStringEdTemp));
    Q_strncpyz(text,
               va(/*"Connecting to %s"*/ sStringEdTemp, cstate.servername),
               sizeof(text));
  ...
  Text_PaintCenter(centerPoint, 425, scale, colorWhite,
                   Info_ValueForKey(cstate.updateInfoString, "motd"), 0,
                   FONT_MEDIUM);
  // print any server info (server full, bad version, etc)
  if (cstate.connState < CA_CONNECTED) {
    Text_PaintCenter(centerPoint, yStart + 176, scale, colorWhite,
                     cstate.messageString, 0, FONT_MEDIUM);
  }

  switch (cstate.connState) {
  case CA_CONNECTING: {
    trap->SE_GetStringTextString("MENUS_AWAITING_CONNECTION", sStringEdTemp,
                                 sizeof(sStringEdTemp));
    s = va(/*"Awaiting connection...%i"*/ sStringEdTemp,
           cstate.connectPacketCount);
  } break;
  case CA_CHALLENGING: {
    trap->SE_GetStringTextString("MENUS_AWAITING_CHALLENGE", sStringEdTemp,
                                 sizeof(sStringEdTemp));
    s = va(/*"Awaiting challenge...%i"*/ sStringEdTemp,
           cstate.connectPacketCount);
  } break;
  case CA_CONNECTED: {
    char downloadName[MAX_INFO_VALUE];

    trap->Cvar_VariableStringBuffer("cl_downloadName", downloadName,
                                    sizeof(downloadName));
    if (*downloadName) {
    ...
    trap->SE_GetStringTextString("MENUS_AWAITING_GAMESTATE", sStringEdTemp,
                                 sizeof(sStringEdTemp));
...
static void UI_StopServerRefresh(void) {
  ...
  if (count - uiInfo.serverStatus.numDisplayServers > 0) {
    Com_Printf("%d servers not listed due to filters, packet loss, invalid "
               "info, or pings higher than %d\n",
...
static void UI_StartServerRefresh(qboolean full) {
  ...
  trap->Cvar_Set(va("ui_lastServerRefresh_%i", ui_netSource.integer),
                 va("%s-%i, %i @ %i:%02i", GetMonthAbbrevString(q.tm_mon),
...
Q_EXPORT intptr_t vmMain(int command, intptr_t arg0, intptr_t arg1,
