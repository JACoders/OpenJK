...
#define SNAPFLAG_RATE_DELAYED                                                  \
  1 // the server withheld a packet to save bandwidth
#define SNAPFLAG_DROPPED_COMMANDS                                              \
  2 // the server lost some cmds coming from the client
...
struct snapshot_s {
  ...
  int configstringNum; // acknowledged snapshot_t (which is usually NOT the
                       // previous snapshot!)
