...
int ICARUS_Instance::SaveSequenceIDTable(void) {
  ...
  m_interface->I_WriteSaveData(INT_ID('#', 'S', 'E', 'Q'), &numSequences,
                               sizeof(numSequences));
  ...
  m_interface->I_WriteSaveData(INT_ID('S', 'Q', 'T', 'B'), idTable,
...
int ICARUS_Instance::SaveSequencers(void) {
  ...
  m_interface->I_WriteSaveData(INT_ID('#', 'S', 'Q', 'R'), &numSequencers,
                               sizeof(numSequencers));
...
int ICARUS_Instance::SaveSignals(void) {
  ...
  STL_ITERATE(si, m_signals) {
    ...
    m_interface->I_WriteSaveData(INT_ID('S', 'I', 'G', '#'), &length,
                                 sizeof(length));

    // Write out the string
    m_interface->I_WriteSaveData(INT_ID('S', 'I', 'G', 'N'), (void *)name,
                                 length);
  }
...
int ICARUS_Instance::Save(void) {
  ...
  m_interface->I_WriteSaveData(INT_ID('I', 'C', 'A', 'R'), &version,
                               sizeof(version));
  ...
  m_interface->I_WriteSaveData(INT_ID('I', 'E', 'N', 'D'), &version,
                               sizeof(version));
...
int ICARUS_Instance::LoadSignals(void) {
  ...
  m_interface->I_ReadSaveData(INT_ID('I', 'S', 'I', 'G'), &numSignals,
                              sizeof(numSignals));
  ...
  for (int i = 0; i < numSignals; i++) {
    ...
    m_interface->I_ReadSaveData(INT_ID('S', 'I', 'G', '#'), &length,
                                sizeof(length));
...
int ICARUS_Instance::LoadSequences(void) {
  ...
  m_interface->I_ReadSaveData(INT_ID('#', 'S', 'E', 'Q'), &numSequences,
                              sizeof(numSequences));
  ...
  m_interface->I_ReadSaveData(INT_ID('S', 'Q', 'T', 'B'), idTable,
                              sizeof(int) * numSequences);
...
int ICARUS_Instance::LoadSequencers(void) {
  ...
  m_interface->I_ReadSaveData(INT_ID('#', 'S', 'Q', 'R'), &numSequencers,
                              sizeof(numSequencers));
...
int ICARUS_Instance::Load(void) {
  ...
  double version;
  m_interface->I_ReadSaveData(INT_ID('I', 'C', 'A', 'R'), &version,
                              sizeof(version));
  ...
  m_interface->I_ReadSaveData(INT_ID('I', 'E', 'N', 'D'), &version,
                              sizeof(version));
