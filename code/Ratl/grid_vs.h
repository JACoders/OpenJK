...
// Grid
// ----
// There are two versions of the Grid class.  Simply, they apply a discreet
// function mapping from a n dimensional space to a linear aray.
//
//
//
//
...
public:
  ...
  public:
    ...
    //-----------------------------------------
    bool onColZero() { return (mLoc % XSIZE_MAX) == 0; }
  ...
  // Iterator End
  ////////////////////////////////////////////////////////////////////////////////////
  iterator end() { return iterator(this, (XSIZE_MAX * YSIZE_MAX)); }
  ...
  public:
    ...
    // Dereference Operator
    //----------------------
    T &operator*() { return (mOwner->get(mLoc[0], mLoc[1])); }
    ...
    bool at_end() { return (mLoc[1] > mMaxs[1]); }

    // Return True If On Frist Column Of A Row
    //-----------------------------------------
    bool onColZero() { return (mLoc[0] == mMins[0]); }
