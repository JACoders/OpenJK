...
XCVAR_DEF( zyk_lightning_dome_cooldown,	"28000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_magic_explosion_cooldown,	"32000",	NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
...
XCVAR_DEF( zyk_ultra_flame_cooldown,	"9000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
...
XCVAR_DEF( zyk_slow_motion_cooldown,	"8000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_ultra_resistance_cooldown,	"5000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_sleeping_flowers_cooldown,	"15000",	NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_healing_water_cooldown,	"9000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_flame_burst_cooldown,	"10000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_earthquake_cooldown,	"8000",				NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
...
XCVAR_DEF( zyk_ultra_drain_cooldown,	"22000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_immunity_power_cooldown,	"20000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_chaos_power_cooldown,	"25000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_time_power_cooldown,	"22000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
...
XCVAR_DEF( zyk_lightning_dome_mp_cost,	"10",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_magic_explosion_mp_cost,	"20",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
...
XCVAR_DEF( zyk_dome_of_damage_mp_cost,	"23",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
