...
extern void TieFighterUse(gentity_t *self, gentity_t *other,
                          gentity_t *activator);
...
extern void ammo_power_converter_use(gentity_t *self, gentity_t *other,
                                     gentity_t *activator);
extern void bomb_planted_use(gentity_t *self, gentity_t *other,
                             gentity_t *activator);
...
extern void item_spawn_use(gentity_t *self, gentity_t *other,
                           gentity_t *activator);
extern void NPC_VehicleSpawnUse(gentity_t *self, gentity_t *other,
                                gentity_t *activator);
extern void misc_weapon_shooter_use(gentity_t *self, gentity_t *other,
                                    gentity_t *activator);
...
extern void misc_model_breakable_pain(gentity_t *self, gentity_t *inflictor,
                                      gentity_t *attacker, const vec3_t point,
                                      int damage, int mod,
                                      int hitLoc = HL_NONE);
...
extern void NPC_Howler_Pain(gentity_t *self, gentity_t *inflictor,
                            gentity_t *attacker, const vec3_t point, int damage,
                            int mod, int hitLoc = HL_NONE);
extern void NPC_Rancor_Pain(gentity_t *self, gentity_t *inflictor,
                            gentity_t *attacker, const vec3_t point, int damage,
                            int mod, int hitLoc = HL_NONE);
extern void NPC_Wampa_Pain(gentity_t *self, gentity_t *inflictor,
                           gentity_t *attacker, const vec3_t point, int damage,
                           int mod, int hitLoc = HL_NONE);
extern void NPC_SandCreature_Pain(gentity_t *self, gentity_t *inflictor,
                                  gentity_t *attacker, const vec3_t point,
                                  int damage, int mod, int hitLoc = HL_NONE);
...
extern void TurretPain(gentity_t *self, gentity_t *inflictor,
                       gentity_t *attacker, const vec3_t point, int damage,
                       int mod, int hitLoc = HL_NONE);
extern void eweb_pain(gentity_t *self, gentity_t *inflictor,
                      gentity_t *attacker, const vec3_t point, int damage,
                      int mod, int hitLoc = HL_NONE);
...
extern void thermal_die(gentity_t *self, gentity_t *inflictor,
                        gentity_t *attacker, int damage, int mod,
                        int dFlags = 0, int hitLoc = HL_NONE);
extern void eweb_die(gentity_t *self, gentity_t *inflictor, gentity_t *attacker,
