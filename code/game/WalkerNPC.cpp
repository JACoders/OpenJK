...
#ifdef _JK2MP
extern void FighterYawAdjust(Vehicle_t *pVeh, playerState_t *riderPS,
                             playerState_t *parentPS); // FighterNPC.c
extern void FighterPitchAdjust(Vehicle_t *pVeh, playerState_t *riderPS,
                               playerState_t *parentPS); // FighterNPC.c
#endif
