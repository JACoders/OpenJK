...
// fixme, this could be made more efficient by keepingtrack of the highest slot
// ever used then there is no need to fill the free list
template <class T> class pool_root : public ratl_base {
public:
...
public:
  ...
  // Constructor
  ////////////////////////////////////////////////////////////////////////////////////
  pool_root() : mSize(0) { FillFreeList(); }
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  bool is_used_index(int i) const { return mUsed[i]; }
  ...
  int pointer_to_index(const TTValue *me) const {
    ...
    assert(
        mUsed[index]); // I am disallowing obtaining the index of a freed item
  ...
  // The Deallocator
  ////////////////////////////////////////////////////////////////////////////////////
  void free(TTValue *me) { free(pointer_to_index(me)); }
  ...
  public:
    ...
    {
      assert(mIndex >= 0 &&
             mIndex < CAPACITY); // this typically means you did end()++
      assert(mOwner && mOwner->is_used_index(mIndex));
  ...
  // Get An Iterator To The End Of The Memroy (One Step Beyond)
  ////////////////////////////////////////////////////////////////////////////////////
  const_iterator end() const { return iterator(this, CAPACITY); }
...
template <class T> class pool_base : public pool_root<T> {
public:
  typedef typename T::TValue TTValue;
  ...
  // Accessor
  ////////////////////////////////////////////////////////////////////////////////////
  TTValue &operator[](int i) { return pool_root<T>::value_at_index(i); }

  bool is_used(int i) const { return pool_root<T>::is_used_index(i); }

  ////////////////////////////////////////////////////////////////////////////////////
  // Swap two items based on index
  ////////////////////////////////////////////////////////////////////////////////////
  void swap(int i, int j) { pool_root<T>::swap_index(i, j); }

  ////////////////////////////////////////////////////////////////////////////////////
  // The Allocator	returns an index
  ////////////////////////////////////////////////////////////////////////////////////
  int alloc() { return pool_root<T>::alloc_index(); }

  ////////////////////////////////////////////////////////////////////////////////////
  // The Allocator	returns an index
  ////////////////////////////////////////////////////////////////////////////////////
  int alloc(const TTValue &v) { return pool_root<T>::alloc_index(v); }

  ////////////////////////////////////////////////////////////////////////////////////
  // The Deallocator
  ////////////////////////////////////////////////////////////////////////////////////
  void free(int i) { pool_root<T>::free_index(i); }
