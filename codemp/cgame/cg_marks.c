...
void CG_ImpactMark(qhandle_t markShader, const vec3_t origin, const vec3_t dir,
  ...
  if (!cg_marks.integer) {
    ...
    trap->R_AddDecalToScene(markShader, origin, dir, orientation, red, green,
                            blue, alpha, alphaFade, radius, temporary);
    return;
  }
  ...
  numFragments = trap->R_MarkFragments(
      4, (const vec3_t *)originalPoints, projection, MAX_MARK_POINTS,
