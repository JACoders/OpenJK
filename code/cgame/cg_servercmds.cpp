...
void CG_ParseServerinfo(void) {
  ...
  // FIXME: a better way to handle sound-matched strings from other levels
  // (currently uses levelname+sound as key)
  ...
  /*	// JK2...
          ...
          {
                  strcpy( cgs.stripLevelName[1], "ARTUS_TOPSIDE" );	// for
     dream sequence...

                  strcpy( cgs.stripLevelName[2], "BESPIN_UNDERCITY" );	// for
     dream sequence...
          }
