...
void SV_Init(void) {
  ...
  sv_snapsMin =
      Cvar_Get("sv_snapsMin", "10", CVAR_ARCHIVE_ND); // 1 <=> sv_snapsMax
  sv_snapsMax =
      Cvar_Get("sv_snapsMax", "40", CVAR_ARCHIVE_ND); // sv_snapsMin <=> sv_fps
  ...
  sv_fps =
      Cvar_Get("sv_fps", "40", CVAR_SERVERINFO, "Server frames per second");
