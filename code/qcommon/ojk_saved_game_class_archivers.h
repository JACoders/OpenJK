...
template <> class SavedGameClassArchiver<cplane_t> {
public:
  enum { is_implemented = true };

  static void sg_export(SavedGameHelper &saved_game, const cplane_t &instance) {
  ...
  static void sg_import(SavedGameHelper &saved_game, cplane_t &instance) {
