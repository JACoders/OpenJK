...
void CG_DrawActiveFrame(int serverTime, stereoFrame_t stereoView) {
	...
	cg.renderingThirdPerson =
		(qboolean)(cg_thirdPerson.integer || (cg.snap->ps.stats[STAT_HEALTH] <= 0) || (g_entities[0].client && g_entities[0].client->NPC_class == CLASS_ATST));
	...
	} else if (cg.snap->ps.viewEntity != 0 && cg.snap->ps.viewEntity < ENTITYNUM_WORLD && g_entities[cg.snap->ps.viewEntity].client) {
