...
// this file corresponds 1:1 with the "*.fontdat" files, so don't change it
...
typedef struct dfontdat_s {
  ...
  short mKoreanHack; // unused field, written out by John's fontgen program but
                     // we have to leave it there for disk structs <sigh>
} dfontdat_t;
