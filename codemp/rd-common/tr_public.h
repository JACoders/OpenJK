...
typedef struct refexport_s {
  ...
  void (*AddDecalToScene)(qhandle_t shader, const vec3_t origin,
                          const vec3_t dir, float orientation, float r, float g,
                          float b, float a, qboolean alphaFade, float radius,
                          qboolean temporary);
  ...
  void (*SetRefractionProperties)(float distortionAlpha,
  ...
  qboolean (*G2API_AttachEnt)(int *boltInfo, CGhoul2Info_v &ghoul2,
                              int modelIndex, int toBoltIndex, int entNum,
                              int toModelNum);
  qboolean (*G2API_AttachG2Model)(CGhoul2Info_v &ghoul2From, int modelFrom,
                                  CGhoul2Info_v &ghoul2To, int toBoltIndex,
                                  int toModel);
  void (*G2API_AttachInstanceToEntNum)(CGhoul2Info_v &ghoul2, int entityNum,
                                       qboolean server);
  ...
  void (*G2API_CollisionDetect)(CollisionRecord_t *collRecMap,
                                ...
                                vec3_t scale, IHeapAllocator *G2VertSpace,
  ...
  qboolean (*G2API_GetBoneAnim)(CGhoul2Info_v &ghoul2, int modelIndex,
                                ...
                                int *endFrame, int *flags, float *animSpeed,
                                qhandle_t *modelList);
  ...
  char *(*G2API_GetSurfaceName)(CGhoul2Info_v &ghlInfo, int modelIndex,
                                int surfNumber);
  ...
  qboolean (*G2API_OverrideServerWithClientData)(CGhoul2Info_v &serverInstance,
                                                 int modelIndex);
  ...
  qboolean (*G2API_SaveGhoul2Models)(CGhoul2Info_v &ghoul2, char **buffer,
                                     int *size);
  void (*G2API_SetBoltInfo)(CGhoul2Info_v &ghoul2, int modelIndex,
                            int boltInfo);
  ...
  qboolean (*G2API_SetBoneAnim)(CGhoul2Info_v &ghoul2, const int modelIndex,
                                ...
                                const float setFrame /*= -1*/,
                                const int blendTime /*= -1*/);
  ...
  qboolean (*G2API_SetSurfaceOnOff)(CGhoul2Info_v &ghoul2,
...
typedef struct refimport_s {
  ...
  void(QDECL *Error)(int errorLevel, const char *fmt, ...) NORETURN_PTR
      __attribute__((format(printf, 2, 3)));
  void(QDECL *OPrintf)(const char *fmt, ...)
  ...
  void *(*Z_Malloc)(
      int iSize, memtag_t eTag, qboolean bZeroit /*= qfalse*/,
