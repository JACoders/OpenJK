...
int R_GetNumVertices(const SMikkTSpaceContext *pContext, const int iFace) { return 3; }
...
void R_SetBSPTSpaceBasic(const SMikkTSpaceContext *pContext, const float *fvTangent, const float fSign, const int iFace, const int iVert) {
	...
	if (vertex.tangent == 0u)
		vertex.tangent = (((uint32_t)(fSign * 1.5f + 2.0f)) << 30) | (((uint32_t)(fvTangent[2] * 511.5f + 512.0f)) << 20) |
						 (((uint32_t)(fvTangent[1] * 511.5f + 512.0f)) << 10) | (((uint32_t)(fvTangent[0] * 511.5f + 512.0f)));
}
...
void R_SetModelTSpaceBasic(const SMikkTSpaceContext *pContext, const float *fvTangent, const float fSign, const int iFace, const int iVert) {
	...
	tangent = (((uint32_t)(fSign * 1.5f + 2.0f)) << 30) | (((uint32_t)(fvTangent[2] * 511.5f + 512.0f)) << 20) |
			  (((uint32_t)(fvTangent[1] * 511.5f + 512.0f)) << 10) | (((uint32_t)(fvTangent[0] * 511.5f + 512.0f)));
}
