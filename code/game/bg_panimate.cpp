...
extern void WP_ForcePowerDrain(gentity_t *self, forcePowers_t forcePower,
                               int overrideAmt);
...
extern qboolean G_TryingPullAttack(gentity_t *self, usercmd_t *cmd,
                                   qboolean amPulling);
...
// Okay, here lies the much-dreaded Pat-created FSM movement chart...  Heretic
// II strikes again! Why am I inflicting this on you?  Well, it's better than
// hardcoded states. Ideally this will be replaced with an external file or more
// sophisticated move-picker once the game gets out of prototype stage.
...
saberMoveData_t saberMoveData[LS_MOVE_MAX] = {
    //							NB:randomized
    // name			anim(do all styles?)startQ	endQ	setanimflag		blend,	blocking
    // chain_idle		chain_attack	trailLen
    {"None", BOTH_STAND1, Q_R, Q_R, AFLAG_IDLE, 350, BLK_NO, LS_NONE, LS_NONE,
     0}, // LS_NONE		= 0,

    // General movements with saber
    {"Ready", BOTH_STAND2, Q_R, Q_R, AFLAG_IDLE, 350, BLK_WIDE, LS_READY,
     LS_S_R2L, 0}, // LS_READY,
    {"Draw", BOTH_STAND1TO2, Q_R, Q_R, AFLAG_FINISH, 350, BLK_NO, LS_READY,
     LS_S_R2L, 0}, // LS_DRAW,
    {"Putaway", BOTH_STAND2TO1, Q_R, Q_R, AFLAG_FINISH, 350, BLK_NO, LS_READY,
     LS_S_R2L, 0}, // LS_PUTAWAY,

    // Attacks
    // UL2LR
    {"TL2BR Att", BOTH_A1_TL_BR, Q_TL, Q_BR, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_R_TL2BR, LS_R_TL2BR, 200}, // LS_A_TL2BR
    // SLASH LEFT
    {"L2R Att", BOTH_A1__L__R, Q_L, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT, LS_R_L2R,
     LS_R_L2R, 200}, // LS_A_L2R
    // LL2UR
    {"BL2TR Att", BOTH_A1_BL_TR, Q_BL, Q_TR, AFLAG_ACTIVE, 50, BLK_TIGHT,
     LS_R_BL2TR, LS_R_BL2TR, 200}, // LS_A_BL2TR
    // LR2UL
    {"BR2TL Att", BOTH_A1_BR_TL, Q_BR, Q_TL, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_R_BR2TL, LS_R_BR2TL, 200}, // LS_A_BR2TL
    // SLASH RIGHT
    {"R2L Att", BOTH_A1__R__L, Q_R, Q_L, AFLAG_ACTIVE, 100, BLK_TIGHT, LS_R_R2L,
     LS_R_R2L, 200}, // LS_A_R2L
    // UR2LL
    {"TR2BL Att", BOTH_A1_TR_BL, Q_TR, Q_BL, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_R_TR2BL, LS_R_TR2BL, 200}, // LS_A_TR2BL
    // SLASH DOWN
    {"T2B Att", BOTH_A1_T__B_, Q_T, Q_B, AFLAG_ACTIVE, 100, BLK_TIGHT, LS_R_T2B,
     LS_R_T2B, 200}, // LS_A_T2B
    // special attacks
    {"Back Stab", BOTH_A2_STABBACK1, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_A_BACKSTAB
    {"Back Att", BOTH_ATTACK_BACK, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_A_BACK
    {"CR Back Att", BOTH_CROUCHATTACKBACK1, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_READY, 200}, // LS_A_BACK_CR
    {"RollStab", BOTH_ROLL_STAB, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_ROLL_STAB
    {"Lunge Att", BOTH_LUNGE2_B__T_, Q_B, Q_T, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_A_LUNGE
    {"Jump Att", BOTH_FORCELEAP2_T__B_, Q_T, Q_B, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_A_JUMP_T__B_
    {"Flip Stab", BOTH_JUMPFLIPSTABDOWN, Q_R, Q_T, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_T1_T___R, 200}, // LS_A_FLIP_STAB
    {"Flip Slash", BOTH_JUMPFLIPSLASHDOWN1, Q_L, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_T1__R_T_, 200}, // LS_A_FLIP_SLASH
    {"DualJump Atk", BOTH_JUMPATTACK6, Q_R, Q_BL, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_T1_BL_TR, 200}, // LS_JUMPATTACK_DUAL

    {"DualJumpAtkL_A", BOTH_ARIAL_LEFT, Q_R, Q_TL, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_A_TL2BR, 200}, // LS_JUMPATTACK_ARIAL_LEFT
    {"DualJumpAtkR_A", BOTH_ARIAL_RIGHT, Q_R, Q_TR, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_A_TR2BL, 200}, // LS_JUMPATTACK_ARIAL_RIGHT

    {"DualJumpAtkL_A", BOTH_CARTWHEEL_LEFT, Q_R, Q_TL, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_T1_TL_BR, 200}, // LS_JUMPATTACK_CART_LEFT
    {"DualJumpAtkR_A", BOTH_CARTWHEEL_RIGHT, Q_R, Q_TR, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_T1_TR_BL, 200}, // LS_JUMPATTACK_CART_RIGHT

    {"DualJumpAtkLStaff", BOTH_BUTTERFLY_FL1, Q_R, Q_L, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_T1__L__R, 200}, // LS_JUMPATTACK_STAFF_LEFT
    {"DualJumpAtkRStaff", BOTH_BUTTERFLY_FR1, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_T1__R__L, 200}, // LS_JUMPATTACK_STAFF_RIGHT

    {"ButterflyLeft", BOTH_BUTTERFLY_LEFT, Q_R, Q_L, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_T1__L__R, 200}, // LS_BUTTERFLY_LEFT
    {"ButterflyRight", BOTH_BUTTERFLY_RIGHT, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_T1__R__L, 200}, // LS_BUTTERFLY_RIGHT

    {"BkFlip Atk", BOTH_JUMPATTACK7, Q_B, Q_T, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_T1_T___R, 200}, // LS_A_BACKFLIP_ATK
    {"DualSpinAtk", BOTH_SPINATTACK6, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_SPINATTACK_DUAL
    {"StfSpinAtk", BOTH_SPINATTACK7, Q_L, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_SPINATTACK
    {"LngLeapAtk", BOTH_FORCELONGLEAP_ATTACK, Q_R, Q_L, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_READY, 200}, // LS_LEAP_ATTACK
    {"SwoopAtkR", BOTH_VS_ATR_S, Q_R, Q_T, AFLAG_ACTIVE, 100, BLK_NO, LS_READY,
     LS_READY, 200}, // LS_SWOOP_ATTACK_RIGHT
    {"SwoopAtkL", BOTH_VS_ATL_S, Q_L, Q_T, AFLAG_ACTIVE, 100, BLK_NO, LS_READY,
     LS_READY, 200}, // LS_SWOOP_ATTACK_LEFT
    {"TauntaunAtkR", BOTH_VT_ATR_S, Q_R, Q_T, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_TAUNTAUN_ATTACK_RIGHT
    {"TauntaunAtkL", BOTH_VT_ATL_S, Q_L, Q_T, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_TAUNTAUN_ATTACK_LEFT
    {"StfKickFwd", BOTH_A7_KICK_F, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_S_R2L, 200}, // LS_KICK_F
    {"StfKickBack", BOTH_A7_KICK_B, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_S_R2L, 200}, // LS_KICK_B
    {"StfKickRight", BOTH_A7_KICK_R, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_S_R2L, 200}, // LS_KICK_R
    {"StfKickLeft", BOTH_A7_KICK_L, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_S_R2L, 200}, // LS_KICK_L
    {"StfKickSpin", BOTH_A7_KICK_S, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_S_R2L, 200}, // LS_KICK_S
    {"StfKickBkFwd", BOTH_A7_KICK_BF, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_S_R2L, 200}, // LS_KICK_BF
    {"StfKickSplit", BOTH_A7_KICK_RL, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_S_R2L, 200}, // LS_KICK_RL
    {"StfKickFwdAir", BOTH_A7_KICK_F_AIR, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_S_R2L, 200}, // LS_KICK_F_AIR
    {"StfKickBackAir", BOTH_A7_KICK_B_AIR, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_S_R2L, 200}, // LS_KICK_B_AIR
    {"StfKickRightAir", BOTH_A7_KICK_R_AIR, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_S_R2L, 200}, // LS_KICK_R_AIR
    {"StfKickLeftAir", BOTH_A7_KICK_L_AIR, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_S_R2L, 200}, // LS_KICK_L_AIR
    {"StabDown", BOTH_STABDOWN, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_S_R2L, 200}, // LS_STABDOWN
    {"StabDownStf", BOTH_STABDOWN_STAFF, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_S_R2L, 200}, // LS_STABDOWN_STAFF
    {"StabDownDual", BOTH_STABDOWN_DUAL, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_S_R2L, 200}, // LS_STABDOWN_DUAL
    {"dualspinprot", BOTH_A6_SABERPROTECT, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_READY, 500}, // LS_DUAL_SPIN_PROTECT
    {"StfSoulCal", BOTH_A7_SOULCAL, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 500}, // LS_STAFF_SOULCAL
    {"specialfast", BOTH_A1_SPECIAL, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 2000}, // LS_A1_SPECIAL
    {"specialmed", BOTH_A2_SPECIAL, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 2000}, // LS_A2_SPECIAL
    {"specialstr", BOTH_A3_SPECIAL, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 2000}, // LS_A3_SPECIAL
    {"upsidedwnatk", BOTH_FLIP_ATTACK7, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_UPSIDE_DOWN_ATTACK
    {"pullatkstab", BOTH_PULL_IMPALE_STAB, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_READY, 200}, // LS_PULL_ATTACK_STAB
    {"pullatkswing", BOTH_PULL_IMPALE_SWING, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_READY, 200}, // LS_PULL_ATTACK_SWING
    {"AloraSpinAtk", BOTH_ALORA_SPIN_SLASH, Q_R, Q_R, AFLAG_ACTIVE, 100,
     BLK_TIGHT, LS_READY, LS_READY, 200}, // LS_SPINATTACK_ALORA
    {"Dual FB Atk", BOTH_A6_FB, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_DUAL_FB
    {"Dual LR Atk", BOTH_A6_LR, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_DUAL_LR
    {"StfHiltBash", BOTH_A7_HILT, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_HILT_BASH

    // starts
    {"TL2BR St", BOTH_S1_S1_TL, Q_R, Q_TL, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_A_TL2BR, LS_A_TL2BR, 200}, // LS_S_TL2BR
    {"L2R St", BOTH_S1_S1__L, Q_R, Q_L, AFLAG_ACTIVE, 100, BLK_TIGHT, LS_A_L2R,
     LS_A_L2R, 200}, // LS_S_L2R
    {"BL2TR St", BOTH_S1_S1_BL, Q_R, Q_BL, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_A_BL2TR, LS_A_BL2TR, 200}, // LS_S_BL2TR
    {"BR2TL St", BOTH_S1_S1_BR, Q_R, Q_BR, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_A_BR2TL, LS_A_BR2TL, 200}, // LS_S_BR2TL
    {"R2L St", BOTH_S1_S1__R, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_TIGHT, LS_A_R2L,
     LS_A_R2L, 200}, // LS_S_R2L
    {"TR2BL St", BOTH_S1_S1_TR, Q_R, Q_TR, AFLAG_ACTIVE, 100, BLK_TIGHT,
     LS_A_TR2BL, LS_A_TR2BL, 200}, // LS_S_TR2BL
    {"T2B St", BOTH_S1_S1_T_, Q_R, Q_T, AFLAG_ACTIVE, 100, BLK_TIGHT, LS_A_T2B,
     LS_A_T2B, 200}, // LS_S_T2B

    // returns
    {"TL2BR Ret", BOTH_R1_BR_S1, Q_BR, Q_R, AFLAG_FINISH, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_R_TL2BR
    {"L2R Ret", BOTH_R1__R_S1, Q_R, Q_R, AFLAG_FINISH, 100, BLK_TIGHT, LS_READY,
     LS_READY, 200}, // LS_R_L2R
    {"BL2TR Ret", BOTH_R1_TR_S1, Q_TR, Q_R, AFLAG_FINISH, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_R_BL2TR
    {"BR2TL Ret", BOTH_R1_TL_S1, Q_TL, Q_R, AFLAG_FINISH, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_R_BR2TL
    {"R2L Ret", BOTH_R1__L_S1, Q_L, Q_R, AFLAG_FINISH, 100, BLK_TIGHT, LS_READY,
     LS_READY, 200}, // LS_R_R2L
    {"TR2BL Ret", BOTH_R1_BL_S1, Q_BL, Q_R, AFLAG_FINISH, 100, BLK_TIGHT,
     LS_READY, LS_READY, 200}, // LS_R_TR2BL
    {"T2B Ret", BOTH_R1_B__S1, Q_B, Q_R, AFLAG_FINISH, 100, BLK_TIGHT, LS_READY,
     LS_READY, 200}, // LS_R_T2B

    // Transitions
    {"BR2R Trans", BOTH_T1_BR__R, Q_BR, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_L2R, LS_A_R2L, 150}, //# Fast arc bottom right to right
    {"BR2TR Trans", BOTH_T1_BR_TR, Q_BR, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_TR2BL, 150}, //# Fast arc bottom right to top right
                                   //(use: BOTH_T1_TR_BR)
    {"BR2T Trans", BOTH_T1_BR_T_, Q_BR, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_T2B, 150}, //# Fast arc bottom right to top
                                 //(use: BOTH_T1_T__BR)
    {"BR2TL Trans", BOTH_T1_BR_TL, Q_BR, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_A_TL2BR, 150}, //# Fast weak spin bottom right to top left
    {"BR2L Trans", BOTH_T1_BR__L, Q_BR, Q_L, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_R2L, LS_A_L2R, 150}, //# Fast weak spin bottom right to left
    {"BR2BL Trans", BOTH_T1_BR_BL, Q_BR, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL, LS_A_BL2TR,
     150}, //# Fast weak spin bottom right to bottom left
    {"R2BR Trans", BOTH_T1__R_BR, Q_R, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_A_BR2TL, 150}, //# Fast arc right to bottom right
                                   //(use: BOTH_T1_BR__R)
    {"R2TR Trans", BOTH_T1__R_TR, Q_R, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_TR2BL, 150}, //# Fast arc right to top right
    {"R2T Trans", BOTH_T1__R_T_, Q_R, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_T2B, 150}, //# Fast ar right to top
                                 //(use: BOTH_T1_T___R)
    {"R2TL Trans", BOTH_T1__R_TL, Q_R, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_A_TL2BR, 150}, //# Fast arc right to top left
    {"R2L Trans", BOTH_T1__R__L, Q_R, Q_L, AFLAG_ACTIVE, 100, BLK_NO, LS_R_R2L,
     LS_A_L2R, 150}, //# Fast weak spin right to left
    {"R2BL Trans", BOTH_T1__R_BL, Q_R, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL, LS_A_BL2TR, 150}, //# Fast weak spin right to bottom left
    {"TR2BR Trans", BOTH_T1_TR_BR, Q_TR, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_A_BR2TL, 150}, //# Fast arc top right to bottom right
    {"TR2R Trans", BOTH_T1_TR__R, Q_TR, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_L2R, LS_A_R2L, 150}, //# Fast arc top right to right
                               //(use: BOTH_T1__R_TR)
    {"TR2T Trans", BOTH_T1_TR_T_, Q_TR, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_T2B, 150}, //# Fast arc top right to top
                                 //(use: BOTH_T1_T__TR)
    {"TR2TL Trans", BOTH_T1_TR_TL, Q_TR, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_A_TL2BR, 150}, //# Fast arc top right to top left
    {"TR2L Trans", BOTH_T1_TR__L, Q_TR, Q_L, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_R2L, LS_A_L2R, 150}, //# Fast arc top right to left
    {"TR2BL Trans", BOTH_T1_TR_BL, Q_TR, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL, LS_A_BL2TR, 150}, //# Fast weak spin top right to bottom left
    {"T2BR Trans", BOTH_T1_T__BR, Q_T, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_A_BR2TL, 150}, //# Fast arc top to bottom right
    {"T2R Trans", BOTH_T1_T___R, Q_T, Q_R, AFLAG_ACTIVE, 100, BLK_NO, LS_R_L2R,
     LS_A_R2L, 150}, //# Fast arc top to right
    {"T2TR Trans", BOTH_T1_T__TR, Q_T, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_TR2BL, 150}, //# Fast arc top to top right
    {"T2TL Trans", BOTH_T1_T__TL, Q_T, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_A_TL2BR, 150}, //# Fast arc top to top left
    {"T2L Trans", BOTH_T1_T___L, Q_T, Q_L, AFLAG_ACTIVE, 100, BLK_NO, LS_R_R2L,
     LS_A_L2R, 150}, //# Fast arc top to left
    {"T2BL Trans", BOTH_T1_T__BL, Q_T, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL, LS_A_BL2TR, 150}, //# Fast arc top to bottom left
    {"TL2BR Trans", BOTH_T1_TL_BR, Q_TL, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_A_BR2TL, 150}, //# Fast weak spin top left to bottom right
    {"TL2R Trans", BOTH_T1_TL__R, Q_TL, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_L2R, LS_A_R2L, 150}, //# Fast arc top left to right
                               //(use: BOTH_T1__R_TL)
    {"TL2TR Trans", BOTH_T1_TL_TR, Q_TL, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_TR2BL, 150}, //# Fast arc top left to top right
                                   //(use: BOTH_T1_TR_TL)
    {"TL2T Trans", BOTH_T1_TL_T_, Q_TL, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_T2B, 150}, //# Fast arc top left to top
                                 //(use: BOTH_T1_T__TL)
    {"TL2L Trans", BOTH_T1_TL__L, Q_TL, Q_L, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_R2L, LS_A_L2R, 150}, //# Fast arc top left to left
                               //(use: BOTH_T1__L_TL)
    {"TL2BL Trans", BOTH_T1_TL_BL, Q_TL, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL, LS_A_BL2TR, 150}, //# Fast arc top left to bottom left
    {"L2BR Trans", BOTH_T1__L_BR, Q_L, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_A_BR2TL, 150}, //# Fast weak spin left to bottom right
    {"L2R Trans", BOTH_T1__L__R, Q_L, Q_R, AFLAG_ACTIVE, 100, BLK_NO, LS_R_L2R,
     LS_A_R2L, 150}, //# Fast weak spin left to right
    {"L2TR Trans", BOTH_T1__L_TR, Q_L, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_TR2BL, 150}, //# Fast arc left to top right			(use:
                                   //BOTH_T1_TR__L)
    {"L2T Trans", BOTH_T1__L_T_, Q_L, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_T2B, 150}, //# Fast arc left to top
                                 //(use: BOTH_T1_T___L)
    {"L2TL Trans", BOTH_T1__L_TL, Q_L, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_A_TL2BR, 150}, //# Fast arc left to top left
    {"L2BL Trans", BOTH_T1__L_BL, Q_L, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL,
     LS_A_BL2TR, 150}, //# Fast arc left to bottom left (use: BOTH_T1_BL__L)
    {"BL2BR Trans", BOTH_T1_BL_BR, Q_BL, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_A_BR2TL,
     150}, //# Fast weak spin bottom left to bottom right
    {"BL2R Trans", BOTH_T1_BL__R, Q_BL, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_L2R, LS_A_R2L, 150}, //# Fast weak spin bottom left to right
    {"BL2TR Trans", BOTH_T1_BL_TR, Q_BL, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_TR2BL, 150}, //# Fast weak spin bottom left to top right
    {"BL2T Trans", BOTH_T1_BL_T_, Q_BL, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_A_T2B, 150}, //# Fast arc bottom left to top
                                 //(use: BOTH_T1_T__BL)
    {"BL2TL Trans", BOTH_T1_BL_TL, Q_BL, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_A_TL2BR,
     150}, //# Fast arc bottom left to top left		(use: BOTH_T1_TL_BL)
    {"BL2L Trans", BOTH_T1_BL__L, Q_BL, Q_L, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_R2L, LS_A_L2R, 150}, //# Fast arc bottom left to left

    // Bounces
    {"Bounce BR", BOTH_B1_BR___, Q_BR, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_T1_BR_TR, 150},
    {"Bounce R", BOTH_B1__R___, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_NO, LS_R_L2R,
     LS_T1__R__L, 150},
    {"Bounce TR", BOTH_B1_TR___, Q_TR, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_T1_TR_TL, 150},
    {"Bounce T", BOTH_B1_T____, Q_T, Q_T, AFLAG_ACTIVE, 100, BLK_NO, LS_R_BL2TR,
     LS_T1_T__BL, 150},
    {"Bounce TL", BOTH_B1_TL___, Q_TL, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_T1_TL_TR, 150},
    {"Bounce L", BOTH_B1__L___, Q_L, Q_L, AFLAG_ACTIVE, 100, BLK_NO, LS_R_R2L,
     LS_T1__L__R, 150},
    {"Bounce BL", BOTH_B1_BL___, Q_BL, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL, LS_T1_BL_TR, 150},

    // Deflected attacks (like bounces, but slide off enemy saber, not straight
    // back)
    {"Deflect BR", BOTH_D1_BR___, Q_BR, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TL2BR, LS_T1_BR_TR, 150},
    {"Deflect R", BOTH_D1__R___, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_NO, LS_R_L2R,
     LS_T1__R__L, 150},
    {"Deflect TR", BOTH_D1_TR___, Q_TR, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_T1_TR_TL, 150},
    {"Deflect T", BOTH_B1_T____, Q_T, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_T1_T__BL, 150},
    {"Deflect TL", BOTH_D1_TL___, Q_TL, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BR2TL, LS_T1_TL_TR, 150},
    {"Deflect L", BOTH_D1__L___, Q_L, Q_L, AFLAG_ACTIVE, 100, BLK_NO, LS_R_R2L,
     LS_T1__L__R, 150},
    {"Deflect BL", BOTH_D1_BL___, Q_BL, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_TR2BL, LS_T1_BL_TR, 150},
    {"Deflect B", BOTH_D1_B____, Q_B, Q_B, AFLAG_ACTIVE, 100, BLK_NO,
     LS_R_BL2TR, LS_T1_T__BL, 150},

    // Reflected attacks
    {"Reflected BR", BOTH_V1_BR_S1, Q_BR, Q_BR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1_BR
    {"Reflected R", BOTH_V1__R_S1, Q_R, Q_R, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1__R
    {"Reflected TR", BOTH_V1_TR_S1, Q_TR, Q_TR, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1_TR
    {"Reflected T", BOTH_V1_T__S1, Q_T, Q_T, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1_T_
    {"Reflected TL", BOTH_V1_TL_S1, Q_TL, Q_TL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1_TL
    {"Reflected L", BOTH_V1__L_S1, Q_L, Q_L, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1__L
    {"Reflected BL", BOTH_V1_BL_S1, Q_BL, Q_BL, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1_BL
    {"Reflected B", BOTH_V1_B__S1, Q_B, Q_B, AFLAG_ACTIVE, 100, BLK_NO,
     LS_READY, LS_READY, 150}, //	LS_V1_B_

    // Broken parries
    {"BParry Top", BOTH_H1_S1_T_, Q_T, Q_B, AFLAG_ACTIVE, 50, BLK_NO, LS_READY,
     LS_READY, 150}, // LS_PARRY_UP,
    {"BParry UR", BOTH_H1_S1_TR, Q_TR, Q_BL, AFLAG_ACTIVE, 50, BLK_NO, LS_READY,
     LS_READY, 150}, // LS_PARRY_UR,
    {"BParry UL", BOTH_H1_S1_TL, Q_TL, Q_BR, AFLAG_ACTIVE, 50, BLK_NO, LS_READY,
     LS_READY, 150}, // LS_PARRY_UL,
    {"BParry LR", BOTH_H1_S1_BL, Q_BL, Q_TR, AFLAG_ACTIVE, 50, BLK_NO, LS_READY,
     LS_READY, 150}, // LS_PARRY_LR,
    {"BParry Bot", BOTH_H1_S1_B_, Q_B, Q_T, AFLAG_ACTIVE, 50, BLK_NO, LS_READY,
     LS_READY, 150}, // LS_PARRY_LL
    {"BParry LL", BOTH_H1_S1_BR, Q_BR, Q_TL, AFLAG_ACTIVE, 50, BLK_NO, LS_READY,
     LS_READY, 150}, // LS_PARRY_LL

    // Knockaways
    {"Knock Top", BOTH_K1_S1_T_, Q_R, Q_T, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BL2TR, LS_T1_T__BR, 150}, // LS_PARRY_UP,
    {"Knock UR", BOTH_K1_S1_TR, Q_R, Q_TR, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BL2TR, LS_T1_TR__R, 150}, // LS_PARRY_UR,
    {"Knock UL", BOTH_K1_S1_TL, Q_R, Q_TL, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BR2TL, LS_T1_TL__L, 150}, // LS_PARRY_UL,
    {"Knock LR", BOTH_K1_S1_BL, Q_R, Q_BL, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_TL2BR, LS_T1_BL_TL, 150}, // LS_PARRY_LR,
    {"Knock LL", BOTH_K1_S1_BR, Q_R, Q_BR, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_TR2BL, LS_T1_BR_TR, 150}, // LS_PARRY_LL

    // Parry
    {"Parry Top", BOTH_P1_S1_T_, Q_R, Q_T, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BL2TR, LS_A_T2B, 150}, // LS_PARRY_UP,
    {"Parry UR", BOTH_P1_S1_TR, Q_R, Q_TL, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BL2TR, LS_A_TR2BL, 150}, // LS_PARRY_UR,
    {"Parry UL", BOTH_P1_S1_TL, Q_R, Q_TR, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BR2TL, LS_A_TL2BR, 150}, // LS_PARRY_UL,
    {"Parry LR", BOTH_P1_S1_BL, Q_R, Q_BR, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_TL2BR, LS_A_BR2TL, 150}, // LS_PARRY_LR,
    {"Parry LL", BOTH_P1_S1_BR, Q_R, Q_BL, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_TR2BL, LS_A_BL2TR, 150}, // LS_PARRY_LL

    // Reflecting a missile
    {"Reflect Top", BOTH_P1_S1_T_, Q_R, Q_T, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BL2TR, LS_A_T2B, 300}, // LS_PARRY_UP,
    {"Reflect UR", BOTH_P1_S1_TL, Q_R, Q_TR, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BR2TL, LS_A_TL2BR, 300}, // LS_PARRY_UR,
    {"Reflect UL", BOTH_P1_S1_TR, Q_R, Q_TL, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_BL2TR, LS_A_TR2BL, 300}, // LS_PARRY_UL,
    {"Reflect LR", BOTH_P1_S1_BR, Q_R, Q_BL, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_TR2BL, LS_A_BL2TR, 300}, // LS_PARRY_LR
    {"Reflect LL", BOTH_P1_S1_BL, Q_R, Q_BR, AFLAG_ACTIVE, 50, BLK_WIDE,
     LS_R_TL2BR, LS_A_BR2TL, 300}, // LS_PARRY_LL,
};
...
saberMoveName_t transitionMove[Q_NUM_QUADS][Q_NUM_QUADS] = {
    {
        ...
        LS_T1_BR__R, // 40
        LS_T1_BR_TR, LS_T1_BR_T_, LS_T1_BR_TL, LS_T1_BR__L, LS_T1_BR_BL,
        LS_NONE // No transitions to bottom, and no anims start there, so
                // shouldn't need any
    },
    {
        LS_T1__R_BR, // 46
        LS_NONE,     // Can't transition to same pos!
        LS_T1__R_TR, LS_T1__R_T_, LS_T1__R_TL, LS_T1__R__L, LS_T1__R_BL,
        LS_NONE // No transitions to bottom, and no anims start there, so
                // shouldn't need any
    },
    {
        ...
        LS_T1_TR__R,
        LS_NONE, // Can't transition to same pos!
        LS_T1_TR_T_, LS_T1_TR_TL, LS_T1_TR__L, LS_T1_TR_BL,
        LS_NONE // No transitions to bottom, and no anims start there, so
                // shouldn't need any
    },
    {
        LS_T1_T__BR, // 58
        LS_T1_T___R, LS_T1_T__TR,
        LS_NONE, // Can't transition to same pos!
        LS_T1_T__TL, LS_T1_T___L, LS_T1_T__BL,
        LS_NONE // No transitions to bottom, and no anims start there, so
                // shouldn't need any
    },
    {
        LS_T1_TL_BR, // 64
        LS_T1_TL__R, LS_T1_TL_TR, LS_T1_TL_T_,
        LS_NONE, // Can't transition to same pos!
        LS_T1_TL__L, LS_T1_TL_BL,
        LS_NONE // No transitions to bottom, and no anims start there, so
                // shouldn't need any
    },
    {
    ...
    {
        LS_T1_BL_BR, // 76
        LS_T1_BL__R, LS_T1_BL_TR, LS_T1_BL_T_, LS_T1_BL_TL, LS_T1_BL__L,
        LS_NONE, // Can't transition to same pos!
        LS_NONE  // No transitions to bottom, and no anims start there, so
                // shouldn't need any
    },
    {
        LS_T1_BL_BR, // NOTE: there are no transitions from bottom, so re-use
                     // the bottom right transitions
        LS_T1_BR__R, LS_T1_BR_TR, LS_T1_BR_T_, LS_T1_BR_TL, LS_T1_BR__L,
        LS_T1_BR_BL,
        LS_NONE // No transitions to bottom, and no anims start there, so
                // shouldn't need any
    }};
...
void PM_VelocityForSaberMove(playerState_t *ps, vec3_t throwDir) {
  vec3_t vForward = {0.0f}, vRight = {0.0f}, vUp = {0.0f}, startQ = {0.0f},
         endQ = {0.0f};
...
int PM_PowerLevelForSaberAnim(playerState_t *ps, int saberNum) {
  ...
  int animTimeElapsed =
      PM_AnimLength(g_entities[ps->clientNum].client->clientInfo.animFileIndex,
                    (animNumber_t)anim) -
      ps->torsoAnimTimer;
  if (anim >= BOTH_A1_T__B_ && anim <= BOTH_D1_B____) {
  ...
  if ((anim >= BOTH_P1_S1_T_ && anim <= BOTH_P1_S1_BR) ||
      ...
      (anim >= BOTH_P7_S7_T_ && anim <= BOTH_P7_S7_BR)) { // parries
  ...
  case BOTH_ATTACK_BACK:
    if (ps->torsoAnimTimer < 500) { // end of anim
      return FORCE_LEVEL_0;
    }
    return FORCE_LEVEL_3;
    break;
  case BOTH_CROUCHATTACKBACK1:
    if (ps->torsoAnimTimer < 800) { // end of anim
      return FORCE_LEVEL_0;
    }
    return FORCE_LEVEL_3;
    break;
  ...
  case BOTH_LUNGE2_B__T_:
    if (ps->torsoAnimTimer < 400) { // end of anim
      return FORCE_LEVEL_0;
  ...
  case BOTH_JUMPFLIPSLASHDOWN1:
    if (ps->torsoAnimTimer <= 900) { // end of anim
      return FORCE_LEVEL_0;
    } else if (animTimeElapsed < 550) { // beginning of anim
      return FORCE_LEVEL_0;
    }
  ...
  case BOTH_JUMPFLIPSTABDOWN:
    if (ps->torsoAnimTimer <= 1200) { // end of anim
      return FORCE_LEVEL_0;
  ...
  case BOTH_JUMPATTACK6:
    ...
    if (pm->ps)
    {
            if ( ( pm->ps->legsAnimTimer >= 1450
                            && PM_AnimLength(
    g_entities[ps->clientNum].client->clientInfo.animFileIndex, BOTH_JUMPATTACK6
    ) - pm->ps->legsAnimTimer >= 400 )
                    ||(pm->ps->legsAnimTimer >= 400
                            && PM_AnimLength(
    g_entities[ps->clientNum].client->clientInfo.animFileIndex, BOTH_JUMPATTACK6
    ) - pm->ps->legsAnimTimer >= 1100 ) )
            {//pretty much sideways
                    return FORCE_LEVEL_3;
            }
    }
    */
    if ((ps->torsoAnimTimer >= 1450 && animTimeElapsed >= 400) ||
  ...
  */
  ...
  case BOTH_STABDOWN_STAFF:
    if (ps->torsoAnimTimer <= 850) { // end of anim
      return FORCE_LEVEL_3;
    }
    break;
  ...
  case BOTH_A6_SABERPROTECT:
    if (ps->torsoAnimTimer < 650) { // end of anim
      return FORCE_LEVEL_0;
    }
    return FORCE_LEVEL_3;
    break;
  ...
  case BOTH_A1_SPECIAL:
    if (ps->torsoAnimTimer < 600) { // end of anim
      return FORCE_LEVEL_0;
    } else if (animTimeElapsed < 200) { // beginning of anim
      return FORCE_LEVEL_0;
    }
  ...
  case BOTH_A2_SPECIAL:
    if (ps->torsoAnimTimer < 300) { // end of anim
      return FORCE_LEVEL_0;
    } else if (animTimeElapsed < 200) { // beginning of anim
      return FORCE_LEVEL_0;
    }
  ...
  case BOTH_A3_SPECIAL:
    if (ps->torsoAnimTimer < 700) { // end of anim
      return FORCE_LEVEL_0;
    } else if (animTimeElapsed < 200) { // beginning of anim
      return FORCE_LEVEL_0;
    }
  ...
  case BOTH_PULL_IMPALE_STAB:
    if (ps->torsoAnimTimer < 1000) { // end of anim
      return FORCE_LEVEL_0;
    }
    return FORCE_LEVEL_3;
    break;
  ...
  case BOTH_ALORA_SPIN_SLASH:
    ...
    break;
  case BOTH_A6_FB:
    if (ps->torsoAnimTimer < 250) { // end of anim
      return FORCE_LEVEL_0;
    } else if (animTimeElapsed < 250) { // beginning of anim
      return FORCE_LEVEL_0;
    }
  ...
  case BOTH_LK_S_S_T_SB_1_W:
    if (ps->torsoAnimTimer < 150) { // end of anim
      return FORCE_LEVEL_0;
    } else if (animTimeElapsed < 400) { // beginning of anim
      return FORCE_LEVEL_0;
    }
  ...
  case BOTH_LK_DL_ST_T_SB_1_W:
    if (ps->torsoAnimTimer < 950) { // end of anim
      return FORCE_LEVEL_0;
...
qboolean PM_InAnimForSaberMove(int anim, int saberMove) {
  switch (anim) { // special case anims
  case BOTH_A2_STABBACK1:
  case BOTH_ATTACK_BACK:
  case BOTH_CROUCHATTACKBACK1:
  case BOTH_ROLL_STAB:
  ...
  if (animLevel <= 0) { // NOTE: this will always return false for the ready
                        // poses and putaway/draw...
    return qfalse;
  }
...
int PM_SaberAttackChainAngle(int move1, int move2) {
  ...
  return saberMoveTransitionAngle[saberMoveData[move1].endQuad]
                                 [saberMoveData[move2].startQuad];
}

qboolean PM_SaberKataDone(int curmove = LS_NONE, int newmove = LS_NONE) {
  if (pm->ps->forceRageRecoveryTime >
      level.time) { // rage recovery, only 1 swing at a time (tired)
    if (pm->ps->saberAttackChainCount > 0) { // swung once
      return qtrue;
    } else { // allow one attack
      return qfalse;
    }
  } else if ((pm->ps->forcePowersActive &
              (1 << FP_RAGE))) { // infinite chaining when raged
    return qfalse;
  ...
  if (pm->ps->saberAnimLevel == SS_DESANN ||
      pm->ps->saberAnimLevel == SS_TAVION) { // desann and tavion can link up as
                                             // many attacks as they want
    return qfalse;
  }
  // FIXME: instead of random, apply some sort of logical conditions to whether
  // or 		not you can chain?  Like if you were completely missed, you can't chain
  //as much, or...? 		And/Or based on FP_SABER_OFFENSE level?  So number of
  //attacks you can chain 		increases with your FP_SABER_OFFENSE skill?
  if (pm->ps->saberAnimLevel == SS_STAFF) {
    ...
    else if ( pm->ps->saberAttackChainCount > 0 )
    {
            ...
            {//continues the momentum perfectly, allow it to chain 66% of the
    time if ( pm->ps->saberAttackChainCount > 2 )
                    {
                            return qtrue;
                    }
            }
    ...
    */
    ...
    if (curmove == LS_NONE || newmove == LS_NONE) {
      if (pm->ps->saberAnimLevel >= FORCE_LEVEL_3 &&
          pm->ps->saberAttackChainCount > Q_irand(0, 1)) {
        return qtrue;
      }
      ...
      int chainAngle = PM_SaberAttackChainAngle(curmove, newmove);
      if (chainAngle < 135 ||
          chainAngle > 215) { // if trying to chain to a move that doesn't
                              // continue the momentum
        return qtrue;
      } else if (chainAngle == 180) { // continues the momentum perfectly, allow
                                      // it to chain 66% of the time
        if (pm->ps->saberAttackChainCount > 1) {
          return qtrue;
        }
  ...
  } else { // FIXME: have chainAngle influence fast and medium chains as well?
...
qboolean PM_CheckEnemyInBack(float backCheckDist) {
  ...
  if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
      ...
      pm->cmd.forwardmove >= 0) { // don't auto-backstab
    return qfalse;
  }
  if (pm->ps->groundEntityNum == ENTITYNUM_NONE) { // only when on ground
    return qfalse;
  }
  trace_t trace;
  ...
  pm->trace(&trace, pm->ps->origin, vec3_origin, vec3_origin, end,
            pm->ps->clientNum, CONTENTS_SOLID | CONTENTS_BODY, (EG2_Collision)0,
            0);
  if (trace.fraction < 1.0f && trace.entityNum < ENTITYNUM_WORLD) {
    gentity_t *traceEnt = &g_entities[trace.entityNum];
    if (traceEnt && traceEnt->health > 0 && traceEnt->client &&
        traceEnt->client->playerTeam == pm->gent->client->enemyTeam &&
        traceEnt->client->ps.groundEntityNum != ENTITYNUM_NONE) {
      if ((pm->ps->clientNum < MAX_CLIENTS ||
           PM_ControlledByPlayer())) { // player
        if (pm->gent) { // set player enemy to traceEnt so he auto-aims at him
  ...
  if (pm->gent->client->ps.saberAnimLevel == SS_TAVION) {
    ...
    if (pm->ps->saberMove == LS_READY || !Q_irand(0, 3)) {
      ...
      return LS_A_BACK;
             ...
             pm->ps->saberAnimLevel ==
                 SS_DUAL) { // using medium attacks or dual sabers
    if (pm->ps->pm_flags & PMF_DUCKED) {
      return LS_A_BACK_CR;
    } else {
      return LS_A_BACK;
...
saberMoveName_t PM_CheckStabDown(void) {
  ...
  if (pm->ps->dualSabers && (pm->ps->saber[1].saberFlags & SFL_NO_STABDOWN)) {
    return LS_NONE;
  }
  if (pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) // PLAYER ONLY
  {                                                               // player
    if (G_TryingKataAttack(
            pm->gent,
            &pm->cmd)) //(pm->cmd.buttons&BUTTON_FORCE_FOCUS) )//Holding focus
  ...
  if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer())) { // player
    ...
    { // sorry must be on ground (or have just jumped)
      if (level.time - pm->ps->lastOnGround <= 50 &&
          (pm->ps->pm_flags & PMF_JUMPING)) { // just jumped, it's okay
      } else {
        return LS_NONE;
      }
    }
    ...
    */
    ...
    pm->cmd.upmove = 0;
              ...
              !PM_ControlledByPlayer())) {         // NPC
    if (pm->ps->groundEntityNum == ENTITYNUM_NONE) // in air
    { // sorry must be on ground (or have just jumped)
      if (level.time - pm->ps->lastOnGround <= 250 &&
          (pm->ps->pm_flags & PMF_JUMPING)) { // just jumped, it's okay
      } else {
        return LS_NONE;
      }
    ...
    if (Q_irand(0, RANK_CAPTAIN) >
        pm->gent->NPC->rank) { // lower ranks do this less often
      return LS_NONE;
    }
  }
  ...
  enemyDir[2] = 0;
  float enemyHDist = VectorNormalize(enemyDir) -
                     (pm->gent->maxs[0] + pm->gent->enemy->maxs[0]);
  ...
  if ( //(pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer())
      ...
      &&
      enemyZDiff <= 20) { // guy is on the ground below me, do a top-down attack
    if (pm->gent->enemy->s.number >= MAX_CLIENTS ||
        !G_ControlledByPlayer(
            pm->gent->enemy)) { // don't get up while I'm doing this
...
saberMoveName_t PM_AttackForEnemyPos(qboolean allowFB, qboolean allowStabDown) {
  ...
  vec3_t enemy_org, enemyDir, faceFwd, faceRight, faceUp,
      facingAngles = {0, pm->ps->viewangles[YAW], 0};
  ...
  if (pm->gent->enemy->client) {
    ...
    VectorSubtract(pm->gent->enemy->client->renderInfo.eyePoint, pm->ps->origin,
                   enemyDir);
  } else {
    if (pm->gent->enemy->bmodel &&
        VectorCompare(
            vec3_origin,
            pm->gent->enemy
                ->currentOrigin)) { // a brush model without an origin brush
      vec3_t size;
      VectorSubtract(pm->gent->enemy->absmax, pm->gent->enemy->absmin, size);
      VectorMA(pm->gent->enemy->absmin, 0.5, size, enemy_org);
    } else {
  ...
  if (dot > 0) {         // enemy is in front
    if (allowStabDown) { // okay to try this
    ...
    if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
        dot > 0.65f && enemyDist <= 64 && pm->gent->enemy->client &&
        (enemyZDiff <= 20 ||
         PM_InKnockDownOnGround(&pm->gent->enemy->client->ps) ||
         PM_CrouchAnim(
             pm->gent->enemy->client->ps.legsAnim))) { // swing down at them
      return LS_A_T2B;
    }
    if (allowFB) { // directly in front anim allowed
      if (!(pm->ps->saber[0].saberFlags & SFL_NO_BACK_ATTACK) &&
          (!pm->ps->dualSabers ||
           !(pm->ps->saber[1].saberFlags &
             SFL_NO_BACK_ATTACK))) { // okay to do backstabs with this saber
        if (enemyDist > 200 ||
            pm->gent->enemy->health <= 0) { // hmm, look in back for an enemy
          if (pm->ps->clientNum &&
              !PM_ControlledByPlayer()) { // player should never do this
                                          // automatically
            if (pm->ps->groundEntityNum !=
                ENTITYNUM_NONE) { // only when on ground
              if (pm->gent && pm->gent->client && pm->gent->NPC &&
                  pm->gent->NPC->rank >= RANK_LT_JG &&
                  Q_irand(0, pm->gent->NPC->rank) >
                      RANK_ENSIGN) { // only fencers and higher can do this,
                                     // higher rank does it more
      ...
      if ((pm->ps->clientNum && !PM_ControlledByPlayer()) ||
          ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
           ...
           !cg.zoomMode)) { // NPC or player not in 1st person
        if (PM_CheckFlipOverAttackMove(
                qtrue)) { // enemy must be close and in front
    ...
    if (dotR > 0.35) { // enemy is to far right
      autoMove = LS_A_L2R;
    } else if (dotR < -0.35) { // far left
      autoMove = LS_A_R2L;
    } else if (dotR > 0.15) { // enemy is to near right
      autoMove = LS_A_TR2BL;
    } else if (dotR < -0.15) { // near left
      autoMove = LS_A_TL2BR;
    }
    if (DotProduct(enemyDir, faceUp) > 0.5) { // enemy is above me
  ...
  } else if (allowFB) { // back attack allowed
    ...
    if (!(pm->ps->saber[0].saberFlags & SFL_NO_BACK_ATTACK) &&
      ...
      if (pm->ps->groundEntityNum != ENTITYNUM_NONE) { // only when on ground
        if (!pm->gent->enemy->client ||
            pm->gent->enemy->client->ps.groundEntityNum !=
                ENTITYNUM_NONE) { // enemy not a client or is a client and on
                                  // ground
          if (dot < -0.75f && enemyDist < 128 &&
              (pm->ps->saberAnimLevel == SS_FAST ||
               ...
               (pm->gent->client &&
                ...
                Q_irand(0, 2)))) { // fast back-stab
            if (!(pm->ps->pm_flags & PMF_DUCKED) &&
                pm->cmd.upmove >= 0) { // can't do it while ducked?
              if ((pm->ps->clientNum < MAX_CLIENTS ||
                   PM_ControlledByPlayer()) ||
                  (pm->gent->NPC &&
                   pm->gent->NPC->rank >=
                       RANK_LT_JG)) { // only fencers and above can do this
                autoMove = LS_A_BACKSTAB;
              }
            }
          } else if (pm->ps->saberAnimLevel != SS_FAST &&
                     pm->ps->saberAnimLevel !=
                         SS_STAFF) { // higher level back spin-attacks
            if ((pm->ps->clientNum && !PM_ControlledByPlayer()) ||
                ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
...
qboolean PM_InSecondaryStyle(void) {
  if (pm->ps->saber[0].numBlades > 1 && pm->ps->saber[0].singleBladeStyle &&
      (pm->ps->saber[0].stylesForbidden &
       (1 << pm->ps->saber[0].singleBladeStyle)) &&
...
saberMoveName_t PM_SaberLungeAttackMove(qboolean fallbackToNormalLunge) {
  G_DrainPowerForSpecialMove(pm->gent, FP_SABER_OFFENSE,
  ...
  // do normal checks
  if (pm->gent->client->NPC_class == CLASS_ALORA &&
      !Q_irand(0, 3)) { // alora NPC
...
qboolean PM_CheckLungeAttackMove(void) {
  ...
  if (pm->ps->saberAnimLevel == SS_FAST     // fast
      ...
      pm->ps->dualSabers) { // alt+back+attack using fast, dual or staff attacks
    if (pm->ps->clientNum >= MAX_CLIENTS && !PM_ControlledByPlayer()) { // NPC
      if (pm->cmd.upmove < 0 || (pm->ps->pm_flags & PMF_DUCKED)) { // ducking
        if (pm->ps->legsAnim == BOTH_STAND2 ||
            ...
            (level.time - pm->ps->lastStationary) <=
                500) {                  // standing or just stopped standing
          if (pm->gent && pm->gent->NPC // NPC
              && pm->gent->NPC->rank >= RANK_LT_JG // high rank
              && (pm->gent->NPC->rank == RANK_LT_JG ||
                  Q_irand(-3, pm->gent->NPC->rank) >=
                      RANK_LT_JG) // Q_irand( 0, pm->gent->NPC->rank ) >=
                                  // RANK_LT_JG )
              && !Q_irand(0, 3 - g_spskill->integer)) { // only fencer and
                                                        // higher can do this
            if (pm->ps->saberAnimLevel == SS_DESANN) {
              if (!Q_irand(0, 4)) {
                return qtrue;
      ...
      if (G_TryingLungeAttack(pm->gent, &pm->cmd) && G_EnoughPowerForSpecialMove(
                                                         pm->ps->forcePower,
                                                         SABER_ALT_ATTACK_POWER_FB) /*pm->ps->forcePower >= SABER_ALT_ATTACK_POWER_FB*/) // have enough force power to pull it off
      {
        return qtrue;
      }
    }
...
saberMoveName_t PM_SaberJumpForwardAttackMove(void) {
  G_DrainPowerForSpecialMove(pm->gent, FP_LEVITATION,
                             SABER_ALT_ATTACK_POWER_FB);
  ...
  if (pm->ps->saberAnimLevel == SS_DUAL || pm->ps->saberAnimLevel == SS_STAFF) {
    ...
    pm->ps->forceJumpZStart =
        pm->ps->origin[2]; // so we don't take damage if we land at same height
...
qboolean PM_CheckJumpForwardAttackMove(void) {
  ...
  if (pm->cmd.forwardmove > 0 // going forward
      && pm->ps->forceRageRecoveryTime <
             pm->cmd.serverTime // not in a force Rage recovery period
      &&
      pm->ps->forcePowerLevel[FP_LEVITATION] > FORCE_LEVEL_1 // can force jump
      && pm->gent &&
      !(pm->gent->flags &
        FL_LOCK_PLAYER_WEAPONS) // yes this locked weapons check also includes
                                // force powers, if we need a separate check
                                // later I'll make one
      && (pm->ps->groundEntityNum != ENTITYNUM_NONE ||
          level.time - pm->ps->lastOnGround <=
              250) // on ground or just jumped (if not player)
  ) {
    if (pm->ps->saberAnimLevel == SS_DUAL ||
        pm->ps->saberAnimLevel == SS_STAFF) { // dual and staff
      if (!PM_SaberInTransitionAny(
              pm->ps->saberMove) // not going to/from/between an attack anim
          ...
          && (pm->cmd.buttons & BUTTON_ATTACK))   // want to attack
      {
        if (pm->ps->clientNum >= MAX_CLIENTS &&
            !PM_ControlledByPlayer()) { // NPC
          if (pm->cmd.upmove > 0 ||
              (pm->ps->pm_flags & PMF_JUMPING)) // jumping NPC
          {
            if (pm->gent && pm->gent->NPC &&
                (pm->gent->NPC->rank == RANK_CREWMAN ||
          ...
          if (G_TryingJumpForwardAttack(pm->gent, &pm->cmd) &&
              G_EnoughPowerForSpecialMove(
                  pm->ps->forcePower,
                  SABER_ALT_ATTACK_POWER_FB)) // have enough power to attack
          {
            return qtrue;
          }
        }
             ...
             || pm->ps->saberAnimLevel == SS_DESANN) // desann
    {
      if ( //&& !PM_InKnockDown( pm->ps )
          !pm->ps->dualSabers
          //&& (pm->ps->legsAnim == BOTH_STAND2||pm->ps->legsAnim ==
          //BOTH_SABERFAST_STANCE||pm->ps->legsAnim ==
          //BOTH_SABERSLOW_STANCE||level.time-pm->ps->lastStationary<=500)//standing
          //or just started moving
      ) { // strong attack: jump-hack
        /*
        if ( pm->ps->legsAnim == BOTH_STAND2
                || pm->ps->legsAnim == BOTH_SABERFAST_STANCE
                || pm->ps->legsAnim == BOTH_SABERSLOW_STANCE
                || level.time-pm->ps->lastStationary <= 250 )//standing or just
        started moving
        */
        if (pm->ps->clientNum >= MAX_CLIENTS &&
            !PM_ControlledByPlayer()) { // NPC
          if (pm->cmd.upmove > 0 ||
              (pm->ps->pm_flags & PMF_JUMPING)) // NPC jumping
          {
            if (pm->gent && pm->gent->NPC &&
                (pm->gent->NPC->rank == RANK_CREWMAN ||
                 pm->gent->NPC->rank >=
                     RANK_LT)) { // only acrobat or boss and higher can do this
              if (pm->ps->legsAnim == BOTH_STAND2 ||
                  pm->ps->legsAnim == BOTH_SABERFAST_STANCE ||
                  pm->ps->legsAnim == BOTH_SABERSLOW_STANCE ||
                  level.time - pm->ps->lastStationary <=
                      250) { // standing or just started moving
                if (pm->gent->client &&
...
saberMoveName_t PM_SaberFlipOverAttackMove(void) {
  ...
  // FIXME: while in this jump, keep velocity[2] at a minimum until the end of
  // the anim
  vec3_t fwdAngles, jumpFwd;
  ...
  // 250 is normalized for a standing enemy at your z level, about 64 tall...
  // adjust for actual maxs[2]-mins[2] of enemy and for zdiff in origins
  if (pm->gent && pm->gent->enemy) { // go higher for taller enemies
    pm->ps->velocity[2] *=
        (pm->gent->enemy->maxs[2] - pm->gent->enemy->mins[2]) / 64.0f;
    ...
    if (zDiff <= 0 &&
        pm->ps->velocity[2] < 200) { // if we're on same level, don't let me
                                     // jump so low, I clip into the ground
  ...
  pm->gent->angle =
      pm->ps->viewangles[YAW]; // so we know what yaw we started this at
...
qboolean PM_CheckFlipOverAttackMove(qboolean checkEnemy) {
  ...
  if ((pm->ps->saberAnimLevel == SS_MEDIUM     // medium
      ...
      pm->ps->forcePowerLevel[FP_LEVITATION] > FORCE_LEVEL_1 // can force jump
      && !(pm->gent->flags &
           FL_LOCK_PLAYER_WEAPONS) // yes this locked weapons check also
                                   // includes force powers, if we need a
                                   // separate check later I'll make one
      && (pm->ps->groundEntityNum != ENTITYNUM_NONE ||
          level.time - pm->ps->lastOnGround <= 250) // on ground or just jumped
  ) {
    ...
    if (pm->ps->clientNum >= MAX_CLIENTS && !PM_ControlledByPlayer()) { // NPC
      ...
      if (G_TryingJumpForwardAttack(pm->gent, &pm->cmd) &&
          G_EnoughPowerForSpecialMove(
              pm->ps->forcePower,
              SABER_ALT_ATTACK_POWER_FB)) // have enough power
      {
        if (!pm->cmd.rightmove) {
          if (pm->ps->legsAnim == BOTH_JUMP1 ||
              ...
              pm->ps->legsAnim ==
                  BOTH_FORCEINAIR1) { // in a non-flip forward jump
            tryMove = qtrue;
          }
        }
      }
    ...
    if (tryMove) {
      if (!checkEnemy) { // based just on command input
        return qtrue;
      } else {               // based on presence of enemy
        if (pm->gent->enemy) // have an enemy
        {
          ...
          if (pm->gent->enemy->health > 0 &&
              ...
              (!pm->gent->enemy->client ||
               !PM_InKnockDownOnGround(&pm->gent->enemy->client->ps)) &&
              DistanceSquared(pm->gent->currentOrigin,
                              pm->gent->enemy->currentOrigin) < 10000 &&
              InFront(pm->gent->enemy->currentOrigin, pm->gent->currentOrigin,
                      fwdAngles, 0.3f)) { // enemy must be alive, not low to
                                          // ground, close and in front
            return qtrue;
          }
        }
        return qfalse;
      ...
      {                                           // not already attacking
        if (pm->ps->clientNum >= MAX_CLIENTS &&
          ...
          if (pm->gent && pm->gent->NPC &&
              (pm->gent->NPC->rank == RANK_CREWMAN ||
               pm->gent->NPC->rank >=
                   RANK_LT)) { // acrobat or boss and higher can do this
            return qtrue;
          }
        } else { // player
          return qtrue;
...
saberMoveName_t PM_CheckDualSpinProtect(void) {
  ...
  if (pm->ps->saberMove ==
          LS_READY // ready
                   //&& (pm->ps->clientNum <
                   //MAX_CLIENTS||PM_ControlledByPlayer())//PLAYER ONLY...?
                   //&& pm->ps->viewangles[0] > 30 //looking down
      && pm->ps->saberAnimLevel == SS_DUAL // using dual saber style
      && pm->ps->saber[0].Active() &&
      pm->ps->saber[1].Active() // both sabers on
      ...
      &&
      G_EnoughPowerForSpecialMove(
          pm->ps->forcePower, SABER_ALT_ATTACK_POWER,
          qtrue) // pm->ps->forcePower >=
                 // SABER_ALT_ATTACK_POWER//DUAL_SPIN_PROTECT_POWER//force push 3
    ...
    */
    {
      if (pm->gent) {
        G_DrainPowerForSpecialMove(pm->gent, FP_PUSH, SABER_ALT_ATTACK_POWER,
                                   qtrue); // drain the required force power
      }
...
extern qboolean WP_ForceThrowable(gentity_t *ent, gentity_t *forwardEnt,
                                  gentity_t *self, qboolean pull, float cone,
...
saberMoveName_t PM_CheckPullAttack(void) {
  ...
  if ((pm->ps->saberMove == LS_READY || PM_SaberInReturn(pm->ps->saberMove) ||
       PM_SaberInReflect(pm->ps->saberMove)) // ready
                                             //&& (pm->ps->clientNum <
                                             //MAX_CLIENTS||PM_ControlledByPlayer())//PLAYER
                                             //ONLY
      &&
      pm->ps->saberAnimLevel >= SS_FAST // single saber styles - FIXME: Tavion?
      && pm->ps->saberAnimLevel <=
             SS_STRONG // single saber styles - FIXME: Tavion?
      && G_TryingPullAttack(
             pm->gent, &pm->cmd,
             qfalse) //(pm->cmd.buttons&BUTTON_FORCE_FOCUS)//holding focus
      //&& pm->cmd.forwardmove<0//pulling back
      && (pm->cmd.buttons & BUTTON_ATTACK) // attacking
      && G_EnoughPowerForSpecialMove(
             pm->ps->forcePower,
             SABER_ALT_ATTACK_POWER_FB) // pm->ps->forcePower >=
                                        // SABER_ALT_ATTACK_POWER_FB//have enough
                                        // power
  ) { // FIXME: some NPC logic to do this?
    qboolean doMove = g_saberNewControlScheme->integer
                          ? qtrue
                          : qfalse; // in new control scheme, can always do
                                    // this, even if there's no-one to do it to
    if (g_saberNewControlScheme->integer ||
        g_crosshairEntNum < ENTITYNUM_WORLD) // in old control scheme, there has
                                             // to be someone there
    {
      ...
      if (g_crosshairEntNum < ENTITYNUM_WORLD && pm->gent && pm->gent->client) {
        ...
        if (targEnt->client &&
            targEnt->health > 0
            // FIXME: check other things like in knockdown, saberlock,
            // uninterruptable anims, etc.
            ...
            WP_ForceThrowable(targEnt, targEnt, pm->gent, qtrue, 1.0f, 0.0f,
                              NULL)) {
          if (!g_saberNewControlScheme
                   ->integer) { // in old control scheme, make sure they're
                                // close or far enough away for the move we'll be
                                // doing
            float targDist = Distance(targEnt->currentOrigin, pm->ps->origin);
            if (pullAttackMove ==
                LS_PULL_ATTACK_STAB) { // must be closer than 512
              if (targDist > 384.0f) {
                return LS_NONE;
              }
          ...
          if (InFront(pm->ps->origin, targEnt->currentOrigin, targAngles)) {
            NPC_SetAnim(targEnt, SETANIM_BOTH, BOTH_PULLED_INAIR_F,
                        SETANIM_FLAG_OVERRIDE, SETANIM_FLAG_HOLD);
          } else {
            NPC_SetAnim(targEnt, SETANIM_BOTH, BOTH_PULLED_INAIR_B,
                        SETANIM_FLAG_OVERRIDE, SETANIM_FLAG_HOLD);
          }
          // hold the anim until I'm with done pull anim
          targEnt->client->ps.legsAnimTimer =
              targEnt->client->ps.torsoAnimTimer = PM_AnimLength(
                  pm->gent->client->clientInfo.animFileIndex,
                  (animNumber_t)saberMoveData[pullAttackMove].animToUse);
          // set pullAttackTime
          pm->gent->client->ps.pullAttackTime =
              targEnt->client->ps.pullAttackTime =
                  level.time + targEnt->client->ps.legsAnimTimer;
      ...
      if (doMove) {
        if (pm->gent) {
          G_DrainPowerForSpecialMove(pm->gent, FP_PULL,
                                     SABER_ALT_ATTACK_POWER_FB);
        }
...
saberMoveName_t PM_CheckPlayerAttackFromParry(int curmove) {
  if (pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) {
    if (curmove >= LS_PARRY_UP && curmove <= LS_REFLECT_LL) { // in a parry
...
saberMoveName_t PM_SaberAttackForMovement(int forwardmove, int rightmove,
                                          int curmove) {
  ...
  if (pm->ps->saber[0].jumpAtkRightMove != LS_INVALID) {
    if (pm->ps->saber[0].jumpAtkRightMove != LS_NONE) { // actually overriding
      overrideJumpRightAttackMove =
          (saberMoveName_t)pm->ps->saber[0].jumpAtkRightMove;
    } else if (pm->ps->dualSabers &&
               pm->ps->saber[1].jumpAtkRightMove >
                   LS_NONE) { // would be cancelling it, but check the second
                              // saber, too
      overrideJumpRightAttackMove =
          (saberMoveName_t)pm->ps->saber[1].jumpAtkRightMove;
    } else { // nope, just cancel it
      overrideJumpRightAttackMove = LS_NONE;
    }
  } else if (pm->ps->dualSabers &&
             pm->ps->saber[1].jumpAtkRightMove !=
                 LS_INVALID) { // first saber not overridden, check second
    overrideJumpRightAttackMove =
        (saberMoveName_t)pm->ps->saber[1].jumpAtkRightMove;
  }
  ...
  if (pm->ps->saber[0].jumpAtkLeftMove != LS_INVALID) {
    if (pm->ps->saber[0].jumpAtkLeftMove != LS_NONE) { // actually overriding
      overrideJumpLeftAttackMove =
          (saberMoveName_t)pm->ps->saber[0].jumpAtkLeftMove;
    } else if (pm->ps->dualSabers &&
               pm->ps->saber[1].jumpAtkLeftMove >
                   LS_NONE) { // would be cancelling it, but check the second
                              // saber, too
      overrideJumpLeftAttackMove =
          (saberMoveName_t)pm->ps->saber[1].jumpAtkLeftMove;
    } else { // nope, just cancel it
  ...
  if (rightmove > 0) { // moving right
    if (!noSpecials && overrideJumpRightAttackMove != LS_NONE &&
        (pm->ps->groundEntityNum != ENTITYNUM_NONE ||
         level.time - pm->ps->lastOnGround <= 250) // on ground or just jumped
        && (pm->cmd.buttons & BUTTON_ATTACK)       // hitting attack
        && pm->ps->forcePowerLevel[FP_LEVITATION] >
               FORCE_LEVEL_0 // have force jump 1 at least
        && G_EnoughPowerForSpecialMove(
               pm->ps->forcePower,
               SABER_ALT_ATTACK_POWER_LR) // pm->ps->forcePower >=
                                          // SABER_ALT_ATTACK_POWER_LR//have
                                          // enough power
        &&
        (((pm->ps->clientNum >= MAX_CLIENTS && !PM_ControlledByPlayer()) &&
          pm->cmd.upmove > 0) // jumping NPC
         || ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
             G_TryingCartwheel(
                 pm->gent,
                 &pm->cmd) /*(pm->cmd.buttons&BUTTON_FORCE_FOCUS)*/))) // focus-holding
                                                                       // player
    { // cartwheel right
      vec3_t right, fwdAngles = {0, pm->ps->viewangles[YAW], 0};
      if (pm->gent) {
        G_DrainPowerForSpecialMove(pm->gent, FP_LEVITATION,
                                   SABER_ALT_ATTACK_POWER_LR);
      }
      pm->cmd.upmove = 0;
      if (overrideJumpRightAttackMove !=
          LS_INVALID) { // overridden with another move
        ...
        if (!(pm->ps->saber[0].saberFlags & SFL_NO_CARTWHEELS) &&
            (!pm->ps->dualSabers ||
             !(pm->ps->saber[1].saberFlags &
               SFL_NO_CARTWHEELS))) { // okay to do cartwheels with this saber
          /*
          ...
          */
          { // in air
            ...
            return LS_JUMPATTACK_ARIAL_RIGHT;
               ...
               pm->ps->legsAnim !=
                   BOTH_ARIAL_RIGHT) { // not in a cartwheel/arial
      if (pm->ps->clientNum < MAX_CLIENTS ||
          PM_ControlledByPlayer()) // PLAYER ONLY
      {                            // player
        if (G_TryingSpecial(
                pm->gent,
                &pm->cmd) /*(pm->cmd.buttons&BUTTON_FORCE_FOCUS)*/) // Holding
                                                                    // focus
      ...
      if (forwardmove > 0) { // forward right = TL2BR slash
        return LS_A_TL2BR;
      } else if (forwardmove < 0) { // backward right = BL2TR uppercut
        return LS_A_BL2TR;
      } else { // just right is a left slice
        return LS_A_L2R;
      }
    }
  } else if (rightmove < 0) { // moving left
    if (!noSpecials && overrideJumpLeftAttackMove != LS_NONE &&
        (pm->ps->groundEntityNum != ENTITYNUM_NONE ||
         level.time - pm->ps->lastOnGround <= 250) // on ground or just jumped
        && (pm->cmd.buttons & BUTTON_ATTACK)       // hitting attack
        && pm->ps->forcePowerLevel[FP_LEVITATION] >
    ...
    { // cartwheel left
          ...
          */
          {
            ...
            return LS_JUMPATTACK_CART_LEFT;
               ...
               pm->ps->legsAnim !=
                   BOTH_ARIAL_LEFT) { // not in a left cartwheel/arial
      if (pm->ps->clientNum < MAX_CLIENTS ||
          PM_ControlledByPlayer()) // PLAYER ONLY
      {                            // player
        if (G_TryingSpecial(
      ...
      // check regular attacks
      if (forwardmove > 0) { // forward left = TR2BL slash
        return LS_A_TR2BL;
      } else if (forwardmove < 0) { // backward left = BR2TL uppercut
        return LS_A_BR2TL;
    ...
    if (forwardmove > 0) { // forward= T2B slash
      ...
      {                   // player in thirdperson, not zoomed in
        ...
        if (!noSpecials && PM_CheckFlipOverAttackMove(
                               qfalse)) { // flip over-forward down-attack
          return PM_SaberFlipOverAttackMove();
        }
        // lunge attack logic
      ...
      if (pm->gent && pm->gent->enemy &&
          pm->gent->enemy->client) { // I have an active enemy
        if (pm->ps->clientNum < MAX_CLIENTS ||
            PM_ControlledByPlayer()) { // a player who is running at an enemy
          // if the enemy is not a jedi, don't use top-down, pick a diagonal or
          // side attack
          if (pm->gent->enemy->s.weapon != WP_SABER &&
              pm->gent->enemy->client->NPC_class !=
                  CLASS_REMOTE // too small to do auto-aiming accurately
              && pm->gent->enemy->client->NPC_class !=
                     CLASS_SEEKER // too small to do auto-aiming accurately
              && pm->gent->enemy->client->NPC_class !=
                     CLASS_GONK // too short to do auto-aiming accurately
              && pm->gent->enemy->client->NPC_class !=
                     CLASS_HOWLER // too short to do auto-aiming accurately
              && g_saberAutoAim->integer) {
            saberMoveName_t autoMove = PM_AttackForEnemyPos(
                qfalse, (qboolean)(pm->ps->clientNum >= MAX_CLIENTS &&
                                   !PM_ControlledByPlayer()));
        ...
        if (pm->ps->clientNum >= MAX_CLIENTS &&
            !PM_ControlledByPlayer()) // NPC ONLY
        {                             // NPC
      ...
      // check regular attacks
      return LS_A_T2B;
    } else if (forwardmove < 0) { // backward= T2B slash//B2T uppercut?
      if (g_saberNewControlScheme->integer) {
      ...
      if (g_saberNewControlScheme->integer &&
          (pm->ps->clientNum < MAX_CLIENTS ||
           PM_ControlledByPlayer())                  // PLAYER ONLY
          && (pm->cmd.buttons & BUTTON_FORCE_FOCUS)) // Holding focus, trying
                                                     // special backwards attacks
      {                         // player lunge attack logic
        if ((pm->ps->dualSabers // or dual
             || pm->ps->saberAnimLevel ==
                    SS_STAFF) // pm->ps->SaberStaff() )//or staff
            &&
        ...
        { // alt+back+attack using fast, dual or staff attacks
          PM_SaberLungeAttackMove(qfalse);
                 ...
                 || ((pm->ps->clientNum < MAX_CLIENTS ||
                      PM_ControlledByPlayer()) &&
                     cg.renderingThirdPerson &&
                     !cg.zoomMode)) // player in third person, not zooomed
      {                             // NPC or player in third person, not zoomed
        ...
        if (!(pm->ps->saber[0].saberFlags & SFL_NO_BACK_ATTACK) &&
            (!pm->ps->dualSabers ||
             !(pm->ps->saber[1].saberFlags &
               SFL_NO_BACK_ATTACK))) { // okay to do backstabs with this saber
          if (pm->ps->groundEntityNum != ENTITYNUM_NONE) { // only when on
                                                           // ground
            if (pm->gent &&
                pm->gent->enemy) { // FIXME: or just trace for a valid enemy
                                   // standing behind me?  And no enemy in front?
              vec3_t enemyDir, faceFwd,
                  facingAngles = {0, pm->ps->viewangles[YAW], 0};
              AngleVectors(facingAngles, faceFwd, NULL, NULL);
              VectorSubtract(pm->gent->enemy->currentOrigin, pm->ps->origin,
                             enemyDir);
              float dot = DotProduct(enemyDir, faceFwd);
              if (dot < 0) { // enemy is behind me
                if (dot < -0.75f &&
                    DistanceSquared(pm->gent->currentOrigin,
                                    pm->gent->enemy->currentOrigin) <
                        16384 // 128 squared
                    && (pm->ps->saberAnimLevel == SS_FAST ||
                        pm->ps->saberAnimLevel == SS_STAFF ||
                        (pm->gent->client &&
                         (pm->gent->client->NPC_class == CLASS_TAVION ||
                          pm->gent->client->NPC_class == CLASS_ALORA) &&
                         Q_irand(0, 1)))) { // fast attacks and Tavion
                  if (!(pm->ps->pm_flags & PMF_DUCKED) &&
                      pm->cmd.upmove >= 0) { // can't do it while ducked?
                    if ((pm->ps->clientNum < MAX_CLIENTS ||
                         PM_ControlledByPlayer()) ||
                        (pm->gent->NPC && pm->gent->NPC->rank >=
                                              RANK_LT_JG)) { // only fencers and
                                                             // above can do this
                      return LS_A_BACKSTAB;
                    }
                  }
                           ...
                           pm->ps->saberAnimLevel !=
                               SS_STAFF) { // medium and higher attacks
                  if ((pm->ps->pm_flags & PMF_DUCKED) || pm->cmd.upmove < 0) {
                    return LS_A_BACK_CR;
                  } else {
                    return LS_A_BACK;
                ...
                float enemyDistSq = DistanceSquared(
                ...
                { // my enemy is pretty far in front of me and I'm using fast
                  // attacks
                  if ((pm->ps->clientNum < MAX_CLIENTS ||
                       PM_ControlledByPlayer()) ||
                      (pm->gent && pm->gent->client && pm->gent->NPC &&
                       pm->gent->NPC->rank >= RANK_LT_JG &&
                       Q_irand(0, pm->gent->NPC->rank) >
                           RANK_ENSIGN)) { // only fencers and higher can do
                                           // this, higher rank does it more
                    if (PM_CheckEnemyInBack(128)) {
                      return PM_PickBackStab();
                             ...
                             pm->gent->client->NPC_class == CLASS_DESANN) &&
                            enemyDistSq > 40000) ||
                           pm->gent->enemy->health <= 0) // 200 squared
            ...
            } else { // no current enemy
              if ((pm->ps->clientNum < MAX_CLIENTS ||
                   PM_ControlledByPlayer()) &&
                  pm->gent && pm->gent->client) { // only player
                if (PM_CheckEnemyInBack(128)) {
                  return PM_PickBackStab();
                }
              }
      ...
      return LS_A_T2B;
    } else { // not moving in any direction
      if (PM_SaberInBounce(
              curmove)) { // bounces should go to their default attack if you
                          // don't specify a direction but are attacking
        if (pm->ps->clientNum < MAX_CLIENTS ||
            PM_ControlledByPlayer())               // PLAYER ONLY
        {                                          // player
          if (G_TryingSpecial(pm->gent, &pm->cmd)) //(pm->cmd.buttons&BUTTON_FORCE_FOCUS)
      ...
      } else if (PM_SaberInKnockaway(
                     curmove)) { // bounces should go to their default attack if
                                 // you don't specify a direction but are
                                 // attacking
        if (pm->ps->clientNum < MAX_CLIENTS ||
            PM_ControlledByPlayer())               // PLAYER ONLY
        {                                          // player
        ...
        if (pm->ps->clientNum && !PM_ControlledByPlayer() &&
          ...
          if (pm->ps->saberAnimLevel == SS_FAST ||
              pm->ps->saberAnimLevel ==
                  SS_TAVION) { // player is in fast attacks, so come right back
                               // down from the same spot
            newmove = PM_AttackMoveForQuad(saberMoveData[curmove].endQuad);
          } else { // use a transition to wrap to another attack from a
                   // different dir
            newmove = saberMoveData[curmove].chain_attack;
          }
        }
      ...
      } else if (curmove == LS_READY || curmove == LS_A_FLIP_STAB ||
                 curmove == LS_A_FLIP_SLASH ||
                 (curmove >= LS_PARRY_UP &&
                  curmove <= LS_REFLECT_LL)) { // Not moving at all, not too
                                               // busy to attack
        ...
        // checked all special attacks, if we're in a parry, attack from that
        // move
        saberMoveName_t parryAttackMove =
            PM_CheckPlayerAttackFromParry(curmove);
        if (parryAttackMove != LS_NONE) {
          return parryAttackMove;
        }
        // check regular attacks
        if (pm->ps->clientNum || g_saberAutoAim->integer) { // auto-aim
          if (pm->gent &&
              pm->gent
                  ->enemy) { // based on enemy position, pick a proper attack
            saberMoveName_t autoMove = PM_AttackForEnemyPos(
                qtrue, (qboolean)(pm->ps->clientNum >= MAX_CLIENTS));
            if (autoMove != LS_INVALID) {
              return autoMove;
            }
          } else if (fabs(pm->ps->viewangles[0]) >
                     30) { // looking far up or far down uses the top to bottom
                           // attack, presuming you want a vertical attack
            return LS_A_T2B;
          }
        } else { // for now, just pick a random attack
...
saberMoveName_t PM_SaberAnimTransitionMove(saberMoveName_t curmove,
                                           saberMoveName_t newmove) {
  ...
  if (curmove == LS_READY) { // just standing there
    ...
    case LS_A_TR2BL:
    case LS_A_T2B:
      if (newmove == curmove) { // FIXME: need a spin or something or go to next
                                // level, but for now, just play the return
        // going into another attack...
        // allow endless chaining in level 1 attacks, several in level 2 and
        // only one or a few in level 3
        // FIXME: don't let strong attacks chain to an attack in the opposite
        // direction ( > 45 degrees?)
        if (PM_SaberKataDone(curmove,
                             newmove)) { // done with this kata, must return to
                                         // ready before attack again
          retmove = LS_R_TL2BR + (newmove - LS_A_TL2BR);
        } else { // okay to chain to another attack
          retmove = transitionMove[saberMoveData[curmove].endQuad]
                                  [saberMoveData[newmove].startQuad];
        }
      } else if (saberMoveData[curmove].endQuad ==
                 saberMoveData[newmove]
                     .startQuad) { // new move starts from same quadrant
        retmove = newmove;
      } else {
        switch (curmove) {
        // transitioning from an attack
...
int PM_LegsAnimForFrame(gentity_t *ent, int legsFrame) {
  ...
  for (int animation = 0; animation < BOTH_CIN_1;
       animation++) // first anim after last legs
  {
    if (animation >= TORSO_DROPWEAP1 &&
        animation < LEGS_TURN1) // first legs only anim
    ...
    if (animations[animation].firstFrame >
        legsFrame) { // This anim starts after this frame
      continue;
    }

    if (animations[animation].firstFrame + animations[animation].numFrames <
        legsFrame) { // This anim ends before this frame
      continue;
    }
...
int PM_ValidateAnimRange(
    const int startFrame, const int endFrame,
    const float animSpeed) { // given a startframe and endframe, see if that
                             // lines up with any known animation
  animation_t *animations = level.knownAnimFileSets[0].animations;

  for (int anim = 0; anim < MAX_ANIMATIONS; anim++) {
    if (animSpeed < 0) { // playing backwards
      if (animations[anim].firstFrame == endFrame) {
        if (animations[anim].numFrames + animations[anim].firstFrame ==
            startFrame) {
      ...
      if (animations[anim].firstFrame ==
          startFrame) { // This anim starts on this frame
        if (animations[anim].firstFrame + animations[anim].numFrames ==
            endFrame) { // This anim ends on this frame
...
int PM_TorsoAnimForFrame(gentity_t *ent, int torsoFrame) {
  ...
  for (int animation = 0; animation < LEGS_TURN1;
       animation++) // first legs only anim
  {
    if (animations[animation].glaIndex != glaIndex) {
      continue;
    }
    ...
    if (animations[animation].firstFrame >
        torsoFrame) { // This anim starts after this frame
      continue;
    }

    if (animations[animation].firstFrame + animations[animation].numFrames <
        torsoFrame) { // This anim ends before this frame
      continue;
    }
    // else, must be in this anim!
    return animation;
...
qboolean PM_FinishedCurrentLegsAnim(gentity_t *self) {
  ...
  gi.G2API_GetBoneAnimIndex(&self->ghoul2[self->playerModel], self->rootBone,
                            (cg.time ? cg.time : level.time), &currentFrame,
                            &junk, &junk, &junk, &animSpeed, NULL);
  curFrame = floor(currentFrame);

  int legsAnim = self->client->ps.legsAnim;
  animation_t *animations =
      level.knownAnimFileSets[self->client->clientInfo.animFileIndex]
          .animations;

  if (curFrame >=
      animations[legsAnim].firstFrame + (animations[legsAnim].numFrames - 2)) {
    return qtrue;
  }
...
void PM_SetLegsAnimTimer(gentity_t *ent, int *legsAnimTimer, int time) {
  *legsAnimTimer = time;
  ...
  if (!*legsAnimTimer && ent &&
      Q3_TaskIDPending(
          ent, TID_ANIM_LOWER)) { // Waiting for legsAnimTimer to complete, and
                                  // it just got set to zero
    if (!Q3_TaskIDPending(ent, TID_ANIM_BOTH)) { // Not waiting for top
      Q3_TaskIDComplete(ent, TID_ANIM_LOWER);
    } else { // Waiting for both to finish before complete
      Q3_TaskIDClear(&ent->taskID[TID_ANIM_LOWER]); // Bottom is done,
                                                    // regardless
      if (!Q3_TaskIDPending(ent, TID_ANIM_UPPER)) { // top is done and we're
                                                    // done
...
void PM_SetTorsoAnimTimer(gentity_t *ent, int *torsoAnimTimer, int time) {
  *torsoAnimTimer = time;
  ...
  if (!*torsoAnimTimer && ent &&
      Q3_TaskIDPending(
          ent, TID_ANIM_UPPER)) { // Waiting for torsoAnimTimer to complete, and
                                  // it just got set to zero
    if (!Q3_TaskIDPending(ent, TID_ANIM_BOTH)) { // Not waiting for bottom
      ...
      if (!Q3_TaskIDPending(ent,
                            TID_ANIM_LOWER)) { // lower is done and we're done
        Q3_TaskIDComplete(ent, TID_ANIM_BOTH);
      }
    }
  }
...
void PM_SaberStartTransAnim(int saberAnimLevel, int anim, float *animSpeed,
  ...
  if (gent && gent->client &&
      ...
      gent->client->ps.dualSabers && saberAnimLevel == SS_DUAL &&
      gent->weaponModel[1]) { // using a scepter and dual style, slow down anims
    if (anim >= BOTH_A1_T__B_ && anim <= BOTH_H7_S7_BR) {
      *animSpeed *= 0.75;
    }
  }
  if (gent && gent->client &&
      gent->client->ps.forceRageRecoveryTime > level.time) { // rage recovery
    if (anim >= BOTH_A1_T__B_ && anim <= BOTH_H1_S1_BR) {    // animate slower
      *animSpeed *= 0.75;
    }
  } else if (gent && gent->NPC &&
             gent->NPC->rank == RANK_CIVILIAN) { // grunt reborn
    if (anim >= BOTH_A1_T__B_ &&
        anim <= BOTH_R1_TR_S1) { // his fast attacks are slower
    ...
    if (gent->client->ps.saber[0].type == SABER_LANCE ||
        gent->client->ps.saber[0].type ==
            SABER_TRIDENT) { // FIXME: hack for now - these use the fast anims,
                             // but slowed down.  Should have own style
      if (anim >= BOTH_A1_T__B_ &&
          anim <= BOTH_R1_TR_S1) { // his fast attacks are slower
        if (!PM_SpinningSaberAnim(anim)) {
          *animSpeed *= 0.75;
  ...
  if ((anim >= BOTH_T1_BR__R && anim <= BOTH_T1_BL_TL) ||
    ...
    if (saberAnimLevel == FORCE_LEVEL_1 ||
        saberAnimLevel ==
            FORCE_LEVEL_5) { // FIXME: should not be necc for FORCE_LEVEL_1's
      *animSpeed *= 1.5;
...
/*
void PM_SaberStartTransAnim( int anim, int entNum, int saberOffenseLevel, float
*animSpeed )
{
        //check starts
...
float PM_GetTimeScaleMod(gentity_t *gent) {
  if (g_timescale->value) {
    if (!MatrixMode && gent->client->ps.legsAnim != BOTH_FORCELONGLEAP_START &&
        gent->client->ps.legsAnim != BOTH_FORCELONGLEAP_ATTACK &&
        gent->client->ps.legsAnim != BOTH_FORCELONGLEAP_LAND) {
      if (gent && gent->s.clientNum == 0 && !player_locked &&
...
void PM_SetAnimFinal(int *torsoAnim, int *legsAnim, int setAnimParts, int anim,
                     int setAnimFlags, int *torsoAnimTimer, int *legsAnimTimer,
                     gentity_t *gent, int blendTime) // default blendTime=350
{
  ...
  if (anim < 0 || anim >= MAX_ANIMATIONS ||
      !ValidAnimFileIndex(gent->client->clientInfo.animFileIndex)) {
#ifndef FINAL_BUILD
    if (g_AnimWarning->integer) {
      if (anim < 0 || anim >= MAX_ANIMATIONS) {
        ...
        gi.Printf(S_COLOR_RED
                  "PM_SetAnimFinal: Invalid Anim File Index (%d)!\n",
  ...
  const animation_t *animations =
      level.knownAnimFileSets[gent->client->clientInfo.animFileIndex]
          .animations;
  ...
  if (animations[anim].numFrames == 0) {
    ...
    if (LastAnimWarningNum != anim) {
      if ((cg_debugAnim.integer == 3) || // 3 = do everyone
          (cg_debugAnim.integer == 1 &&
           gent->s.number == 0) || // 1 = only the player
          (cg_debugAnim.integer == 2 &&
           gent->s.number != 0) || // 2 = only everyone else
          (cg_debugAnim.integer == 4 &&
           gent->s.number != cg_debugAnimTarget.integer) // 4 = specific entnum
      ) {
        gi.Printf(
            S_COLOR_RED
            "PM_SetAnimFinal: Anim %s does not exist in this model (%s)!\n",
  ...
  // If It's Not A Ghoul 2 Model, Just Remember The Anims And Stop, Because
  // Everything Beyond This Is Ghoul2
  //---------------------------------------------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------
  PM_SaberStartTransAnim(gent->client->ps.saberAnimLevel, anim, &timeScaleMod,
                         gent);

  // SETUP VALUES FOR INCOMMING ANIMATION
  //======================================
  const bool animFootMove =
      (PM_WalkingAnim(anim) || PM_RunningAnim(anim) ||
       anim == BOTH_CROUCH1WALK || anim == BOTH_CROUCH1WALKBACK);
  ...
  float animSpeed = (50.0f / curAnim.frameLerp *
                     timeScaleMod); // animSpeed is 1.0 if the frameLerp
                                    // (ms/frame) is 50 (20 fps).
  const float animFPS = (::abs(curAnim.frameLerp));
  const int animDurMSec =
      (int)(((curAnim.numFrames - 1) * animFPS) / timeScaleMod);
  const int animHoldMSec =
      ((animHoldless && timeScaleMod == 1.0f)
           ? ((animDurMSec > 1) ? (animDurMSec - 1) : (animFPS))
           : (animDurMSec));
  int animFlags = (curAnim.loopFrames != -1) ? (BONE_ANIM_OVERRIDE_LOOP)
  ...
  // If The Animation Is Walking Or Running, Attempt To Scale The Playback Speed
  // To Match
  //--------------------------------------------------------------------------------------
  if (g_noFootSlide->integer && animFootMove &&
      !(animSpeed < 0.0f)
      // FIXME: either read speed from animation.cfg or only do this for NPCs
      //			for whom we've specifically determined the
      //proper numbers!
  ...
  bool bodyPlay = ((setAnimParts & SETANIM_LEGS) && (bodyBone != -1) &&
                   (animOverride || !bodyTimerOn));
  bool bodyAnimating = !!gi.G2API_GetBoneAnimIndex(
      &gent->ghoul2[gent->playerModel], bodyBone, actualTime, &bodyCurrent,
      &bodyStart, &bodyEnd, &bodyFlags, &bodySpeed, NULL);
  bool bodyOnAnimNow = (bodyAnimating && bodyAnim == anim &&
                        bodyStart == animStart && bodyEnd == animEnd);
  ...
  bool torsPlay = (gent->client->NPC_class != CLASS_RANCOR &&
                   (setAnimParts & SETANIM_TORSO) && (torsBone != -1) &&
                   (animOverride || !torsTimerOn));
  bool torsAnimating = !!gi.G2API_GetBoneAnimIndex(
      &gent->ghoul2[gent->playerModel], torsBone, actualTime, &torsCurrent,
      &torsStart, &torsEnd, &torsFlags, &torsSpeed, NULL);
  bool torsOnAnimNow = (torsAnimating && torsAnim == anim &&
                        torsStart == animStart && torsEnd == animEnd);
  bool torsMatchBodyFrame = false;

  // APPLY SYNC TO TORSO
  //=====================
  if (animSync && torsPlay && !bodyPlay && bodyOnAnimNow &&
      (!torsOnAnimNow || torsCurrent != bodyCurrent)) {
    torsMatchBodyFrame = true;
    animCurrent = bodyCurrent;
  }
  if (animSync && bodyPlay && !torsPlay && torsOnAnimNow &&
      (!bodyOnAnimNow || bodyCurrent != torsCurrent)) {
  ...
  if (!animRestart) {
    torsPlay &=
        !(torsOnAnimNow && torsSpeed == animSpeed && !torsMatchBodyFrame);
    bodyPlay &=
        !(bodyOnAnimNow && bodySpeed == animSpeed && !bodyMatchTorsFrame);
  }
  ...
  if ((cg_debugAnim.integer == 3) || // 3 = do everyone
    ...
    if (bodyPlay || torsPlay) {
      ...
      Com_Printf("[%10d] ent[%3d-%18s] %s anim[%3d] - %s\n", actualTime,
                 gent->s.number, entName, location, anim, animTable[anim].name);
    }
  }
#endif
  ...
  if (torsPlay) {
    *torsoAnim = anim;
    ...
    if (animCurrent != bodyCurrent && torsOnAnimNow && !animRestart &&
        !torsMatchBodyFrame) {
      animCurrent = torsCurrent;
    }
    ...
    gi.G2API_SetBoneAnimIndex(
        &gent->ghoul2[gent->playerModel], torsBone, animStart, animEnd,
        (torsOnAnimNow && !animRestart) ? (animFlags & ~BONE_ANIM_BLEND)
                                        : (animFlags),
        animSpeed, actualTime, animCurrent, blendTime);

    if (gent->motionBone != -1) {
      gi.G2API_SetBoneAnimIndex(&gent->ghoul2[gent->playerModel],
                                gent->motionBone, animStart, animEnd,
                                (torsOnAnimNow && !animRestart)
                                    ? (animFlags & ~BONE_ANIM_BLEND)
                                    : (animFlags),
                                animSpeed, actualTime, animCurrent, blendTime);
    }
    ...
    // If This Animation Is To Be Locked And Held, Calculate The Duration And
    // Set The Timer
    //--------------------------------------------------------------------------------------
  ...
  if (bodyPlay) {
    *legsAnim = anim;
    ...
    gi.G2API_SetAnimIndex(&gent->ghoul2[gent->playerModel], curAnim.glaIndex);
    gi.G2API_SetBoneAnimIndex(
        &gent->ghoul2[gent->playerModel], bodyBone, animStart, animEnd,
        (bodyOnAnimNow && !animRestart) ? (animFlags & ~BONE_ANIM_BLEND)
                                        : (animFlags),
        animSpeed, actualTime, animCurrent, blendTime);
...
void PM_SetAnim(pmove_t *pm, int setAnimParts, int anim, int setAnimFlags,
                int blendTime) { // FIXME : once torsoAnim and legsAnim are in
                                 // the same structure for NPC and Players
  // rename PM_SetAnimFinal to PM_SetAnim and have both NPC and Players call
  // PM_SetAnim

  if (pm->ps->pm_type >= PM_DEAD) { // FIXME: sometimes we'll want to set anims
                                    // when your dead... twitches, impacts, etc.
    return;
  }
  ...
  if (!pm->gent || pm->gent->health > 0) { // don't lock anims if the guy is
                                           // dead
    if (pm->ps->torsoAnimTimer && PM_LockedAnim(pm->ps->torsoAnim) &&
        !PM_LockedAnim(anim)) { // nothing can override these special anims
      setAnimParts &= ~SETANIM_TORSO;
    }

    if (pm->ps->legsAnimTimer && PM_LockedAnim(pm->ps->legsAnim) &&
        !PM_LockedAnim(anim)) { // nothing can override these special anims
  ...
  PM_SetAnimFinal(&pm->ps->torsoAnim, &pm->ps->legsAnim, setAnimParts, anim,
                  setAnimFlags, &pm->ps->torsoAnimTimer, &pm->ps->legsAnimTimer,
                  &g_entities[pm->ps->clientNum], blendTime); // was pm->gent
}
  ...
  if (ent &&         // valid ent
      ...
      (ent->client->ps.weapon != WP_SABER ||
       ent->client->ps.saberMove ==
           LS_READY) && // either not holding a saber or the saber is in the
                        // ready pose
      ...
      if (gi.WE_GetWindVector(windDir, ent->currentOrigin)) {
        ...
        if (DotProduct(fwd, windDir) > 0.65f) {
          if (ent->client && ent->client->ps.torsoAnim != BOTH_WIND) {
            NPC_SetAnim(ent, SETANIM_TORSO, BOTH_WIND, SETANIM_FLAG_NORMAL,
                        400);
          }
          return true;
        }
...
// only does idle-ish anims.  Anything that has a timer associated, such as
// attacks and blocks, are set by PM_WeaponLightsaber()
...
void PM_TorsoAnimLightsaber() {
  ...
  if (pm->ps->forcePowersActive & (1 << FP_GRIP) &&
      pm->ps->forcePowerLevel[FP_GRIP] >
          FORCE_LEVEL_1) { // holding an enemy aloft with force-grip
    return;
  }

  if (pm->ps->forcePowersActive & (1 << FP_LIGHTNING) &&
      pm->ps->forcePowerLevel[FP_LIGHTNING] > FORCE_LEVEL_1) { // lightning
    return;
  }

  if (pm->ps->forcePowersActive & (1 << FP_DRAIN)) { // drain
    return;
  }
  ...
  if (pm->ps->weaponTime > 0) { // weapon is already busy.
    if (pm->ps->torsoAnim == BOTH_TOSS1 ||
        pm->ps->torsoAnim == BOTH_TOSS2) { // in toss
      if (!pm->ps->torsoAnimTimer) {       // weird, get out of it, I guess
  ...
  if (pm->ps->weaponstate == WEAPON_READY ||
    ...
    if (pm->ps->weapon == WP_SABER && (pm->ps->SaberLength())) { // saber is on
      ...
      if (pm->ps->saberMove > LS_READY && pm->ps->saberMove < LS_MOVE_MAX) {
        ...
        if (PM_JumpingAnim(pm->ps->legsAnim) ||
          ...
          if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
              pm->ps->torsoAnim == BOTH_BUTTON_HOLD) { // using something
            if (!pm->ps->useTime) { // stopped holding it, release
            ...
            if ((PM_RunningAnim(pm->ps->legsAnim) ||
                ...
                pm->ps->saberBlockingTime <
                    cg.time) { // running w/1-handed weapon uses full-body anim
              PM_SetAnim(pm, SETANIM_TORSO, pm->ps->legsAnim,
                         SETANIM_FLAG_NORMAL);
            } else {
    ...
    } else if (pm->ps->legsAnim ==
               BOTH_RUN2) //&& pm->ps->saberAnimLevel != SS_STAFF )
    {
      ...
      pm->ps->saberMove = LS_READY;
    } else if (pm->ps->legsAnim == BOTH_CROUCH1IDLE &&
               pm->ps->clientNum != 0) // player falls through
    {
      ...
      pm->ps->saberMove = LS_READY;
    } else { // Used to default to both_stand1 which is an arms-down anim
      //				PM_SetAnim(pm,SETANIM_TORSO,BOTH_ATTACK1,SETANIM_FLAG_NORMAL);//TORSO_WEAPONREADY1
      // Select the next proper pose for the lightsaber assuming that there are
      // no attacks.
      if (pm->ps->saberMove > LS_READY && pm->ps->saberMove < LS_MOVE_MAX) {
        PM_SetSaberMove(saberMoveData[pm->ps->saberMove].chain_idle);
      } else {
  ...
  // *********************************************************
    ...
    if (TorsoAgainstWindTest(pm->gent)) {
      ...
      PM_SetAnim(pm, SETANIM_TORSO, BOTH_GUARD_LOOKAROUND1,
                 SETANIM_FLAG_NORMAL);
      pm->ps->saberMove = LS_READY;
      ...
      // Idle for Lightsaber
      if (pm->gent && pm->gent->client) {
        //				pm->gent->client->saberTrail.inAction =
        //qfalse;
      }

      qboolean saberInAir = qtrue;
      if (pm->ps->saberInFlight) { // guiding saber
        if (PM_SaberInBrokenParry(pm->ps->saberMove) ||
            pm->ps->saberBlocked == BLOCKED_PARRY_BROKEN ||
            PM_DodgeAnim(pm->ps->torsoAnim)) { // we're stuck in a broken parry
          saberInAir = qfalse;
        }
        if (pm->ps->saberEntityNum < ENTITYNUM_NONE &&
            pm->ps->saberEntityNum > 0) // player is 0
        {                               //
          if (&g_entities[pm->ps->saberEntityNum] != NULL &&
              g_entities[pm->ps->saberEntityNum].s.pos.trType ==
                  TR_STATIONARY) { // fell to the ground and we're not trying to
                                   // pull it back
            saberInAir = qfalse;
          }
        }
      ...
      if (pm->ps->saberInFlight && saberInAir &&
        ...
        if (!PM_ForceAnim(pm->ps->torsoAnim) ||
            pm->ps->torsoAnimTimer <
                300) { // don't interrupt a force power anim
          ...
          if (PM_JumpingAnim(pm->ps->legsAnim) ||
            ...
            if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
              ...
              if ((PM_RunningAnim(pm->ps->legsAnim) ||
                   ...
                   pm->ps->legsAnim == BOTH_WALKBACK_DUAL) &&
                  pm->ps->saberBlockingTime <
                      cg.time) { // running w/1-handed weapon uses full-body
                                 // anim
...
void PM_TorsoAnimation(void) { // FIXME: Write a much smarter and more
                               // appropriate anim picking routine logic...
  //	int	oldAnim;
  if (PM_InKnockDown(pm->ps) || PM_InRoll(pm->ps)) { // in knockdown
    return;
  }
  ...
  if ((pm->ps->eFlags & EF_FORCE_DRAINED)) { // being drained
    // PM_SetAnim( pm, SETANIM_TORSO, BOTH_HUGGEE1,
    // SETANIM_FLAG_OVERRIDE|SETANIM_FLAG_HOLD );
    return;
  }
  if ((pm->ps->forcePowersActive & (1 << FP_DRAIN)) &&
      pm->ps->forceDrainEntityNum < ENTITYNUM_WORLD) { // draining
    // PM_SetAnim( pm, SETANIM_TORSO, BOTH_HUGGER1,
    // SETANIM_FLAG_OVERRIDE|SETANIM_FLAG_HOLD );
    return;
  }

  if (pm->gent && pm->gent->NPC &&
      (pm->gent->NPC->scriptFlags & SCF_FORCED_MARCH)) {
    return;
  }
  ...
  if (pm->gent && pm->ps && pm->ps->eFlags & EF_LOCKED_TO_WEAPON) {
    if (pm->gent->owner &&
        pm->gent->owner->e_UseFunc ==
            useF_emplaced_gun_use) // ugly way to tell, but...
    {                              // full body
      PM_SetAnim(pm, SETANIM_BOTH, BOTH_GUNSIT1,
                 SETANIM_FLAG_OVERRIDE |
                     SETANIM_FLAG_HOLD); // SETANIM_FLAG_NORMAL
    } else {                             // torso
  ...
  /*	else if ( pm->gent && pm->gent->client && pm->gent->client->NPC_class ==
     CLASS_VEHICLE && pm->ps->clientNum < MAX_CLIENTS &&
     (m_pVehicleInfo[((CVehicleNPC *)pm->gent->NPC)->m_iVehicleTypeID].numHands
     == 2 || g_speederControlScheme->value == 2) )
          {//can't look around
                  PM_SetAnim(pm,SETANIM_TORSO,m_pVehicleInfo[((CVehicleNPC
     *)pm->gent->NPC)->m_iVehicleTypeID].riderAnim,SETANIM_FLAG_OVERRIDE|SETANIM_FLAG_HOLD);
                  return;
          }*/
  ...
  if (pm->ps->taunting > level.time) {
    if (pm->gent && pm->gent->client &&
        pm->gent->client->NPC_class == CLASS_ALORA) {
      PM_SetAnim(pm, SETANIM_BOTH, BOTH_ALORA_TAUNT,
                 SETANIM_FLAG_OVERRIDE |
                     SETANIM_FLAG_HOLD); // SETANIM_FLAG_NORMAL
    } else if (pm->ps->weapon == WP_SABER &&
               pm->ps->saberAnimLevel == SS_DUAL &&
               PM_HasAnimation(pm->gent, BOTH_DUAL_TAUNT)) {
      PM_SetAnim(pm, SETANIM_BOTH, BOTH_DUAL_TAUNT,
                 SETANIM_FLAG_OVERRIDE |
                     SETANIM_FLAG_HOLD); // SETANIM_FLAG_NORMAL
    } else if (pm->ps->weapon == WP_SABER &&
               pm->ps->saberAnimLevel ==
                   SS_STAFF) // pm->ps->saber[0].type == SABER_STAFF )
    {                        // turn on the blades
      if (PM_HasAnimation(pm->gent, BOTH_STAFF_TAUNT)) {
        PM_SetAnim(pm, SETANIM_BOTH, BOTH_STAFF_TAUNT,
                   SETANIM_FLAG_OVERRIDE |
                       SETANIM_FLAG_HOLD); // SETANIM_FLAG_NORMAL
      }
      /*
      else
      {
              ...
              {//first blade is off
                      ...
                      {//second blade is also off, extend time of this taunt so
      we have enough time to turn them both on pm->ps->taunting = level.time +
      3000;
                      }
              }
              ...
              pm->ps->torsoAnimTimer = pm->ps->legsAnimTimer = (pm->ps->taunting
      - level.time);
      }
      */
    } else if (PM_HasAnimation(pm->gent, BOTH_GESTURE1)) {
      PM_SetAnim(pm, SETANIM_BOTH, BOTH_GESTURE1,
                 SETANIM_FLAG_OVERRIDE |
                     SETANIM_FLAG_HOLD); // SETANIM_FLAG_NORMAL
  ...
  if (pm->ps->weapon == WP_SABER) // WP_LIGHTSABER
  {
    ...
    if (pm->ps->SaberLength() && !pm->ps->saberInFlight) {
      ...
      if (PM_SaberInBrokenParry(pm->ps->saberMove) ||
        ...
        if (pm->ps->saberInFlight && saberInAir &&
          ...
          if (PM_InSlopeAnim(
                  pm->ps->legsAnim)) { // HMM... this probably breaks the saber
                                       // putaway and select anims
    ...
    if (pm->ps->weaponTime <= 0 &&
        (pm->ps->saberMove == LS_READY || pm->ps->SaberLength() == 0) &&
        !saberInAir) {
  ...
  if (PM_ForceAnim(pm->ps->torsoAnim) &&
      pm->ps->torsoAnimTimer > 0) { // in a force anim, don't do a stand anim
    return;
  }
  ...
  if (pm->ps->weapon == WP_NONE) {
    ...
    return;
             ...
             cg.zoomTime >
                 cg.time - 5000) { // if we used binoculars recently, aim weapon
    weaponBusy = qtrue;
    pm->ps->weaponstate = WEAPON_IDLE;
  } else if (pm->ps->pm_flags &
             PMF_DUCKED) { // ducking is considered on alert... plus looks
                           // stupid to have arms hanging down when crouched
    weaponBusy = qtrue;
  }
  ...
  if (pm->ps->weapon == WP_NONE || pm->ps->weaponstate == WEAPON_READY ||
    ...
    if (pm->ps->weapon == WP_SABER && pm->ps->SaberLength()) {
      PM_SetAnim(pm, SETANIM_TORSO, BOTH_ATTACK1,
                 SETANIM_FLAG_NORMAL); // TORSO_WEAPONREADY1
    } else if (pm->ps->legsAnim == BOTH_RUN1 && !weaponBusy) {
      PM_SetAnim(pm, SETANIM_TORSO, BOTH_RUN1, SETANIM_FLAG_NORMAL);
    } else if (pm->ps->legsAnim == BOTH_RUN2 &&
               !weaponBusy) //&& pm->ps->saberAnimLevel != SS_STAFF )
    {
      PM_SetAnim(pm, SETANIM_TORSO, BOTH_RUN2, SETANIM_FLAG_NORMAL);
      ...
      if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
        ...
        if (!pm->ps->useTime) { // stopped holding it, release
          PM_SetAnim(pm, SETANIM_TORSO, BOTH_BUTTON_RELEASE,
                 ...
                 (pm->gent->s.number < MAX_CLIENTS ||
                  G_ControlledByPlayer(pm->gent)) &&
                 pm->ps->weaponstate != WEAPON_CHARGING &&
                 pm->ps->weaponstate !=
                     WEAPON_CHARGING_ALT) { // PLayer- temp hack for weapon
                                            // frame
        if (pm->gent && pm->gent->client &&
            pm->gent->client->NPC_class == CLASS_RANCOR) { // ignore
        } else if (pm->ps->weapon == WP_MELEE) {           // hehe
          PM_SetAnim(pm, SETANIM_TORSO, BOTH_STAND6, SETANIM_FLAG_NORMAL);
        } else {
          PM_SetAnim(pm, SETANIM_TORSO, BOTH_STAND1, SETANIM_FLAG_NORMAL);
        }
      } else if (PM_InSpecialJump(
                     pm->ps->legsAnim)) { // use legs anim
                                          // FIXME: or just use whatever's
                                          // currently playing? PM_SetAnim( pm,
                                          // SETANIM_TORSO, pm->ps->legsAnim,
                                          // SETANIM_FLAG_NORMAL );
      } else {
        switch (pm->ps->weapon) {
        // ********************************************************
        case WP_SABER: // WP_LIGHTSABER
          ...
          //					PM_SetAnim(pm,SETANIM_TORSO,BOTH_ATTACK1,SETANIM_FLAG_NORMAL);//TORSO_WEAPONREADY1
          // Select the next proper pose for the lightsaber assuming that there
          // are no attacks.
        ...
        case WP_BLASTER_PISTOL:
          if (pm->gent && pm->gent->weaponModel[1] > 0) { // dual pistols
            if (weaponBusy) {
              PM_SetAnim(pm, SETANIM_TORSO, BOTH_GUNSIT1, SETANIM_FLAG_NORMAL);
                       ...
                       PM_JumpingAnim(pm->ps->legsAnim) ||
                       PM_SwimmingAnim(
                           pm->ps->legsAnim)) { // running w/1-handed weapon
                                                // uses full-body anim
              PM_SetAnim(pm, SETANIM_TORSO, pm->ps->legsAnim,
                         SETANIM_FLAG_NORMAL);
            } else {
        ...
        case WP_MELEE:
          if (PM_RunningAnim(pm->ps->legsAnim) ||
              PM_WalkingAnim(pm->ps->legsAnim) ||
              PM_JumpingAnim(pm->ps->legsAnim) ||
              PM_SwimmingAnim(pm->ps->legsAnim)) { // running w/1-handed weapon
                                                   // uses full-body anim
            PM_SetAnim(pm, SETANIM_TORSO, pm->ps->legsAnim,
                       SETANIM_FLAG_NORMAL);
          } else {
            if (pm->gent && pm->gent->client &&
                pm->gent->client->NPC_class == CLASS_RANCOR) { // ignore
                       ...
                       !PM_DroidMelee(pm->gent->client->NPC_class)) {
              PM_SetAnim(pm, SETANIM_TORSO, BOTH_STAND6, SETANIM_FLAG_NORMAL);
            } else {
              PM_SetAnim(pm, SETANIM_TORSO, BOTH_STAND1, SETANIM_FLAG_NORMAL);
            }
        ...
        case WP_TUSKEN_RIFLE:
          if ((pm->ps->weaponstate != WEAPON_FIRING &&
              ...
              PM_WalkingAnim(pm->ps->legsAnim) ||
              PM_JumpingAnim(pm->ps->legsAnim) ||
              PM_SwimmingAnim(pm->ps->legsAnim)) { // running sniper weapon uses
                                                   // normal ready
            if (pm->ps->clientNum) {
              PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONREADY3,
                         SETANIM_FLAG_NORMAL);
            ...
            if (pm->ps->clientNum) {
              PM_SetAnim(
                  pm, SETANIM_TORSO, TORSO_WEAPONREADY4,
                  SETANIM_FLAG_OVERRIDE |
                      SETANIM_FLAG_HOLD); // TORSO_WEAPONREADY4//SETANIM_FLAG_RESTART|
            } else {
        ...
        case WP_THERMAL:
          if (pm->ps->weaponstate != WEAPON_FIRING &&
            ...
            if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
                (pm->ps->weaponstate == WEAPON_CHARGING ||
                 pm->ps->weaponstate ==
                     WEAPON_CHARGING_ALT)) { // player pulling back to throw
              if (PM_StandingAnim(pm->ps->legsAnim)) {
                PM_SetAnim(pm, SETANIM_LEGS, BOTH_THERMAL_READY,
                           SETANIM_FLAG_OVERRIDE | SETANIM_FLAG_HOLD);
              } else if (pm->ps->legsAnim ==
                         BOTH_THERMAL_READY) { // sigh... hold it so
                                               // pm_footsteps doesn't override
              ...
              if (weaponBusy) {
                PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONREADY10,
                           SETANIM_FLAG_NORMAL);
              } else {
                PM_SetAnim(pm, SETANIM_TORSO, BOTH_STAND1, SETANIM_FLAG_NORMAL);
              }
        ...
        case WP_REPEATER:
          if (pm->gent && pm->gent->client &&
            ...
            if (pm->gent->alt_fire) {
              ...
              PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONREADY1,
                         SETANIM_FLAG_NORMAL);
            }
          } else {
            PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONREADY3,
    ...
    if (pm->ps->legsAnim == BOTH_GUARD_LOOKAROUND1) {
      ...
      PM_SetAnim(pm, SETANIM_TORSO, BOTH_SWIMFORWARD, SETANIM_FLAG_NORMAL);
                   ...
                   pm->ps
                       ->legsAnim)) { // use legs anim
                                      // FIXME: or just use whatever's currently
                                      // playing? PM_SetAnim( pm, SETANIM_TORSO,
                                      // pm->ps->legsAnim, SETANIM_FLAG_NORMAL );
    } else if ((pm->ps->clientNum < MAX_CLIENTS || PM_ControlledByPlayer()) &&
               pm->ps->torsoAnim == BOTH_BUTTON_HOLD) { // using something
      if (!pm->ps->useTime) { // stopped holding it, release
        PM_SetAnim(pm, SETANIM_TORSO, BOTH_BUTTON_RELEASE,
      ...
      if (!weaponBusy && pm->ps->weapon != WP_BOWCASTER &&
          pm->ps->weapon != WP_REPEATER && pm->ps->weapon != WP_FLECHETTE &&
          ...
          (PM_RunningAnim(pm->ps->legsAnim) ||
           ...
           PM_JumpingAnim(pm->ps->legsAnim) ||
           PM_SwimmingAnim(
               pm->ps->legsAnim))) { // running w/1-handed or light 2-handed
                                     // weapon uses full-body anim if you're not
                                     // using the weapon right now
        PM_SetAnim(pm, SETANIM_TORSO, pm->ps->legsAnim, SETANIM_FLAG_NORMAL);
      } else {
        switch (pm->ps->weapon) {
        // ********************************************************
        ...
        case WP_NOGHRI_STICK:
          if (weaponBusy) {
            ...
            PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONIDLE3,
                       SETANIM_FLAG_NORMAL);
          }
          break;
        ...
        case WP_THERMAL:
          if (PM_RunningAnim(pm->ps->legsAnim) ||
            ...
            if (weaponBusy) {
              PM_SetAnim(pm, SETANIM_TORSO, TORSO_WEAPONIDLE10,
                         SETANIM_FLAG_NORMAL);
            } else {
              PM_SetAnim(pm, SETANIM_TORSO, BOTH_STAND1, SETANIM_FLAG_NORMAL);
            }
...
int PM_TurnAnimForLegsAnim(gentity_t *gent, int anim) {
  ...
  case BOTH_CROUCH1IDLE: //# Crouching idle
                         /*
                         case BOTH_UNCROUCH1:			//# Transition from crouch to
                         standing                      case BOTH_CROUCH2TOSTAND1:	//# going from crouch2 to stand1                      case
                         BOTH_CROUCH3:			//# Desann crouching down to Kyle (cin
                         9)
                         case BOTH_UNCROUCH3:			//# Desann uncrouching down to Kyle (cin
                         9)
                         case BOTH_CROUCH4:			//# Slower version of crouch1 for
                         cinematics
                         case BOTH_UNCROUCH4:			//# Slower version of uncrouch1 for
                         cinematics
                         */
...
qboolean PM_InOnGroundAnim(playerState_t *ps) {
  ...
  case BOTH_RELEASED:
    if (ps->legsAnimTimer < 500) { // pretty much horizontal by this point
      return qtrue;
    }
    break;
  case BOTH_PLAYER_PA_3_FLY:
    if (ps->legsAnimTimer < 300) { // pretty much horizontal by this point
      return qtrue;
    }
    /*
  ...
  case BOTH_FORCE_GETUP_B6:
    if (ps->legsAnimTimer >
        PM_AnimLength(
            ...
            (animNumber_t)ps->legsAnim) -
            400) { // still pretty much horizontal at this point
      return qtrue;
    }
    break;
  }
...
qboolean
PM_InDeathAnim(void) { // Purposely does not cover stumbledeath and falldeath...
  switch (pm->ps->legsAnim) {
...
qboolean PM_GoingToAttackDown(playerState_t *ps) {
  if (PM_StabDownAnim(ps->torsoAnim)      // stabbing downward
      ...
      || (PM_SaberInTransition(ps->saberMove) &&
          saberMoveData[ps->saberMove].endQuad ==
              Q_T)) // transitioning to a top to bottom attack
  {
    return qtrue;
  }
  return qfalse;
...
qboolean PM_ForceUsingSaberAnim(
    int anim) { // saber/acrobatic anims that should prevent you from recharging
                // force power while you're in them...
  switch (anim) {
  case BOTH_JUMPFLIPSLASHDOWN1:
  case BOTH_JUMPFLIPSTABDOWN:
  case BOTH_FORCELEAP2_T__B_:
...
qboolean
PM_LockedAnim(int anim) { // anims that can *NEVER* be overridden, regardless
  switch (anim) {
  case BOTH_KYLE_PA_1:
  case BOTH_KYLE_PA_2:
  case BOTH_KYLE_PA_3:
  ...
  // grabbed by wampa
  case BOTH_GRABBED:     //#
  case BOTH_RELEASED:    //#	when Wampa drops player, transitions into fall
                         //on back
  case BOTH_HANG_IDLE:   //#
  case BOTH_HANG_ATTACK: //#
  case BOTH_HANG_PAIN:   //#
...
qboolean PM_SaberLockBreakAnim(int anim) {
  ...
  case BOTH_LK_ST_S_T_B_1_W:  // normal break I won
    return (qboolean)(PM_SuperBreakLoseAnim(anim) ||
                      PM_SuperBreakWinAnim(anim));
    break;
  }
  return qfalse;
}
...
qboolean PM_CanRollFromSoulCal(playerState_t *ps) {
  if (ps->legsAnim == BOTH_A7_SOULCAL && ps->legsAnimTimer < 700 &&
