...
static inline zoneTail_t *ZoneTailFromHeader(zoneHeader_t *pHeader) { return (zoneTail_t *)((char *)pHeader + sizeof(*pHeader) + pHeader->iSize); }
...
StaticZeroMem_t gZeroMalloc = {{ZONE_MAGIC, TAG_STATIC, 0, NULL, NULL}, {ZONE_MAGIC}};
StaticMem_t gEmptyString = {{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'\0', '\0'}, {ZONE_MAGIC}};
StaticMem_t gNumberString[] = {
	{{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'0', '\0'}, {ZONE_MAGIC}}, {{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'1', '\0'}, {ZONE_MAGIC}},
	{{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'2', '\0'}, {ZONE_MAGIC}}, {{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'3', '\0'}, {ZONE_MAGIC}},
	{{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'4', '\0'}, {ZONE_MAGIC}}, {{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'5', '\0'}, {ZONE_MAGIC}},
	{{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'6', '\0'}, {ZONE_MAGIC}}, {{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'7', '\0'}, {ZONE_MAGIC}},
	{{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'8', '\0'}, {ZONE_MAGIC}}, {{ZONE_MAGIC, TAG_STATIC, 2, NULL, NULL}, {'9', '\0'}, {ZONE_MAGIC}},
};
...
void *openjk_minizip_malloc(int size) { return Z_Malloc(size, TAG_MINIZIP, qfalse, 0); }
...
static void Z_Stats_f(void) {
	Com_Printf("\nThe zone is using %d bytes (%.2fMB) in %d memory blocks\n", TheZone.Stats.iCurrent, (float)TheZone.Stats.iCurrent / 1024.0f / 1024.0f,
			   TheZone.Stats.iCount);

	Com_Printf("The zone peaked at %d bytes (%.2fMB)\n", TheZone.Stats.iPeak, (float)TheZone.Stats.iPeak / 1024.0f / 1024.0f);
}
...
=================
*/
void *Hunk_Alloc(int size, ha_pref preference) { return Z_Malloc(size, hunk_tag, qtrue); }
