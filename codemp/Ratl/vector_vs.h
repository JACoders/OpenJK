...
// Vector
// ------
// The vector class is a simple addition to the array.  It supports some useful
// additions like sort and binary search, as well as keeping track of the number
// of objects contained within.
//
//
//
//
...
// The Vector Class
////////////////////////////////////////////////////////////////////////////////////////
template <class T> class vector_base : public ratl_base {
public:
...
public:
  ...
  TTValue *raw_array() {
    ...
    // could be done with object semantics, but I would want to assert that all
    // objects are contructed
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  // Erase An Iterator Location... NOTE: THIS DOES NOT PRESERVE ORDER IN THE
  // VECTOR!!
  ////////////////////////////////////////////////////////////////////////////////////
  ...
  // Heap Sort
  //
  // This sort algorithm has all the advantages of merge sort in terms of
  // guarenteeing O(n log n) worst case, as well as all the advantages of quick
  // sort in that it is "in place" and requires no additional storage.
  //
  ////////////////////////////////////////////////////////////////////////////////////
  void sort() {
    // Temporary Data
    //----------------
    int HeapSize; // How Large The Heap Is (Grows In PHASE 1, Shrinks In PHASE
                  // 2)
    int Pos;      // The Location We Are AT During "re-heapify" Loops
    int Compare;  // The Location We Are Comparing AGAINST During "re-heapify"
                  // Loops

    // PHASE 1, CONSTRUCT THE HEAP										  O(n log
    // n)
    //===============================================================================
    ...
    // PHASE 2, POP OFF THE TOP OF THE HEAP ONE AT A TIME (AND FIX)       O(n
    // log n)
    //===============================================================================
...
private:
  ////////////////////////////////////////////////////////////////////////////////////
  // For Heap Sort
  // Returns The Location Of Node (i)'s Parent Node (The Parent Node Of Zero Is
  // Zero)
  ////////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  // For Heap Sort
  // Returns The Location Of Node (i)'s Right Child (The Child Of A Leaf Is The
  // Leaf)
  ////////////////////////////////////////////////////////////////////////////////////
  ...
  const_iterator find(const TTValue &value) const {
    ...
    if (index < mSize) {
      return const_iterator(this,
                            index); // Found It, Return An Iterator To Index
    }
    return end(); // Return "end" Iterator If Not Found
  }
...
class vector_vs
    : public vector_base<storage::value_semantics<T, ARG_CAPACITY>> {
public:
...
template <class T, int ARG_CAPACITY>
class vector_os
    : public vector_base<storage::object_semantics<T, ARG_CAPACITY>> {
public:
