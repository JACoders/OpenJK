...
void FX_RepeaterHitWall(vec3_t origin, vec3_t normal) { trap->FX_PlayEffectID(cgs.effects.repeaterWallImpactEffect, origin, normal, -1, -1, qfalse); }
...
void FX_RepeaterAltHitWall(vec3_t origin, vec3_t normal) { trap->FX_PlayEffectID(cgs.effects.repeaterAltWallImpactEffect, origin, normal, -1, -1, qfalse); }
