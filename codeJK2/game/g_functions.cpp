...
// This file contains the 8 (so far) function calls that replace the 8 function
// ptrs in the gentity_t structure
...
//#define THINKCASE(blah) case thinkF_ ## blah: blah(self);
...
// note different switch-case code for CEntity as opposed to GEntity (CEntity
// goes through parent GEntity first)...
//
void CEntity_ThinkFunc(centity_s *cent) {
//#define CLTHINKCASE(blah) case clThinkF_ ## blah: blah(cent);
//OutputDebugString(va("%s\n",#blah));break;
...
//#define REACHEDCASE(blah) case reachedF_ ## blah: blah(self);
//OutputDebugString(va("%s\n",#blah));break;
...
//#define BLOCKEDCASE(blah) case blockedF_ ## blah: blah(self,other);
//OutputDebugString(va("%s\n",#blah));break;
...
//#define TOUCHCASE(blah) case touchF_ ## blah: blah(self,other,trace);
//OutputDebugString(va("%s\n",#blah));break;
...
//#define USECASE(blah) case useF_ ## blah: blah(self,other,activator);
//OutputDebugString(va("%s\n",#blah));break;
#define USECASE(blah)                                                          \
  case useF_##blah:                                                            \
...
void GEntity_PainFunc(gentity_t *self, gentity_t *inflictor,
                      ...
                      int hitLoc) {
//#define PAINCASE(blah) case painF_ ## blah: blah(self,attacker,damage);
//OutputDebugString(va("%s\n",#blah));break;
...
//#define DIECASE(blah) case dieF_ ## blah:
//blah(self,inflictor,attacker,damage,mod);
//OutputDebugString(va("%s\n",#blah));break;
#define DIECASE(blah)                                                          \
  case dieF_##blah:                                                            \
