...
{                 // These take over only if script allows them to be autonomous
  ...
  BS_SEARCH, //# Using current waypoint as a base, search the immediate branches
             //of waypoints for enemies
  ...
  BS_CINEMATIC, //# Does nothing but face it's angles and move to a goal if it
                //has one # #eol internal bStates only
  BS_WAIT, //# Does nothing but face it's angles
  BS_STAND_GUARD,
  BS_PATROL,
  BS_INVESTIGATE, //# head towards temp goal and look for enemies and listen for
                  //sounds
  BS_STAND_AND_SHOOT,
  BS_HUNT_AND_KILL,
  BS_FLEE, //# Run away!
