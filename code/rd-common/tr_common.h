...
typedef void (*ImageLoaderFn)(const char *filename, byte **pic, int *width,
                              int *height);
...
void LoadJPGFromBuffer(byte *inputBuffer, size_t len, byte **pic, int *width,
                       int *height);
#endif
...
size_t RE_SaveJPGToBuffer(byte *buffer, size_t bufSize, int quality,
                          ...
                          int padding, bool flip_vertical);

// Save raw image data as JPEG image file.
void RE_SaveJPG(const char *filename, int quality, int image_width,
