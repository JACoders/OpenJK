...
typedef enum //# animNumber_e
{
  ...
  BOTH_FALLDEATH1LAND,  //# Fall forward off a high cliff and splat death - hit
                        //bottom
  ...
  BOTH_FALLDEAD1LAND, //# Fall forward and splat death finished pose
                      //# #sep BOTH_ DEAD TWITCH/FLOP # React to being shot from
                      //death poses
  ...
  BOTH_DEADFORWARD1_FLOP,  //# React to being shot First thrown forward death
                           //finished pose
  BOTH_DEADFORWARD2_FLOP,  //# React to being shot Second thrown forward death
                           //finished pose
  BOTH_DEADBACKWARD1_FLOP, //# React to being shot First thrown backward death
                           //finished pose
  BOTH_DEADBACKWARD2_FLOP, //# React to being shot Second thrown backward death
                           //finished pose
  BOTH_LYINGDEAD1_FLOP, //# React to being shot Killed lying down death finished
                        //pose
  BOTH_STUMBLEDEAD1_FLOP, //# React to being shot Stumble forward death finished
                          //pose
  BOTH_FALLDEAD1_FLOP,    //# React to being shot Fall forward and splat death
                          //finished pose
  ...
  BOTH_T1_BL__L, //# Fast arc bottom left to left
                 // Saber Arc Transitions that use existing animations played
                 // backwards
  BOTH_T1_BR_TR, //# Fast arc bottom right to top right		(use:
                 //BOTH_T1_TR_BR)
  BOTH_T1_BR_T_, //# Fast arc bottom right to top			(use:
                 //BOTH_T1_T__BR)
  BOTH_T1__R_BR, //# Fast arc right to bottom right			(use:
                 //BOTH_T1_BR__R)
  BOTH_T1__R_T_, //# Fast ar right to top				(use:
                 //BOTH_T1_T___R)
  BOTH_T1_TR__R, //# Fast arc top right to right			(use:
                 //BOTH_T1__R_TR)
  BOTH_T1_TR_T_, //# Fast arc top right to top				(use:
                 //BOTH_T1_T__TR)
  BOTH_T1_TL__R, //# Fast arc top left to right			(use:
                 //BOTH_T1__R_TL)
  BOTH_T1_TL_TR, //# Fast arc top left to top right			(use:
                 //BOTH_T1_TR_TL)
  BOTH_T1_TL_T_, //# Fast arc top left to top				(use:
                 //BOTH_T1_T__TL)
  BOTH_T1_TL__L, //# Fast arc top left to left				(use:
                 //BOTH_T1__L_TL)
  BOTH_T1__L_TR, //# Fast arc left to top right			(use:
                 //BOTH_T1_TR__L)
  BOTH_T1__L_T_, //# Fast arc left to top				(use:
                 //BOTH_T1_T___L)
  BOTH_T1__L_BL, //# Fast arc left to bottom left			(use:
                 //BOTH_T1_BL__L)
  BOTH_T1_BL_T_, //# Fast arc bottom left to top			(use:
                 //BOTH_T1_T__BL)
  BOTH_T1_BL_TL, //# Fast arc bottom left to top left		(use:
                 //BOTH_T1_TL_BL) Saber Attack Start Transitions
  BOTH_S1_S1_T_, //# Fast plain transition from stance1 to top-to-bottom Fast
                 //weak attack
  BOTH_S1_S1__L, //# Fast plain transition from stance1 to left-to-right Fast
                 //weak attack
  BOTH_S1_S1__R, //# Fast plain transition from stance1 to right-to-left Fast
                 //weak attack
  BOTH_S1_S1_TL, //# Fast plain transition from stance1 to
                 //top-left-to-bottom-right Fast weak attack
  BOTH_S1_S1_BR, //# Fast plain transition from stance1 to
                 //bottom-right-to-top-left Fast weak attack
  BOTH_S1_S1_BL, //# Fast plain transition from stance1 to
                 //bottom-left-to-top-right Fast weak attack
  BOTH_S1_S1_TR, //# Fast plain transition from stance1 to
                 //top-right-to-bottom-left Fast weak attack Saber Attack Return
                 // Transitions
  BOTH_R1_B__S1, //# Fast plain transition from top-to-bottom Fast weak attack
                 //to stance1
  BOTH_R1__L_S1, //# Fast plain transition from left-to-right Fast weak attack
                 //to stance1
  BOTH_R1__R_S1, //# Fast plain transition from right-to-left Fast weak attack
                 //to stance1
  BOTH_R1_TL_S1, //# Fast plain transition from top-left-to-bottom-right Fast
                 //weak attack to stance1
  BOTH_R1_BR_S1, //# Fast plain transition from bottom-right-to-top-left Fast
                 //weak attack to stance1
  BOTH_R1_BL_S1, //# Fast plain transition from bottom-left-to-top-right Fast
                 //weak attack to stance1
  BOTH_R1_TR_S1, //# Fast plain transition from top-right-to-bottom-left Fast
                 //weak attack Saber Attack Bounces (first 4 frames of an
                 // attack, played backwards)
  ...
  BOTH_T2_BL__L, //# Fast arc bottom left to left
                 // Saber Arc Transitions that use existing animations played
                 // backwards
  BOTH_T2_BR_TR, //# Fast arc bottom right to top right		(use:
                 //BOTH_T2_TR_BR)
  BOTH_T2_BR_T_, //# Fast arc bottom right to top			(use:
                 //BOTH_T2_T__BR)
  BOTH_T2__R_BR, //# Fast arc right to bottom right			(use:
                 //BOTH_T2_BR__R)
  BOTH_T2__R_T_, //# Fast ar right to top				(use:
                 //BOTH_T2_T___R)
  BOTH_T2_TR__R, //# Fast arc top right to right			(use:
                 //BOTH_T2__R_TR)
  BOTH_T2_TR_T_, //# Fast arc top right to top				(use:
                 //BOTH_T2_T__TR)
  BOTH_T2_TL__R, //# Fast arc top left to right			(use:
                 //BOTH_T2__R_TL)
  BOTH_T2_TL_TR, //# Fast arc top left to top right			(use:
                 //BOTH_T2_TR_TL)
  BOTH_T2_TL_T_, //# Fast arc top left to top				(use:
                 //BOTH_T2_T__TL)
  BOTH_T2_TL__L, //# Fast arc top left to left				(use:
                 //BOTH_T2__L_TL)
  BOTH_T2__L_TR, //# Fast arc left to top right			(use:
                 //BOTH_T2_TR__L)
  BOTH_T2__L_T_, //# Fast arc left to top				(use:
                 //BOTH_T2_T___L)
  BOTH_T2__L_BL, //# Fast arc left to bottom left			(use:
                 //BOTH_T2_BL__L)
  BOTH_T2_BL_T_, //# Fast arc bottom left to top			(use:
                 //BOTH_T2_T__BL)
  BOTH_T2_BL_TL, //# Fast arc bottom left to top left		(use:
                 //BOTH_T2_TL_BL) Saber Attack Start Transitions
  BOTH_S2_S1_T_, //# Fast plain transition from stance1 to top-to-bottom Fast
                 //weak attack
  BOTH_S2_S1__L, //# Fast plain transition from stance1 to left-to-right Fast
                 //weak attack
  BOTH_S2_S1__R, //# Fast plain transition from stance1 to right-to-left Fast
                 //weak attack
  BOTH_S2_S1_TL, //# Fast plain transition from stance1 to
                 //top-left-to-bottom-right Fast weak attack
  BOTH_S2_S1_BR, //# Fast plain transition from stance1 to
                 //bottom-right-to-top-left Fast weak attack
  BOTH_S2_S1_BL, //# Fast plain transition from stance1 to
                 //bottom-left-to-top-right Fast weak attack
  BOTH_S2_S1_TR, //# Fast plain transition from stance1 to
                 //top-right-to-bottom-left Fast weak attack Saber Attack Return
                 // Transitions
  BOTH_R2_B__S1, //# Fast plain transition from top-to-bottom Fast weak attack
                 //to stance1
  BOTH_R2__L_S1, //# Fast plain transition from left-to-right Fast weak attack
                 //to stance1
  BOTH_R2__R_S1, //# Fast plain transition from right-to-left Fast weak attack
                 //to stance1
  BOTH_R2_TL_S1, //# Fast plain transition from top-left-to-bottom-right Fast
                 //weak attack to stance1
  BOTH_R2_BR_S1, //# Fast plain transition from bottom-right-to-top-left Fast
                 //weak attack to stance1
  BOTH_R2_BL_S1, //# Fast plain transition from bottom-left-to-top-right Fast
                 //weak attack to stance1
  BOTH_R2_TR_S1, //# Fast plain transition from top-right-to-bottom-left Fast
                 //weak attack Saber Attack Bounces (first 4 frames of an
                 // attack, played backwards)
  ...
  BOTH_T3_BL__L, //# Fast arc bottom left to left
                 // Saber Arc Transitions that use existing animations played
                 // backwards
  BOTH_T3_BR_TR, //# Fast arc bottom right to top right		(use:
                 //BOTH_T3_TR_BR)
  BOTH_T3_BR_T_, //# Fast arc bottom right to top			(use:
                 //BOTH_T3_T__BR)
  BOTH_T3__R_BR, //# Fast arc right to bottom right			(use:
                 //BOTH_T3_BR__R)
  BOTH_T3__R_T_, //# Fast ar right to top				(use:
                 //BOTH_T3_T___R)
  BOTH_T3_TR__R, //# Fast arc top right to right			(use:
                 //BOTH_T3__R_TR)
  BOTH_T3_TR_T_, //# Fast arc top right to top				(use:
                 //BOTH_T3_T__TR)
  BOTH_T3_TL__R, //# Fast arc top left to right			(use:
                 //BOTH_T3__R_TL)
  BOTH_T3_TL_TR, //# Fast arc top left to top right			(use:
                 //BOTH_T3_TR_TL)
  BOTH_T3_TL_T_, //# Fast arc top left to top				(use:
                 //BOTH_T3_T__TL)
  BOTH_T3_TL__L, //# Fast arc top left to left				(use:
                 //BOTH_T3__L_TL)
  BOTH_T3__L_TR, //# Fast arc left to top right			(use:
                 //BOTH_T3_TR__L)
  BOTH_T3__L_T_, //# Fast arc left to top				(use:
                 //BOTH_T3_T___L)
  BOTH_T3__L_BL, //# Fast arc left to bottom left			(use:
                 //BOTH_T3_BL__L)
  BOTH_T3_BL_T_, //# Fast arc bottom left to top			(use:
                 //BOTH_T3_T__BL)
  BOTH_T3_BL_TL, //# Fast arc bottom left to top left		(use:
                 //BOTH_T3_TL_BL) Saber Attack Start Transitions
  BOTH_S3_S1_T_, //# Fast plain transition from stance1 to top-to-bottom Fast
                 //weak attack
  BOTH_S3_S1__L, //# Fast plain transition from stance1 to left-to-right Fast
                 //weak attack
  BOTH_S3_S1__R, //# Fast plain transition from stance1 to right-to-left Fast
                 //weak attack
  BOTH_S3_S1_TL, //# Fast plain transition from stance1 to
                 //top-left-to-bottom-right Fast weak attack
  BOTH_S3_S1_BR, //# Fast plain transition from stance1 to
                 //bottom-right-to-top-left Fast weak attack
  BOTH_S3_S1_BL, //# Fast plain transition from stance1 to
                 //bottom-left-to-top-right Fast weak attack
  BOTH_S3_S1_TR, //# Fast plain transition from stance1 to
                 //top-right-to-bottom-left Fast weak attack Saber Attack Return
                 // Transitions
  BOTH_R3_B__S1, //# Fast plain transition from top-to-bottom Fast weak attack
                 //to stance1
  BOTH_R3__L_S1, //# Fast plain transition from left-to-right Fast weak attack
                 //to stance1
  BOTH_R3__R_S1, //# Fast plain transition from right-to-left Fast weak attack
                 //to stance1
  BOTH_R3_TL_S1, //# Fast plain transition from top-left-to-bottom-right Fast
                 //weak attack to stance1
  BOTH_R3_BR_S1, //# Fast plain transition from bottom-right-to-top-left Fast
                 //weak attack to stance1
  BOTH_R3_BL_S1, //# Fast plain transition from bottom-left-to-top-right Fast
                 //weak attack to stance1
  BOTH_R3_TR_S1, //# Fast plain transition from top-right-to-bottom-left Fast
                 //weak attack Saber Attack Bounces (first 4 frames of an
                 // attack, played backwards)
  ...
  BOTH_T4_BL__L, //# Fast arc bottom left to left
                 // Saber Arc Transitions that use existing animations played
                 // backwards
  BOTH_T4_BR_TR, //# Fast arc bottom right to top right		(use:
                 //BOTH_T4_TR_BR)
  BOTH_T4_BR_T_, //# Fast arc bottom right to top			(use:
                 //BOTH_T4_T__BR)
  BOTH_T4__R_BR, //# Fast arc right to bottom right			(use:
                 //BOTH_T4_BR__R)
  BOTH_T4__R_T_, //# Fast ar right to top				(use:
                 //BOTH_T4_T___R)
  BOTH_T4_TR__R, //# Fast arc top right to right			(use:
                 //BOTH_T4__R_TR)
  BOTH_T4_TR_T_, //# Fast arc top right to top				(use:
                 //BOTH_T4_T__TR)
  BOTH_T4_TL__R, //# Fast arc top left to right			(use:
                 //BOTH_T4__R_TL)
  BOTH_T4_TL_TR, //# Fast arc top left to top right			(use:
                 //BOTH_T4_TR_TL)
  BOTH_T4_TL_T_, //# Fast arc top left to top				(use:
                 //BOTH_T4_T__TL)
  BOTH_T4_TL__L, //# Fast arc top left to left				(use:
                 //BOTH_T4__L_TL)
  BOTH_T4__L_TR, //# Fast arc left to top right			(use:
                 //BOTH_T4_TR__L)
  BOTH_T4__L_T_, //# Fast arc left to top				(use:
                 //BOTH_T4_T___L)
  BOTH_T4__L_BL, //# Fast arc left to bottom left			(use:
                 //BOTH_T4_BL__L)
  BOTH_T4_BL_T_, //# Fast arc bottom left to top			(use:
                 //BOTH_T4_T__BL)
  BOTH_T4_BL_TL, //# Fast arc bottom left to top left		(use:
                 //BOTH_T4_TL_BL) Saber Attack Start Transitions
  BOTH_S4_S1_T_, //# Fast plain transition from stance1 to top-to-bottom Fast
                 //weak attack
  BOTH_S4_S1__L, //# Fast plain transition from stance1 to left-to-right Fast
                 //weak attack
  BOTH_S4_S1__R, //# Fast plain transition from stance1 to right-to-left Fast
                 //weak attack
  BOTH_S4_S1_TL, //# Fast plain transition from stance1 to
                 //top-left-to-bottom-right Fast weak attack
  BOTH_S4_S1_BR, //# Fast plain transition from stance1 to
                 //bottom-right-to-top-left Fast weak attack
  BOTH_S4_S1_BL, //# Fast plain transition from stance1 to
                 //bottom-left-to-top-right Fast weak attack
  BOTH_S4_S1_TR, //# Fast plain transition from stance1 to
                 //top-right-to-bottom-left Fast weak attack Saber Attack Return
                 // Transitions
  BOTH_R4_B__S1, //# Fast plain transition from top-to-bottom Fast weak attack
                 //to stance1
  BOTH_R4__L_S1, //# Fast plain transition from left-to-right Fast weak attack
                 //to stance1
  BOTH_R4__R_S1, //# Fast plain transition from right-to-left Fast weak attack
                 //to stance1
  BOTH_R4_TL_S1, //# Fast plain transition from top-left-to-bottom-right Fast
                 //weak attack to stance1
  BOTH_R4_BR_S1, //# Fast plain transition from bottom-right-to-top-left Fast
                 //weak attack to stance1
  BOTH_R4_BL_S1, //# Fast plain transition from bottom-left-to-top-right Fast
                 //weak attack to stance1
  BOTH_R4_TR_S1, //# Fast plain transition from top-right-to-bottom-left Fast
                 //weak attack Saber Attack Bounces (first 4 frames of an
                 // attack, played backwards)
  ...
  BOTH_T5_BL__L, //# Fast arc bottom left to left
                 // Saber Arc Transitions that use existing animations played
                 // backwards
  BOTH_T5_BR_TR, //# Fast arc bottom right to top right		(use:
                 //BOTH_T5_TR_BR)
  BOTH_T5_BR_T_, //# Fast arc bottom right to top			(use:
                 //BOTH_T5_T__BR)
  BOTH_T5__R_BR, //# Fast arc right to bottom right			(use:
                 //BOTH_T5_BR__R)
  BOTH_T5__R_T_, //# Fast ar right to top				(use:
                 //BOTH_T5_T___R)
  BOTH_T5_TR__R, //# Fast arc top right to right			(use:
                 //BOTH_T5__R_TR)
  BOTH_T5_TR_T_, //# Fast arc top right to top				(use:
                 //BOTH_T5_T__TR)
  BOTH_T5_TL__R, //# Fast arc top left to right			(use:
                 //BOTH_T5__R_TL)
  BOTH_T5_TL_TR, //# Fast arc top left to top right			(use:
                 //BOTH_T5_TR_TL)
  BOTH_T5_TL_T_, //# Fast arc top left to top				(use:
                 //BOTH_T5_T__TL)
  BOTH_T5_TL__L, //# Fast arc top left to left				(use:
                 //BOTH_T5__L_TL)
  BOTH_T5__L_TR, //# Fast arc left to top right			(use:
                 //BOTH_T5_TR__L)
  BOTH_T5__L_T_, //# Fast arc left to top				(use:
                 //BOTH_T5_T___L)
  BOTH_T5__L_BL, //# Fast arc left to bottom left			(use:
                 //BOTH_T5_BL__L)
  BOTH_T5_BL_T_, //# Fast arc bottom left to top			(use:
                 //BOTH_T5_T__BL)
  BOTH_T5_BL_TL, //# Fast arc bottom left to top left		(use:
                 //BOTH_T5_TL_BL) Saber Attack Start Transitions
  BOTH_S5_S1_T_, //# Fast plain transition from stance1 to top-to-bottom Fast
                 //weak attack
  BOTH_S5_S1__L, //# Fast plain transition from stance1 to left-to-right Fast
                 //weak attack
  BOTH_S5_S1__R, //# Fast plain transition from stance1 to right-to-left Fast
                 //weak attack
  BOTH_S5_S1_TL, //# Fast plain transition from stance1 to
                 //top-left-to-bottom-right Fast weak attack
  BOTH_S5_S1_BR, //# Fast plain transition from stance1 to
                 //bottom-right-to-top-left Fast weak attack
  BOTH_S5_S1_BL, //# Fast plain transition from stance1 to
                 //bottom-left-to-top-right Fast weak attack
  BOTH_S5_S1_TR, //# Fast plain transition from stance1 to
                 //top-right-to-bottom-left Fast weak attack Saber Attack Return
                 // Transitions
  BOTH_R5_B__S1, //# Fast plain transition from top-to-bottom Fast weak attack
                 //to stance1
  BOTH_R5__L_S1, //# Fast plain transition from left-to-right Fast weak attack
                 //to stance1
  BOTH_R5__R_S1, //# Fast plain transition from right-to-left Fast weak attack
                 //to stance1
  BOTH_R5_TL_S1, //# Fast plain transition from top-left-to-bottom-right Fast
                 //weak attack to stance1
  BOTH_R5_BR_S1, //# Fast plain transition from bottom-right-to-top-left Fast
                 //weak attack to stance1
  BOTH_R5_BL_S1, //# Fast plain transition from bottom-left-to-top-right Fast
                 //weak attack to stance1
  BOTH_R5_TR_S1, //# Fast plain transition from top-right-to-bottom-left Fast
                 //weak attack Saber Attack Bounces (first 4 frames of an
                 // attack, played backwards)
  ...
  BOTH_STAND5STARTLEDLOOKLEFT,   //# Kyle turning to watch the bridge drop (cin
                                 //#9)
  BOTH_STARTLEDLOOKLEFTTOSTAND5, //# Kyle returning to stand 5 from watching the
                                 //bridge drop (cin #9)
  ...
  BOTH_CONSOLE2HOLDCOMSTART, //# lean in to type at console while holding comm
                             //link in hand (cin #5)
  BOTH_CONSOLE2HOLDCOMSTOP,  //# lean away after typing at console while holding
                             //comm link in hand (cin #5)
  ...
  BOTH_FORCEFOUNTAIN1_START,  //# Kyle being lifted into the Force Fountain (cin
                              //#10)
  BOTH_FORCEFOUNTAIN1_MIDDLE, //# Kyle changing to looping position in the Force
                              //Fountain (cin #10)
  BOTH_FORCEFOUNTAIN1_LOOP, //# Kyle being spun in the Force Fountain (cin #10)
  BOTH_FORCEFOUNTAIN1_STOP, //# Kyle being set down out of the Force Fountain
                            //(cin #10)
  ...
  BOTH_CONSTRAINER1HOLD,  //# Static pose of starting Tavion constraining Jan
                          //(cin #9)
  BOTH_CONSTRAINEE1HOLD,  //# Static pose of starting Jan being constrained by
                          //Tavion (cin #9)
  ...
  BOTH_BARTENDER_COWERSTART, //# Start of Bartender raising both hands up in
                             //surrender (cin #16)
  BOTH_BARTENDER_COWERLOOP, //# Loop of Bartender waving both hands in surrender
                            //(cin #16)
  BOTH_BARTENDER_COWER,     //# Single frame of Bartender waving both hands in
                            //surrender (cin #16)
  BOTH_THREATEN1_START,     //# First frame of Kyle threatening Bartender with
                            //lightsaber (cin #16)
  ...
  BOTH_TRIUMPHANT1STARTGESTURE, //# Mech Galak raising his arms in victory (cin
                                //#32)
  ...
  BOTH_SIT2TOSIT4, //# Trans from sit2 to sit4 (cin #12) Luke leaning back from
                   //lotus position.
  ...
  BOTH_PAIN2WRITHE1,  //# Transition from upright position to writhing on ground
                      //anim
  ...
  BOTH_INJURED1, //# Lying down, against wall - can also be sleeping against
                 //wall
  ...
  BOTH_COCKPIT_TALKR1START, //# turn head from straight forward to looking full
                            //right
  BOTH_COCKPIT_TALKR1STARTTOMID, //# from TALKR1START to looking at hologram
                                 //(cin #1)
  BOTH_COCKPIT_TALKR1MIDTOSTART, //# from looking at hologram to TALKR1START
                                 //(cin #1)
  BOTH_COCKPIT_TALKR1STOP,       //# return head to straight forward from
                                 //BOTH_COCKPIT_TALKR1
  BOTH_COCKPIT_TALKR1STOPTOMID,  //# from TALKR1STOP to TALKR1MID
  BOTH_COCKPIT_TALKR1MIDTOSTOP,  //# from looking at hologram to TALKR1STOP (cin
                                 //#1)
  BOTH_COCKPIT_TALKR1,           //# talk to right side

  BOTH_COCKPIT_TALKL1START, //# turn head from straight forward to looking full
                            //left
  BOTH_COCKPIT_TALKL1STARTTOMID, //# from TALKL1START to looking at hologram
                                 //(cin #1)
  BOTH_COCKPIT_TALKL1MIDTOSTART, //# from looking at hologram to TALKL1START
                                 //(cin #1)
  BOTH_COCKPIT_TALKL1STOP,       //# return head to straight forward from
                                 //BOTH_COCKPIT_TALKL1
  BOTH_COCKPIT_TALKL1STOPTOMID,  //# from TALKL1STOP to TALKL1MID
  BOTH_COCKPIT_TALKL1MIDTOSTOP,  //# from looking at hologram to TALKL1STOP (cin
                                 //#1)
  BOTH_COCKPIT_TALKL1,           //# talk to left side

  BOTH_COCKPIT_CONSOLE1,         //# type at controls
  BOTH_COCKPIT_CONSOLE2,         //# type at controls
  BOTH_COCKPIT_CONSOLE2_PARTIAL, //# last part of console2 anim (cin #1) used by
                                 //Jan
  ...
  BOTH_COCKPIT_TALKGESTURE7STOP, //# Lando's supporting hand away from Kyle (cin
                                 //#21)
  ...
  LEGS_TURN1, //# What legs do when you turn your lower body to match your upper
              //body facing
