...
// Scheduler
// ---------
// The scheduler is a common piece of game functionality.  To use it, simply add
// events at the given time, and call update() with the current time as
// frequently as you wish.
//
// Your event class MUST define a Fire() function which accepts a
// TCALLBACKPARAMS parameter.
//
// NOTES:
//
//
...
// The Scheduler Class
////////////////////////////////////////////////////////////////////////////////////////
template <class T> class scheduler_base : public ratl_base {
public:
...
private:
  ...
  //
  // This class stores two numbers, a timer and an iterator to the events list.
  // We don't store the event directly in the heap to make the swap operation in
  // the heap faster.  We define a less than operator so we can sort in the
  // heap.
  //
  ////////////////////////////////////////////////////////////////////////////////////
  struct timed_event {
    ...
    bool operator<(const timed_event &t) const { return (mTime > t.mTime); }
  };
...
public:
  ...
  // Is This List Filled?
  ////////////////////////////////////////////////////////////////////////////////////
  bool full() const { return mEvents.full(); }
...
class scheduler_vs
    : public scheduler_base<storage::value_semantics<T, ARG_CAPACITY>> {
public:
...
template <class T, int ARG_CAPACITY>
class scheduler_os
    : public scheduler_base<storage::object_semantics<T, ARG_CAPACITY>> {
public:
