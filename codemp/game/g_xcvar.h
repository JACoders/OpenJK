...
XCVAR_DEF( zyk_ultra_strength_cooldown,	"6000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
...
XCVAR_DEF( zyk_ultra_resistance_cooldown,	"6000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
