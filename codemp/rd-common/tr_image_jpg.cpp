...
void LoadJPG(const char *filename, unsigned char **pic, int *width,
             int *height) {
  ...
  if (!cinfo.output_width || !cinfo.output_height ||
    ...
    Com_Printf(
        ...
        filename, cinfo.output_width, cinfo.output_height, pixelcount * 4,
...
void RE_SaveJPG(const char *filename, int quality, int image_width,
  ...
  bufSize = RE_SaveJPGToBuffer(out, bufSize, quality, image_width, image_height,
