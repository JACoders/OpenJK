...
void png_print_error(png_structp png_ptr, png_const_charp err) { ri.Printf(PRINT_ERROR, "%s\n", err); }

void png_print_warning(png_structp png_ptr, png_const_charp warning) { ri.Printf(PRINT_WARNING, "%s\n", warning); }
