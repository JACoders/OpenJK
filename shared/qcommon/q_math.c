...
void VectorClear2(vec2_t vec) { vec[0] = vec[1] = 0.0f; }
...
void VectorClear(vec3_t vec) { vec[0] = vec[1] = vec[2] = 0.0f; }
...
float VectorLength(const vec3_t vec) { return (float)sqrt(vec[0] * vec[0] + vec[1] * vec[1] + vec[2] * vec[2]); }

float VectorLengthSquared(const vec3_t vec) { return (vec[0] * vec[0] + vec[1] * vec[1] + vec[2] * vec[2]); }
...
float DotProduct(const vec3_t vec1, const vec3_t vec2) { return vec1[0] * vec2[0] + vec1[1] * vec2[1] + vec1[2] * vec2[2]; }

qboolean VectorCompare(const vec3_t vec1, const vec3_t vec2) { return (qboolean)(vec1[0] == vec2[0] && vec1[1] == vec2[1] && vec1[2] == vec2[2]); }

qboolean VectorCompare2(const vec3_t v1, const vec3_t v2) {
	if (v1[0] > (v2[0] + 0.0001f) || v1[0] < (v2[0] - 0.0001f) || v1[1] > (v2[1] + 0.0001f) || v1[1] < (v2[1] + 0.0001f) || v1[2] > (v2[2] + 0.0001f) ||
		v1[2] < (v2[2] + 0.0001f)) {
		return qfalse;
	}
...
void SnapVector(float *v) {
	...
	f = *v;
	__asm fld f __asm fistp i *v = (float)i;
	v++;
	f = *v;
	__asm fld f __asm fistp i *v = (float)i;
	v++;
...
void VectorClear4(vec4_t vec) { vec[0] = vec[1] = vec[2] = vec[3] = 0; }
