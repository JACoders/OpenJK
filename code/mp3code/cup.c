...
////@@@@static int bit_skip;
static const int bat_bit_master[] = {0, 5, 7, 9, 10, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48};
...
/*--------------------------------------------------------------*/
#define mac_load(n) (bits -= n, bitval = bitbuf >> bits, bitbuf -= bitval << bits, bitval)
/*======================================================================*/
...
dispatch:
	...
	case 2: /* 1 factor 000 */
		mac_load_check(6);
		pMP3Stream->cs_factor[2][i] = pMP3Stream->cs_factor[1][i] = pMP3Stream->cs_factor[0][i] = c_value[i] * sf_table[mac_load(6)];
		goto dispatch;
