...
void R_Register( void )
{
	...
	r_singleShader						= ri->Cvar_Get( "r_singleShader",					"0",						CVAR_NONE|CVAR_LATCH, "" );
...
//	r_dlightBacks						= ri->Cvar_Get( "r_dlightBacks",					"1",						CVAR_NONE, "" );
	r_finish							= ri->Cvar_Get( "r_finish",							"0",						CVAR_ARCHIVE, "" );
	r_textureMode						= ri->Cvar_Get( "r_textureMode",					"GL_LINEAR_MIPMAP_NEAREST",	CVAR_ARCHIVE, "" );
	r_markcount							= ri->Cvar_Get( "r_markcount",						"100",						CVAR_ARCHIVE, "" );
	r_gamma								= ri->Cvar_Get( "r_gamma",							"1",						CVAR_ARCHIVE, "" );
	r_facePlaneCull						= ri->Cvar_Get( "r_facePlaneCull",					"1",						CVAR_ARCHIVE, "" );
	r_cullRoofFaces						= ri->Cvar_Get( "r_cullRoofFaces",					"0",						CVAR_NONE, "" ); //attempted smart method of culling out upwards facing surfaces on roofs for automap shots -rww
	r_roofCullCeilDist					= ri->Cvar_Get( "r_roofCullCeilDist",				"256",						CVAR_NONE, "" ); //attempted smart method of culling out upwards facing surfaces on roofs for automap shots -rww
	r_roofCullFloorDist					= ri->Cvar_Get( "r_roofCeilFloorDist",				"128",						CVAR_NONE, "" ); //attempted smart method of culling out upwards facing surfaces on roofs for automap shots -rww
	...
	r_showImages						= ri->Cvar_Get( "r_showImages",						"0",						CVAR_NONE, "" );
	r_debugLight						= ri->Cvar_Get( "r_debuglight",						"0",						CVAR_TEMP, "" );
	r_debugSort							= ri->Cvar_Get( "r_debugSort",						"0",						CVAR_NONE, "" );
	...
	r_nocurves							= ri->Cvar_Get( "r_nocurves",						"0",						CVAR_NONE, "" );
	r_drawworld							= ri->Cvar_Get( "r_drawworld",						"1",						CVAR_NONE, "" );
	r_drawfog							= ri->Cvar_Get( "r_drawfog",						"2",						CVAR_NONE, "" );
	r_lightmap							= ri->Cvar_Get( "r_lightmap",						"0",						CVAR_NONE, "" );
	r_portalOnly						= ri->Cvar_Get( "r_portalOnly",						"0",						CVAR_NONE, "" );
	r_skipBackEnd						= ri->Cvar_Get( "r_skipBackEnd",					"0",						CVAR_NONE, "" );
	r_measureOverdraw					= ri->Cvar_Get( "r_measureOverdraw",				"0",						CVAR_NONE, "" );
	r_lodscale							= ri->Cvar_Get( "r_lodscale",						"5",						CVAR_NONE, "" );
	r_norefresh							= ri->Cvar_Get( "r_norefresh",						"0",						CVAR_NONE, "" );
	r_drawentities						= ri->Cvar_Get( "r_drawentities",					"1",						CVAR_NONE, "" );
	r_ignore							= ri->Cvar_Get( "r_ignore",							"1",						CVAR_NONE, "" );
	r_nocull							= ri->Cvar_Get( "r_nocull",							"0",						CVAR_NONE, "" );
	r_novis								= ri->Cvar_Get( "r_novis",							"0",						CVAR_NONE, "" );
	r_showcluster						= ri->Cvar_Get( "r_showcluster",					"0",						CVAR_NONE, "" );
	...
	r_debugSurface						= ri->Cvar_Get( "r_debugSurface",					"0",						CVAR_NONE, "" );
	r_nobind							= ri->Cvar_Get( "r_nobind",							"0",						CVAR_NONE, "" );
	r_showtris							= ri->Cvar_Get( "r_showtris",						"0",						CVAR_NONE, "" );
	r_showsky							= ri->Cvar_Get( "r_showsky",						"0",						CVAR_NONE, "" );
	r_shownormals						= ri->Cvar_Get( "r_shownormals",					"0",						CVAR_NONE, "" );
	r_clear								= ri->Cvar_Get( "r_clear",							"0",						CVAR_NONE, "" );
	r_offsetFactor						= ri->Cvar_Get( "r_offsetfactor",					"-1",						CVAR_NONE, "" );
	r_offsetUnits						= ri->Cvar_Get( "r_offsetunits",					"-2",						CVAR_NONE, "" );
...
*/
#ifdef _DEBUG
	r_noPrecacheGLA						= ri->Cvar_Get( "r_noPrecacheGLA",					"0",						CVAR_NONE, "" );
#endif
