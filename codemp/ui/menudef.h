...
// this file is parsed at runtime by botlib's text preprocessor (used for .menu
// scripting) include guards aren't necessary
...
#define FEEDER_COLORCHOICES                                                    \
  0x17 // special hack to feed text/actions from playerchoice.txt in species
       // folder
