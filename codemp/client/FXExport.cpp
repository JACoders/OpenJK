...
int FX_RegisterEffect(const char *file) { return theFxScheduler.RegisterEffect(file, true); }
...
void FX_AddScheduledEffects(qboolean portal) { theFxScheduler.AddScheduledEffects(!!portal); }

void FX_Draw2DEffects(float screenXScale, float screenYScale) { theFxScheduler.Draw2DEffects(screenXScale, screenYScale); }
