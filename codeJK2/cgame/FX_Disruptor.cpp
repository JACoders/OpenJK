...
void FX_DisruptorMainShot(vec3_t start, vec3_t end) {
  FX_AddLine(start, end, 0.1f, 4.0f, 0.0f, 1.0f, 0.0f, 0.0f, WHITE, WHITE, 0.0f,
...
void FX_DisruptorAltShot(vec3_t start, vec3_t end, qboolean fullCharge) {
  FX_AddLine(start, end, 0.1f, 10.0f, 0.0f, 1.0f, 0.0f, 0.0f, WHITE, WHITE,
             0.0f, 175, cgi_R_RegisterShader("gfx/effects/redLine"),
             FX_SIZE_LINEAR | FX_ALPHA_LINEAR);
  ...
  if (fullCharge) {
    ...
    // add some beef
    FX_AddLine(start, end, 0.1f, 7.0f, 0.0f, 1.0f, 0.0f, 0.0f, YELLER, YELLER,
               0.0f, 150, cgi_R_RegisterShader("gfx/misc/whiteline2"),
               FX_SIZE_LINEAR | FX_ALPHA_LINEAR);
  }
}
