...
#define SEF_EVENTS                                                             \
  (SEF_HITENEMY | SEF_HITOBJECT | SEF_HITWALL | SEF_PARRIED | SEF_DEFLECTED |  \
   SEF_BLOCKED)
...
#define FORCE_HEAL_INTERVAL                                                    \
  200 // FIXME: maybe level 1 is slower or level 2 is faster?
...
enum { FJ_FORWARD, FJ_BACKWARD, FJ_RIGHT, FJ_LEFT, FJ_UP };

#define FORCE_JUMP_CHARGE_TIME                                                 \
  1000.0f // Force jump reaches maximum power in one second
