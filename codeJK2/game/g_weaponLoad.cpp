...
void FX_DEMP2_ProjectileThink(centity_t *cent,
                              const struct weaponInfo_s *weapon);
void FX_DEMP2_AltProjectileThink(centity_t *cent,
                                 const struct weaponInfo_s *weapon);
...
// ATST Side weapons
void FX_ATSTSideMainProjectileThink(centity_t *cent,
                                    const struct weaponInfo_s *weapon);
void FX_ATSTSideAltProjectileThink(centity_t *cent,
                                   const struct weaponInfo_s *weapon);

// Table used to attach an extern missile function string to the actual cgame
// function
func_t funcs[] = {{"bryar_func", FX_BryarProjectileThink},
...
// This is used as a fallback for each new field, in case they're using base
// files --eez
const int defaultDamage[] = {
    ...
    FLECHETTE_MINE_DAMAGE, // WP_DET_PACK									// HACK, this is what
                           // the code sez.
    STUN_BATON_DAMAGE,     // WP_STUN_BATON
    0,                     // WP_MELEE										//
                           // handled by the melee attack function
...
const int defaultAltDamage[] = {
    ...
    0,                     // WP_RAPID_FIRE_CONC							//
                           // repeater alt damage is used instead
    BRYAR_PISTOL_DAMAGE    // WP_BLASTER_PISTOL
};
...
const int defaultSplashDamage[] = {
    ...
    FLECHETTE_MINE_SPLASH_DAMAGE, // WP_DET_PACK									//
                                  // HACK, this is what the code sez.
    0,                            // WP_STUN_BATON
    0,                            // WP_MELEE
    0,                            // WP_EMPLACED
    0,                            // WP_BOT_LASER
...
const float defaultSplashRadius[] = {
    ...
    FLECHETTE_MINE_SPLASH_RADIUS, // WP_DET_PACK									//
                                  // HACK, this is what the code sez.
    0,                            // WP_STUN_BATON
    0,                            // WP_MELEE
    0,                            // WP_EMPLACED
...
const float defaultAltSplashRadius[] = {
    ...
    LT_SPLASH_RAD,               // WP_TRIP_MINE
    FLECHETTE_ALT_SPLASH_RAD,    // WP_DET_PACK
                                 // // HACK, this is what the code sez.
    0,                           // WP_STUN_BATON
    0,                           // WP_MELEE										//
                                 // handled by the melee attack function
...
void WPN_FuncSkip(const char **holdBuf) { SkipRestOfLine(holdBuf); }
