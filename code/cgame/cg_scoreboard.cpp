...
void CG_MissionFailed(void) {
  ...
  //		cgi_SP_GetStringTextString( "SP_INGAME_RELOADMISSION", text,
  //sizeof(text) ); 	w = cgi_R_Font_StrLenPixels(text,
  //cgs.media.qhFontSmall, 1.0f); 		cgi_R_Font_DrawString(320 - w/2, 450, text,
  //colorTable[CT_CYAN], cgs.media.qhFontSmall, -1, 1.0f);
}
