...
//===End Saber locks==================================================================
	...
	//modder anims
	//======================================================
	//# #sep BOTH_ MODDER-ONLY
	ENUM2STRING(BOTH_MOD_1),
	ENUM2STRING(BOTH_MOD_2),
	ENUM2STRING(BOTH_MOD_3),
	ENUM2STRING(BOTH_MOD_4),
	ENUM2STRING(BOTH_MOD_5),
	ENUM2STRING(BOTH_MOD_6),
	ENUM2STRING(BOTH_MOD_7),
	ENUM2STRING(BOTH_MOD_8),
	ENUM2STRING(BOTH_MOD_9),
	ENUM2STRING(BOTH_MOD_10),
	ENUM2STRING(BOTH_MOD_11),
	ENUM2STRING(BOTH_MOD_12),
	ENUM2STRING(BOTH_MOD_13),
	ENUM2STRING(BOTH_MOD_14),
	ENUM2STRING(BOTH_MOD_15),
	ENUM2STRING(BOTH_MOD_16),
	ENUM2STRING(BOTH_MOD_17),
	ENUM2STRING(BOTH_MOD_18),
	ENUM2STRING(BOTH_MOD_19),
	ENUM2STRING(BOTH_MOD_20),
	ENUM2STRING(BOTH_MOD_21),
	ENUM2STRING(BOTH_MOD_22),
	ENUM2STRING(BOTH_MOD_23),
	ENUM2STRING(BOTH_MOD_24),
	ENUM2STRING(BOTH_MOD_25),
	ENUM2STRING(BOTH_MOD_26),
	ENUM2STRING(BOTH_MOD_27),
	ENUM2STRING(BOTH_MOD_28),
	ENUM2STRING(BOTH_MOD_29),
	ENUM2STRING(BOTH_MOD_30),
	ENUM2STRING(BOTH_MOD_31),
	ENUM2STRING(BOTH_MOD_32),
	ENUM2STRING(BOTH_MOD_33),
	ENUM2STRING(BOTH_MOD_34),
	ENUM2STRING(BOTH_MOD_35),
	ENUM2STRING(BOTH_MOD_36),
	ENUM2STRING(BOTH_MOD_37),
	ENUM2STRING(BOTH_MOD_38),
	ENUM2STRING(BOTH_MOD_39),
	ENUM2STRING(BOTH_MOD_40),
	ENUM2STRING(BOTH_MOD_41),
	ENUM2STRING(BOTH_MOD_42),
	ENUM2STRING(BOTH_MOD_43),
	ENUM2STRING(BOTH_MOD_44),
	ENUM2STRING(BOTH_MOD_45),
	ENUM2STRING(BOTH_MOD_46),
	ENUM2STRING(BOTH_MOD_47),
	ENUM2STRING(BOTH_MOD_48),
	ENUM2STRING(BOTH_MOD_49),
	ENUM2STRING(BOTH_MOD_50),
