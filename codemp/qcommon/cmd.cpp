...
============
*/
char *Cmd_Args(void) { return Cmd_ArgsFrom(1); }
...
============
*/
void Cmd_ArgsFromBuffer(int arg, char *buffer, int bufferLength) { Q_strncpyz(buffer, Cmd_ArgsFrom(arg), bufferLength); }
...
bool CmdSort(const cmd_function_t *cmd1, const cmd_function_t *cmd2) { return Q_stricmp(cmd1->name, cmd2->name) < 0; }
...
static void Cmd_List_f(void) {
	...
	for (cmd = cmd_functions, i = 0, j = 0; cmd; cmd = cmd->next, i++) {
