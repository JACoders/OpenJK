...
stringID_table_t animTable[MAX_ANIMATIONS + 1] = {
    ...
    //=================================================
    ENUM2STRING(
        BOTH_1CRUFTFORGIL), //# G2 cannot have a reverse anim at beginning of
                            //file # #sep ENUM2STRING(BOTH_ DEATHS
    ...
    ENUM2STRING(BOTH_FALLDEATH1), //# Fall forward off a high cliff and splat
                                  //death - start
    ENUM2STRING(BOTH_FALLDEATH1INAIR), //# Fall forward off a high cliff and
                                       //splat death - loop
    ENUM2STRING(BOTH_FALLDEATH1LAND),  //# Fall forward off a high cliff and
                                       //splat death - hit bottom
    ...
    ENUM2STRING(
        BOTH_DEATH_CROUCHED), //# Death anim when crouched
                              //# #sep ENUM2STRING(BOTH_ DEAD POSES # Should be
                              //last frame of corresponding previous anims
    ...
    ENUM2STRING(
        BOTH_FALLDEAD1LAND), //# Fall forward and splat death finished pose
                             //# #sep ENUM2STRING(BOTH_ DEAD TWITCH/FLOP # React
                             //to being shot from death poses
    ENUM2STRING(
    ...
    ENUM2STRING(BOTH_DEADFORWARD1_FLOP),  //# React to being shot First thrown
                                          //forward death finished pose
    ENUM2STRING(BOTH_DEADFORWARD2_FLOP),  //# React to being shot Second thrown
                                          //forward death finished pose
    ENUM2STRING(BOTH_DEADBACKWARD1_FLOP), //# React to being shot First thrown
                                          //backward death finished pose
    ENUM2STRING(BOTH_DEADBACKWARD2_FLOP), //# React to being shot Second thrown
                                          //backward death finished pose
    ENUM2STRING(BOTH_LYINGDEAD1_FLOP), //# React to being shot Killed lying down
                                       //death finished pose
    ENUM2STRING(BOTH_STUMBLEDEAD1_FLOP), //# React to being shot Stumble forward
                                         //death finished pose
    ENUM2STRING(BOTH_FALLDEAD1_FLOP),   //# React to being shot Fall forward and
                                        //splat death finished pose
    ...
    ENUM2STRING(BOTH_A1_TR_BL), //# Fast weak diagonal attack bottom left to
                                //right Saber Arc and Spin Transitions
    ...
    ENUM2STRING(BOTH_T1_BL__L), //# Fast arc bottom left to left
                                // Saber Arc Transitions that use existing
                                // animations played backwards
    ENUM2STRING(BOTH_T1_BR_TR), //# Fast arc bottom right to top right
                                //(use: ENUM2STRING(BOTH_T1_TR_BR)
    ENUM2STRING(BOTH_T1_BR_T_), //# Fast arc bottom right to top
                                //(use: ENUM2STRING(BOTH_T1_T__BR)
    ENUM2STRING(BOTH_T1__R_BR), //# Fast arc right to bottom right
                                //(use: ENUM2STRING(BOTH_T1_BR__R)
    ENUM2STRING(BOTH_T1__R_T_), //# Fast ar right to top
                                //(use: ENUM2STRING(BOTH_T1_T___R)
    ENUM2STRING(BOTH_T1_TR__R), //# Fast arc top right to right
                                //(use: ENUM2STRING(BOTH_T1__R_TR)
    ENUM2STRING(BOTH_T1_TR_T_), //# Fast arc top right to top
                                //(use: ENUM2STRING(BOTH_T1_T__TR)
    ENUM2STRING(BOTH_T1_TL__R), //# Fast arc top left to right
                                //(use: ENUM2STRING(BOTH_T1__R_TL)
    ENUM2STRING(BOTH_T1_TL_TR), //# Fast arc top left to top right
                                //(use: ENUM2STRING(BOTH_T1_TR_TL)
    ENUM2STRING(BOTH_T1_TL_T_), //# Fast arc top left to top
                                //(use: ENUM2STRING(BOTH_T1_T__TL)
    ENUM2STRING(BOTH_T1_TL__L), //# Fast arc top left to left
                                //(use: ENUM2STRING(BOTH_T1__L_TL)
    ENUM2STRING(BOTH_T1__L_TR), //# Fast arc left to top right
                                //(use: ENUM2STRING(BOTH_T1_TR__L)
    ENUM2STRING(BOTH_T1__L_T_), //# Fast arc left to top
                                //(use: ENUM2STRING(BOTH_T1_T___L)
    ENUM2STRING(BOTH_T1__L_BL), //# Fast arc left to bottom left
                                //(use: ENUM2STRING(BOTH_T1_BL__L)
    ENUM2STRING(BOTH_T1_BL_T_), //# Fast arc bottom left to top
                                //(use: ENUM2STRING(BOTH_T1_T__BL)
    ENUM2STRING(BOTH_T1_BL_TL), //# Fast arc bottom left to top left
                                //(use: ENUM2STRING(BOTH_T1_TL_BL) Saber Attack
                                // Start Transitions
    ENUM2STRING(BOTH_S1_S1_T_), //# Fast plain transition from stance1 to
                                //top-to-bottom Fast weak attack
    ENUM2STRING(BOTH_S1_S1__L), //# Fast plain transition from stance1 to
                                //left-to-right Fast weak attack
    ENUM2STRING(BOTH_S1_S1__R), //# Fast plain transition from stance1 to
                                //right-to-left Fast weak attack
    ENUM2STRING(BOTH_S1_S1_TL), //# Fast plain transition from stance1 to
                                //top-left-to-bottom-right Fast weak attack
    ENUM2STRING(BOTH_S1_S1_BR), //# Fast plain transition from stance1 to
                                //bottom-right-to-top-left Fast weak attack
    ENUM2STRING(BOTH_S1_S1_BL), //# Fast plain transition from stance1 to
                                //bottom-left-to-top-right Fast weak attack
    ENUM2STRING(BOTH_S1_S1_TR), //# Fast plain transition from stance1 to
                                //top-right-to-bottom-left Fast weak attack
                                // Saber Attack Return Transitions
    ENUM2STRING(BOTH_R1_B__S1), //# Fast plain transition from top-to-bottom
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R1__L_S1), //# Fast plain transition from left-to-right
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R1__R_S1), //# Fast plain transition from right-to-left
                                //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R1_TL_S1), //# Fast plain transition from top-left-to-bottom-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R1_BR_S1), //# Fast plain transition from bottom-right-to-top-left
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R1_BL_S1), //# Fast plain transition from bottom-left-to-top-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R1_TR_S1), //# Fast plain transition from top-right-to-bottom-left
                        //Fast weak attack Saber Attack Bounces (first 4 frames
                        // of an attack), played backwards)
    ...
    ENUM2STRING(BOTH_A2_TR_BL), //# Fast weak diagonal attack bottom left to
                                //right Saber Arc and Spin Transitions
    ...
    ENUM2STRING(BOTH_T2_BL__L), //# Fast arc bottom left to left
                                // Saber Arc Transitions that use existing
                                // animations played backwards
    ENUM2STRING(BOTH_T2_BR_TR), //# Fast arc bottom right to top right
                                //(use: ENUM2STRING(BOTH_T2_TR_BR)
    ENUM2STRING(BOTH_T2_BR_T_), //# Fast arc bottom right to top
                                //(use: ENUM2STRING(BOTH_T2_T__BR)
    ENUM2STRING(BOTH_T2__R_BR), //# Fast arc right to bottom right
                                //(use: ENUM2STRING(BOTH_T2_BR__R)
    ENUM2STRING(BOTH_T2__R_T_), //# Fast ar right to top
                                //(use: ENUM2STRING(BOTH_T2_T___R)
    ENUM2STRING(BOTH_T2_TR__R), //# Fast arc top right to right
                                //(use: ENUM2STRING(BOTH_T2__R_TR)
    ENUM2STRING(BOTH_T2_TR_T_), //# Fast arc top right to top
                                //(use: ENUM2STRING(BOTH_T2_T__TR)
    ENUM2STRING(BOTH_T2_TL__R), //# Fast arc top left to right
                                //(use: ENUM2STRING(BOTH_T2__R_TL)
    ENUM2STRING(BOTH_T2_TL_TR), //# Fast arc top left to top right
                                //(use: ENUM2STRING(BOTH_T2_TR_TL)
    ENUM2STRING(BOTH_T2_TL_T_), //# Fast arc top left to top
                                //(use: ENUM2STRING(BOTH_T2_T__TL)
    ENUM2STRING(BOTH_T2_TL__L), //# Fast arc top left to left
                                //(use: ENUM2STRING(BOTH_T2__L_TL)
    ENUM2STRING(BOTH_T2__L_TR), //# Fast arc left to top right
                                //(use: ENUM2STRING(BOTH_T2_TR__L)
    ENUM2STRING(BOTH_T2__L_T_), //# Fast arc left to top
                                //(use: ENUM2STRING(BOTH_T2_T___L)
    ENUM2STRING(BOTH_T2__L_BL), //# Fast arc left to bottom left
                                //(use: ENUM2STRING(BOTH_T2_BL__L)
    ENUM2STRING(BOTH_T2_BL_T_), //# Fast arc bottom left to top
                                //(use: ENUM2STRING(BOTH_T2_T__BL)
    ENUM2STRING(BOTH_T2_BL_TL), //# Fast arc bottom left to top left
                                //(use: ENUM2STRING(BOTH_T2_TL_BL) Saber Attack
                                // Start Transitions
    ENUM2STRING(BOTH_S2_S1_T_), //# Fast plain transition from stance1 to
                                //top-to-bottom Fast weak attack
    ENUM2STRING(BOTH_S2_S1__L), //# Fast plain transition from stance1 to
                                //left-to-right Fast weak attack
    ENUM2STRING(BOTH_S2_S1__R), //# Fast plain transition from stance1 to
                                //right-to-left Fast weak attack
    ENUM2STRING(BOTH_S2_S1_TL), //# Fast plain transition from stance1 to
                                //top-left-to-bottom-right Fast weak attack
    ENUM2STRING(BOTH_S2_S1_BR), //# Fast plain transition from stance1 to
                                //bottom-right-to-top-left Fast weak attack
    ENUM2STRING(BOTH_S2_S1_BL), //# Fast plain transition from stance1 to
                                //bottom-left-to-top-right Fast weak attack
    ENUM2STRING(BOTH_S2_S1_TR), //# Fast plain transition from stance1 to
                                //top-right-to-bottom-left Fast weak attack
                                // Saber Attack Return Transitions
    ENUM2STRING(BOTH_R2_B__S1), //# Fast plain transition from top-to-bottom
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R2__L_S1), //# Fast plain transition from left-to-right
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R2__R_S1), //# Fast plain transition from right-to-left
                                //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R2_TL_S1), //# Fast plain transition from top-left-to-bottom-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R2_BR_S1), //# Fast plain transition from bottom-right-to-top-left
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R2_BL_S1), //# Fast plain transition from bottom-left-to-top-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R2_TR_S1), //# Fast plain transition from top-right-to-bottom-left
                        //Fast weak attack Saber Attack Bounces (first 4 frames
                        // of an attack), played backwards)
    ...
    ENUM2STRING(BOTH_A3_TR_BL), //# Fast weak diagonal attack bottom left to
                                //right Saber Arc and Spin Transitions
    ...
    ENUM2STRING(BOTH_T3_BL__L), //# Fast arc bottom left to left
                                // Saber Arc Transitions that use existing
                                // animations played backwards
    ENUM2STRING(BOTH_T3_BR_TR), //# Fast arc bottom right to top right
                                //(use: ENUM2STRING(BOTH_T3_TR_BR)
    ENUM2STRING(BOTH_T3_BR_T_), //# Fast arc bottom right to top
                                //(use: ENUM2STRING(BOTH_T3_T__BR)
    ENUM2STRING(BOTH_T3__R_BR), //# Fast arc right to bottom right
                                //(use: ENUM2STRING(BOTH_T3_BR__R)
    ENUM2STRING(BOTH_T3__R_T_), //# Fast ar right to top
                                //(use: ENUM2STRING(BOTH_T3_T___R)
    ENUM2STRING(BOTH_T3_TR__R), //# Fast arc top right to right
                                //(use: ENUM2STRING(BOTH_T3__R_TR)
    ENUM2STRING(BOTH_T3_TR_T_), //# Fast arc top right to top
                                //(use: ENUM2STRING(BOTH_T3_T__TR)
    ENUM2STRING(BOTH_T3_TL__R), //# Fast arc top left to right
                                //(use: ENUM2STRING(BOTH_T3__R_TL)
    ENUM2STRING(BOTH_T3_TL_TR), //# Fast arc top left to top right
                                //(use: ENUM2STRING(BOTH_T3_TR_TL)
    ENUM2STRING(BOTH_T3_TL_T_), //# Fast arc top left to top
                                //(use: ENUM2STRING(BOTH_T3_T__TL)
    ENUM2STRING(BOTH_T3_TL__L), //# Fast arc top left to left
                                //(use: ENUM2STRING(BOTH_T3__L_TL)
    ENUM2STRING(BOTH_T3__L_TR), //# Fast arc left to top right
                                //(use: ENUM2STRING(BOTH_T3_TR__L)
    ENUM2STRING(BOTH_T3__L_T_), //# Fast arc left to top
                                //(use: ENUM2STRING(BOTH_T3_T___L)
    ENUM2STRING(BOTH_T3__L_BL), //# Fast arc left to bottom left
                                //(use: ENUM2STRING(BOTH_T3_BL__L)
    ENUM2STRING(BOTH_T3_BL_T_), //# Fast arc bottom left to top
                                //(use: ENUM2STRING(BOTH_T3_T__BL)
    ENUM2STRING(BOTH_T3_BL_TL), //# Fast arc bottom left to top left
                                //(use: ENUM2STRING(BOTH_T3_TL_BL) Saber Attack
                                // Start Transitions
    ENUM2STRING(BOTH_S3_S1_T_), //# Fast plain transition from stance1 to
                                //top-to-bottom Fast weak attack
    ENUM2STRING(BOTH_S3_S1__L), //# Fast plain transition from stance1 to
                                //left-to-right Fast weak attack
    ENUM2STRING(BOTH_S3_S1__R), //# Fast plain transition from stance1 to
                                //right-to-left Fast weak attack
    ENUM2STRING(BOTH_S3_S1_TL), //# Fast plain transition from stance1 to
                                //top-left-to-bottom-right Fast weak attack
    ENUM2STRING(BOTH_S3_S1_BR), //# Fast plain transition from stance1 to
                                //bottom-right-to-top-left Fast weak attack
    ENUM2STRING(BOTH_S3_S1_BL), //# Fast plain transition from stance1 to
                                //bottom-left-to-top-right Fast weak attack
    ENUM2STRING(BOTH_S3_S1_TR), //# Fast plain transition from stance1 to
                                //top-right-to-bottom-left Fast weak attack
                                // Saber Attack Return Transitions
    ENUM2STRING(BOTH_R3_B__S1), //# Fast plain transition from top-to-bottom
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R3__L_S1), //# Fast plain transition from left-to-right
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R3__R_S1), //# Fast plain transition from right-to-left
                                //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R3_TL_S1), //# Fast plain transition from top-left-to-bottom-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R3_BR_S1), //# Fast plain transition from bottom-right-to-top-left
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R3_BL_S1), //# Fast plain transition from bottom-left-to-top-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R3_TR_S1), //# Fast plain transition from top-right-to-bottom-left
                        //Fast weak attack Saber Attack Bounces (first 4 frames
                        // of an attack), played backwards)
    ...
    ENUM2STRING(BOTH_A4_TR_BL), //# Fast weak diagonal attack bottom left to
                                //right Saber Arc and Spin Transitions
    ...
    ENUM2STRING(BOTH_T4_BL__L), //# Fast arc bottom left to left
                                // Saber Arc Transitions that use existing
                                // animations played backwards
    ENUM2STRING(BOTH_T4_BR_TR), //# Fast arc bottom right to top right
                                //(use: ENUM2STRING(BOTH_T4_TR_BR)
    ENUM2STRING(BOTH_T4_BR_T_), //# Fast arc bottom right to top
                                //(use: ENUM2STRING(BOTH_T4_T__BR)
    ENUM2STRING(BOTH_T4__R_BR), //# Fast arc right to bottom right
                                //(use: ENUM2STRING(BOTH_T4_BR__R)
    ENUM2STRING(BOTH_T4__R_T_), //# Fast ar right to top
                                //(use: ENUM2STRING(BOTH_T4_T___R)
    ENUM2STRING(BOTH_T4_TR__R), //# Fast arc top right to right
                                //(use: ENUM2STRING(BOTH_T4__R_TR)
    ENUM2STRING(BOTH_T4_TR_T_), //# Fast arc top right to top
                                //(use: ENUM2STRING(BOTH_T4_T__TR)
    ENUM2STRING(BOTH_T4_TL__R), //# Fast arc top left to right
                                //(use: ENUM2STRING(BOTH_T4__R_TL)
    ENUM2STRING(BOTH_T4_TL_TR), //# Fast arc top left to top right
                                //(use: ENUM2STRING(BOTH_T4_TR_TL)
    ENUM2STRING(BOTH_T4_TL_T_), //# Fast arc top left to top
                                //(use: ENUM2STRING(BOTH_T4_T__TL)
    ENUM2STRING(BOTH_T4_TL__L), //# Fast arc top left to left
                                //(use: ENUM2STRING(BOTH_T4__L_TL)
    ENUM2STRING(BOTH_T4__L_TR), //# Fast arc left to top right
                                //(use: ENUM2STRING(BOTH_T4_TR__L)
    ENUM2STRING(BOTH_T4__L_T_), //# Fast arc left to top
                                //(use: ENUM2STRING(BOTH_T4_T___L)
    ENUM2STRING(BOTH_T4__L_BL), //# Fast arc left to bottom left
                                //(use: ENUM2STRING(BOTH_T4_BL__L)
    ENUM2STRING(BOTH_T4_BL_T_), //# Fast arc bottom left to top
                                //(use: ENUM2STRING(BOTH_T4_T__BL)
    ENUM2STRING(BOTH_T4_BL_TL), //# Fast arc bottom left to top left
                                //(use: ENUM2STRING(BOTH_T4_TL_BL) Saber Attack
                                // Start Transitions
    ENUM2STRING(BOTH_S4_S1_T_), //# Fast plain transition from stance1 to
                                //top-to-bottom Fast weak attack
    ENUM2STRING(BOTH_S4_S1__L), //# Fast plain transition from stance1 to
                                //left-to-right Fast weak attack
    ENUM2STRING(BOTH_S4_S1__R), //# Fast plain transition from stance1 to
                                //right-to-left Fast weak attack
    ENUM2STRING(BOTH_S4_S1_TL), //# Fast plain transition from stance1 to
                                //top-left-to-bottom-right Fast weak attack
    ENUM2STRING(BOTH_S4_S1_BR), //# Fast plain transition from stance1 to
                                //bottom-right-to-top-left Fast weak attack
    ENUM2STRING(BOTH_S4_S1_BL), //# Fast plain transition from stance1 to
                                //bottom-left-to-top-right Fast weak attack
    ENUM2STRING(BOTH_S4_S1_TR), //# Fast plain transition from stance1 to
                                //top-right-to-bottom-left Fast weak attack
                                // Saber Attack Return Transitions
    ENUM2STRING(BOTH_R4_B__S1), //# Fast plain transition from top-to-bottom
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R4__L_S1), //# Fast plain transition from left-to-right
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R4__R_S1), //# Fast plain transition from right-to-left
                                //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R4_TL_S1), //# Fast plain transition from top-left-to-bottom-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R4_BR_S1), //# Fast plain transition from bottom-right-to-top-left
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R4_BL_S1), //# Fast plain transition from bottom-left-to-top-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R4_TR_S1), //# Fast plain transition from top-right-to-bottom-left
                        //Fast weak attack Saber Attack Bounces (first 4 frames
                        // of an attack), played backwards)
    ...
    ENUM2STRING(BOTH_A5_TR_BL), //# Fast weak diagonal attack bottom left to
                                //right Saber Arc and Spin Transitions
    ...
    ENUM2STRING(BOTH_T5_BL__L), //# Fast arc bottom left to left
                                // Saber Arc Transitions that use existing
                                // animations played backwards
    ENUM2STRING(BOTH_T5_BR_TR), //# Fast arc bottom right to top right
                                //(use: ENUM2STRING(BOTH_T5_TR_BR)
    ENUM2STRING(BOTH_T5_BR_T_), //# Fast arc bottom right to top
                                //(use: ENUM2STRING(BOTH_T5_T__BR)
    ENUM2STRING(BOTH_T5__R_BR), //# Fast arc right to bottom right
                                //(use: ENUM2STRING(BOTH_T5_BR__R)
    ENUM2STRING(BOTH_T5__R_T_), //# Fast ar right to top
                                //(use: ENUM2STRING(BOTH_T5_T___R)
    ENUM2STRING(BOTH_T5_TR__R), //# Fast arc top right to right
                                //(use: ENUM2STRING(BOTH_T5__R_TR)
    ENUM2STRING(BOTH_T5_TR_T_), //# Fast arc top right to top
                                //(use: ENUM2STRING(BOTH_T5_T__TR)
    ENUM2STRING(BOTH_T5_TL__R), //# Fast arc top left to right
                                //(use: ENUM2STRING(BOTH_T5__R_TL)
    ENUM2STRING(BOTH_T5_TL_TR), //# Fast arc top left to top right
                                //(use: ENUM2STRING(BOTH_T5_TR_TL)
    ENUM2STRING(BOTH_T5_TL_T_), //# Fast arc top left to top
                                //(use: ENUM2STRING(BOTH_T5_T__TL)
    ENUM2STRING(BOTH_T5_TL__L), //# Fast arc top left to left
                                //(use: ENUM2STRING(BOTH_T5__L_TL)
    ENUM2STRING(BOTH_T5__L_TR), //# Fast arc left to top right
                                //(use: ENUM2STRING(BOTH_T5_TR__L)
    ENUM2STRING(BOTH_T5__L_T_), //# Fast arc left to top
                                //(use: ENUM2STRING(BOTH_T5_T___L)
    ENUM2STRING(BOTH_T5__L_BL), //# Fast arc left to bottom left
                                //(use: ENUM2STRING(BOTH_T5_BL__L)
    ENUM2STRING(BOTH_T5_BL_T_), //# Fast arc bottom left to top
                                //(use: ENUM2STRING(BOTH_T5_T__BL)
    ENUM2STRING(BOTH_T5_BL_TL), //# Fast arc bottom left to top left
                                //(use: ENUM2STRING(BOTH_T5_TL_BL) Saber Attack
                                // Start Transitions
    ENUM2STRING(BOTH_S5_S1_T_), //# Fast plain transition from stance1 to
                                //top-to-bottom Fast weak attack
    ENUM2STRING(BOTH_S5_S1__L), //# Fast plain transition from stance1 to
                                //left-to-right Fast weak attack
    ENUM2STRING(BOTH_S5_S1__R), //# Fast plain transition from stance1 to
                                //right-to-left Fast weak attack
    ENUM2STRING(BOTH_S5_S1_TL), //# Fast plain transition from stance1 to
                                //top-left-to-bottom-right Fast weak attack
    ENUM2STRING(BOTH_S5_S1_BR), //# Fast plain transition from stance1 to
                                //bottom-right-to-top-left Fast weak attack
    ENUM2STRING(BOTH_S5_S1_BL), //# Fast plain transition from stance1 to
                                //bottom-left-to-top-right Fast weak attack
    ENUM2STRING(BOTH_S5_S1_TR), //# Fast plain transition from stance1 to
                                //top-right-to-bottom-left Fast weak attack
                                // Saber Attack Return Transitions
    ENUM2STRING(BOTH_R5_B__S1), //# Fast plain transition from top-to-bottom
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R5__L_S1), //# Fast plain transition from left-to-right
                                //Fast weak attack to stance1
    ENUM2STRING(BOTH_R5__R_S1), //# Fast plain transition from right-to-left
                                //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R5_TL_S1), //# Fast plain transition from top-left-to-bottom-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R5_BR_S1), //# Fast plain transition from bottom-right-to-top-left
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R5_BL_S1), //# Fast plain transition from bottom-left-to-top-right
                        //Fast weak attack to stance1
    ENUM2STRING(
        BOTH_R5_TR_S1), //# Fast plain transition from top-right-to-bottom-left
                        //Fast weak attack Saber Attack Bounces (first 4 frames
                        // of an attack), played backwards)
    ...
    ENUM2STRING(BOTH_STANDUP2),       //# Luke standing up from his meditation
                                      //platform (cin # 37)
    ...
    ENUM2STRING(BOTH_STAND5TOAIM),    //# Transition of Kye aiming his gun at
                                      //Desann (cin #9)
    ENUM2STRING(BOTH_STAND5STARTLEDLOOKLEFT), //# Kyle turning to watch the
                                              //bridge drop (cin #9)
    ENUM2STRING(
        BOTH_STARTLEDLOOKLEFTTOSTAND5), //# Kyle returning to stand 5 from
                                        //watching the bridge drop (cin #9)
    ENUM2STRING(BOTH_STAND5TOSTAND8),   //# Transition from stand5 to stand8
    ENUM2STRING(BOTH_STAND7TOSTAND8), //# Tavion putting hands on back of chair
                                      //(cin #11)
    ENUM2STRING(BOTH_STAND8TOSTAND5), //# Transition from stand8 to stand5
    ENUM2STRING(BOTH_STAND5SHIFTWEIGHT), //# Weightshift from stand5 to side and
                                         //back to stand5
    ...
    ENUM2STRING(BOTH_STAND5LOOK180LEFTSTART), //# Start looking over left
                                              //shoulder (cin #17)
    ENUM2STRING(BOTH_STAND5LOOK180LEFTSTOP), //# Stop looking over left shoulder
                                             //(cin #17)
    ...
    ENUM2STRING(BOTH_CONSOLE2START), //# typing at a console with comm link in
                                     //hand (cin #5)
    ENUM2STRING(
        BOTH_CONSOLE2), //# typing at a console with comm link in hand (cin #5)
    ENUM2STRING(BOTH_CONSOLE2STOP), //# typing at a console with comm link in
                                    //hand (cin #5)
    ENUM2STRING(BOTH_CONSOLE2HOLDCOMSTART), //# lean in to type at console while
                                            //holding comm link in hand (cin #5)
    ENUM2STRING(
        BOTH_CONSOLE2HOLDCOMSTOP), //# lean away after typing at console while
                                   //holding comm link in hand (cin #5)
    ...
    ENUM2STRING(BOTH_FORCEFOUNTAIN1_START), //# Kyle being lifted into the Force
                                            //Fountain (cin #10)
    ENUM2STRING(
        BOTH_FORCEFOUNTAIN1_MIDDLE), //# Kyle changing to looping position in
                                     //the Force Fountain (cin #10)
    ENUM2STRING(BOTH_FORCEFOUNTAIN1_LOOP), //# Kyle being spun in the Force
                                           //Fountain (cin #10)
    ENUM2STRING(BOTH_FORCEFOUNTAIN1_STOP), //# Kyle being set down out of the
                                           //Force Fountain (cin #10)
    ENUM2STRING(BOTH_THUMBING1),       //# Lando gesturing with thumb over his
                                       //shoulder (cin #19)
    ENUM2STRING(BOTH_COME_ON1),        //# Jan gesturing to Kyle (cin #32a)
    ENUM2STRING(BOTH_STEADYSELF1),     //# Jan trying to keep footing (cin #32a)
                                       //Kyle (cin#5)
    ENUM2STRING(BOTH_STEADYSELF1END),  //# Return hands to side from STEADSELF1
                                       //Kyle (cin#5)
    ENUM2STRING(BOTH_SILENCEGESTURE1), //# Luke silencing Kyle with a raised
                                       //hand (cin #37)
    ENUM2STRING(BOTH_REACHFORSABER1), //# Luke holding hand out for Kyle's saber
                                      //(cin #37)
    ENUM2STRING(BOTH_PUNCHER1), //# Jan punching Kyle in the shoulder (cin #37)
    ENUM2STRING(BOTH_CONSTRAINER1HOLD),  //# Static pose of starting Tavion
                                         //constraining Jan (cin #9)
    ENUM2STRING(BOTH_CONSTRAINEE1HOLD),  //# Static pose of starting Jan being
                                         //constrained by Tavion (cin #9)
    ENUM2STRING(BOTH_CONSTRAINER1STAND), //# Tavion constraining Jan in a stand
                                         //pose (cin #9)
    ENUM2STRING(BOTH_CONSTRAINEE1STAND), //# Jan being constrained in a stand
                                         //pose (cin #9)
    ...
    ENUM2STRING(BOTH_SABERKILLEE1), //# Jan about to be struck by Tavion with
                                    //saber (cin #9)
    ...
    ENUM2STRING(BOTH_HUGGERSTOP1), //# Kyle stop hugging Jan but don't let her
                                   //go (cin #29)
    ENUM2STRING(
    ...
    ENUM2STRING(BOTH_BARTENDER_COWERSTART), //# Start of Bartender raising both
                                            //hands up in surrender (cin #16)
    ENUM2STRING(BOTH_BARTENDER_COWERLOOP),  //# Loop of Bartender waving both
                                            //hands in surrender (cin #16)
    ENUM2STRING(BOTH_BARTENDER_COWER), //# Single frame of Bartender waving both
                                       //hands in surrender (cin #16)
    ENUM2STRING(BOTH_THREATEN1_START), //# First frame of Kyle threatening
                                       //Bartender with lightsaber (cin #16)
    ENUM2STRING(BOTH_THREATEN1), //# Kyle threatening Bartender with lightsaber
                                 //(cin #16)
    ENUM2STRING(
        BOTH_RADIO_ONOFF), //# Mech Galak turning on his suit radio (cin #32)
    ENUM2STRING(BOTH_TRIUMPHANT1START), //# Mech Galak raising his arms in
                                        //victory (cin #32)
    ENUM2STRING(BOTH_TRIUMPHANT1STARTGESTURE), //# Mech Galak raising his arms
                                               //in victory (cin #32)
    ENUM2STRING(BOTH_TRIUMPHANT1STOP), //# Mech Galak lowering his arms in
                                       //victory (cin #32)
    ...
    ENUM2STRING(BOTH_SIT2TOSIT4),   //# Trans from sit2 to sit4 (cin #12) Luke
                                    //leaning back from lotus position.
    ...
    ENUM2STRING(BOTH_DEATH14_SITUP),  //# Tavion sitting up after having been
                                      //thrown (cin #23)
    ...
    ENUM2STRING(BOTH_SLAMSABERDOWN), //# Kyle slamming his saber on the bar top
                                     //(cin# 14)
    ...
    ENUM2STRING(BOTH_LADDER_UP1), //# Climbing up a ladder with rungs at 16 unit
                                  //intervals
    ENUM2STRING(BOTH_LADDER_DWN1),   //# Climbing down a ladder with rungs at 16
                                     //unit intervals
    ...
    ENUM2STRING(BOTH_LIE_DOWN1), //# From a stand position), get down on
                                 //ground), face down
    ENUM2STRING(BOTH_LIE_DOWN2), //# From a stand position), get down on
                                 //ground), face up
    ENUM2STRING(BOTH_LIE_DOWN3), //# reaction to local disnode being destroyed
    ENUM2STRING(BOTH_PAIN2WRITHE1), //# Transition from upright position to
                                    //writhing on ground anim
    ...
    ENUM2STRING(BOTH_WRITHING1RLEG), //# Lying on ground writhing in pain),
                                     //holding right leg
    ENUM2STRING(BOTH_WRITHING1LLEG), //# Lying on ground writhing in pain),
                                     //holding left leg
    ENUM2STRING(BOTH_WRITHING2), //# Lying on ground on front writhing in pain
    ENUM2STRING(BOTH_INJURED1),  //# Lying down), against wall - can also be
                                 //sleeping against wall
    ...
    ENUM2STRING(BOTH_PROPUP1), //# Kyle getting up from having been knocked down
                               //(cin #9 end)
    ENUM2STRING(
    ...
    ENUM2STRING(BOTH_SLEEP1GETUP), //# alarmed and getting up out of sleep1 pose
                                   //to stand
    ENUM2STRING(BOTH_SLEEP1GETUP2), //#
    ENUM2STRING(BOTH_SLEEP2GETUP), //# alarmed and getting up out of sleep2 pose
                                   //to stand
    ENUM2STRING(BOTH_SLEEP3GETUP), //# alarmed and getting up out of sleep3 pose
                                   //to stand
    ...
    ENUM2STRING(BOTH_RESTRAINED1POINT), //# Telsia tied to medical table
                                        //pointing at Munro
    ENUM2STRING(
        BOTH_LIFTED1), //# Fits with ENUM2STRING(BOTH_LIFT1), lifted on shoulder
    ENUM2STRING(BOTH_CARRIED1), //# Fits with ENUM2STRING(TORSO_CARRY1), carried
                                //over shoulder
    ...
    ENUM2STRING(BOTH_COCKPIT_TALKR1START), //# turn head from straight forward
                                           //to looking full right
    ENUM2STRING(BOTH_COCKPIT_TALKR1STARTTOMID), //# from TALKR1START to looking
                                                //at hologram (cin #1)
    ENUM2STRING(BOTH_COCKPIT_TALKR1MIDTOSTART), //# from looking at hologram to
                                                //TALKR1START (cin #1)
    ENUM2STRING(BOTH_COCKPIT_TALKR1STOP), //# return head to straight forward
                                          //from BOTH_COCKPIT_TALKR1
    ENUM2STRING(BOTH_COCKPIT_TALKR1STOPTOMID), //# from TALKR1STOP to TALKR1MID
    ENUM2STRING(BOTH_COCKPIT_TALKR1MIDTOSTOP), //# from looking at hologram to
                                               //TALKR1STOP (cin #1)
    ENUM2STRING(BOTH_COCKPIT_TALKR1),          //# talk to right side

    ENUM2STRING(BOTH_COCKPIT_TALKL1START), //# turn head from straight forward
                                           //to looking full left
    ENUM2STRING(BOTH_COCKPIT_TALKL1STARTTOMID), //# from TALKL1START to looking
                                                //at hologram (cin #1)
    ENUM2STRING(BOTH_COCKPIT_TALKL1MIDTOSTART), //# from looking at hologram to
                                                //TALKL1START (cin #1)
    ENUM2STRING(BOTH_COCKPIT_TALKL1STOP), //# return head to straight forward
                                          //from BOTH_COCKPIT_TALKL1
    ENUM2STRING(BOTH_COCKPIT_TALKL1STOPTOMID), //# from TALKL1STOP to TALKL1MID
    ENUM2STRING(BOTH_COCKPIT_TALKL1MIDTOSTOP), //# from looking at hologram to
                                               //TALKL1STOP (cin #1)
    ...
    ENUM2STRING(BOTH_COCKPIT_CONSOLE2_PARTIAL), //# last part of console2 anim
                                                //(cin #1) used by Jan
    ...
    ENUM2STRING(BOTH_COCKPIT_TALKGESTURE7START), //# Lando's supporting hand to
                                                 //Kyle (cin #21)
    ENUM2STRING(BOTH_COCKPIT_TALKGESTURE7STOP), //# Lando's supporting hand away
                                                //from Kyle (cin #21)
    ENUM2STRING(
        BOTH_COCKPIT_TALKGESTURE8START), //# Hand to Lando's chin (cin #21)
    ENUM2STRING(BOTH_COCKPIT_TALKGESTURE8STOP), //# hand away from Lando's chin
                                                //*cin #21)
    ...
    ENUM2STRING(LEGS_TURN1), //# What legs do when you turn your lower body to
                             //match your upper body facing
