...
typedef enum //# setType_e
{
  ...
  SET_LOCKYAW,    //## %s="off"  # Lock legs to a certain yaw angle (or "off" or
                  //"auto" uses current)
  SET_FULLNAME,   //## %s="NULL" # This name will appear when ent is scanned by
                  //tricorder
  ...
  SET_ICARUS_FREEZE, //## %s="NULL" # Specify name of entity to freeze -
                     //!!!NOTE!!! since the ent is frozen, it cannot unfreeze
                     //itself, you must have some other entity unfreeze a frozen
                     //ent!!!
  SET_ICARUS_UNFREEZE, //## %s="NULL" # Specify name of entity to unfreeze -
                       //!!!NOTE!!! since the ent is frozen, it cannot unfreeze
                       //itself, you must have some other entity unfreeze a
                       //frozen ent!!!
  ...
  SET_SECRET_AREA_FOUND,   //## %t="BOOL_TYPES" # Increment secret areas found
                           //counter
  SET_MISSION_STATUS_SCREEN, //## %t="BOOL_TYPES" # Display Mission Status
                             //screen before advancing to next level
