...
qboolean G_ParseAnimFileSet(const char *filename, const char *animCFG,
  ...
  if (level.numKnownAnimFileSets == MAX_ANIM_FILES) { // TOO MANY!
    G_Error("G_ParseAnimFileSet: MAX_ANIM_FILES");
  }

  // Okay, time to parse in a new one
  Q_strncpyz(
      level.knownAnimFileSets[level.numKnownAnimFileSets].filename,
      strippedName,
      sizeof(level.knownAnimFileSets[level.numKnownAnimFileSets].filename));

  // Load and parse animations.cfg file
  Com_sprintf(afilename, sizeof(afilename), "models/players/%s/animation.cfg",
              animCFG);
...
void G_LoadAnimFileSet(gentity_t *ent, const char *modelName) {
  ...
  // now load and parse the animation.cfg, animsounds.cfg and set the
  // animFileIndex
  if (!GLAName) {
    Com_Printf(
        S_COLOR_RED
        "Failed find animation file name models/players/%s/animation.cfg\n",
        modelName);
    strippedName = "broken";
  } else {
  ...
  // now load and parse the animation.cfg, animsounds.cfg and set the
  // animFileIndex
  if (!G_ParseAnimFileSet(modelName, strippedName,
...
void NPC_BuildRandom(gentity_t *NPC) {
  ...
  case 0: // female
    ...
    default:
    case 0:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "garren",
                 sizeof(NPC->client->renderInfo.headModelName));
      break;
    case 1:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "garren/salma",
                 sizeof(NPC->client->renderInfo.headModelName));
      break;
    case 2:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "garren/mackey",
                 sizeof(NPC->client->renderInfo.headModelName));
    ...
    default:
    case 0:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewfemale/gold",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    case 1:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewfemale",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    case 2:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewfemale/blue",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    case 3:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewfemale/aframG",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    case 4:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewfemale/aframR",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    case 5:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewfemale/aframB",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    }
    Q_strncpyz(NPC->client->renderInfo.legsModelName, "crewfemale",
  ...
  case 2: // male
    ...
    default:
    case 0:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "chakotay/nelson",
                 sizeof(NPC->client->renderInfo.headModelName));
      break;
    case 1:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "paris/chase",
                 sizeof(NPC->client->renderInfo.headModelName));
      break;
    case 2:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "doctor/pasty",
                 sizeof(NPC->client->renderInfo.headModelName));
      break;
    case 3:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "kim/durk",
                 sizeof(NPC->client->renderInfo.headModelName));
      break;
    case 4:
      Q_strncpyz(NPC->client->renderInfo.headModelName, "paris/kray",
                 sizeof(NPC->client->renderInfo.headModelName));
      break;
    }
    switch (color) {
    default:
    case 0:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewthin/red",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    case 1:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewthin",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
    case 2:
      Q_strncpyz(NPC->client->renderInfo.torsoModelName, "crewthin/blue",
                 sizeof(NPC->client->renderInfo.torsoModelName));
      break;
      // NOTE: 3 - 5 should be red, gold & blue, afram hands
    }
    Q_strncpyz(NPC->client->renderInfo.legsModelName, "crewthin",
               sizeof(NPC->client->renderInfo.legsModelName));
    break;
  }

  NPC->s.modelScale[0] = NPC->s.modelScale[1] = NPC->s.modelScale[2] =
      Q_irand(87, 102) / 100.0f;
...
qboolean NPC_ParseParms(const char *NPCName, gentity_t *NPC) {
  ...
  // DEFAULT_HEADMODEL,  sizeof(ri->headModelName)); Q_strncpyz(
  // ri->torsoModelName, DEFAULT_TORSOMODEL, sizeof(ri->torsoModelName));
  // Q_strncpyz( ri->legsModelName,	DEFAULT_LEGSMODEL,
  // sizeof(ri->legsModelName));
...
void NPC_LoadParms(void) {
  ...
  fileCnt = gi.FS_GetFileList("ext_data", ".npc", npcExtensionListBuf,
