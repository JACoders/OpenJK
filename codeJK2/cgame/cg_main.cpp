...
================
*/
extern "C" Q_EXPORT intptr_t vmMain(int command, intptr_t arg0, intptr_t arg1, intptr_t arg2, intptr_t arg3, intptr_t arg4, intptr_t arg5, intptr_t arg6,
									intptr_t arg7) {
	centity_t *cent;
...
forceTicPos_t forceTicPos[] = {
	...
	{12, 45, 20, 10, "gfx/hud/force_tick2", NULL_HANDLE},  {14, 49, 20, 10, "gfx/hud/force_tick3", NULL_HANDLE},
	{17, 52, 20, 10, "gfx/hud/force_tick4", NULL_HANDLE},  {22, 55, 10, 10, "gfx/hud/force_tick5", NULL_HANDLE},
	{28, 57, 10, 20, "gfx/hud/force_tick6", NULL_HANDLE},  {34, 59, 10, 10, "gfx/hud/force_tick7", NULL_HANDLE}, // Left bottom

	{46, 59, -10, 10, "gfx/hud/force_tick7", NULL_HANDLE}, // Right bottom
	{52, 57, -10, 20, "gfx/hud/force_tick6", NULL_HANDLE}, {58, 55, -10, 10, "gfx/hud/force_tick5", NULL_HANDLE},
	{63, 52, -20, 10, "gfx/hud/force_tick4", NULL_HANDLE}, {66, 49, -20, 10, "gfx/hud/force_tick3", NULL_HANDLE},
	{68, 45, -20, 10, "gfx/hud/force_tick2", NULL_HANDLE}, {69, 41, -20, 10, "gfx/hud/force_tick1", NULL_HANDLE}, // Right top
};

forceTicPos_t ammoTicPos[] = {
	{12, 34, 10, 10, "gfx/hud/ammo_tick7-l", NULL_HANDLE}, // Bottom
	{13, 28, 10, 10, "gfx/hud/ammo_tick6-l", NULL_HANDLE},	{15, 23, 10, 10, "gfx/hud/ammo_tick5-l", NULL_HANDLE},
	{19, 19, 10, 10, "gfx/hud/ammo_tick4-l", NULL_HANDLE},	{23, 15, 10, 10, "gfx/hud/ammo_tick3-l", NULL_HANDLE},
	{29, 12, 10, 10, "gfx/hud/ammo_tick2-l", NULL_HANDLE},	{34, 11, 10, 10, "gfx/hud/ammo_tick1-l", NULL_HANDLE},

	{47, 11, -10, 10, "gfx/hud/ammo_tick1-r", NULL_HANDLE}, {52, 12, -10, 10, "gfx/hud/ammo_tick2-r", NULL_HANDLE},
	{58, 15, -10, 10, "gfx/hud/ammo_tick3-r", NULL_HANDLE}, {62, 19, -10, 10, "gfx/hud/ammo_tick4-r", NULL_HANDLE},
	{66, 23, -10, 10, "gfx/hud/ammo_tick5-r", NULL_HANDLE}, {68, 28, -10, 10, "gfx/hud/ammo_tick6-r", NULL_HANDLE},
...
static void CG_RegisterGraphics(void) {
	...
	// doing one shader just makes it look like a shell.  By using two shaders with different bulge offsets and different texture scales, it has a much more
	// chaotic look
...
void CG_WriteTheEvilCGHackStuff(void) {
	...
	saved_game.write_chunk<int32_t>(INT_ID('F', 'P', 'S', 'L'), ::cg.forcepowerSelect);

	saved_game.write_chunk<int32_t>(INT_ID('I', 'V', 'S', 'L'), ::cg.inventorySelect);
}

void CG_ReadTheEvilCGHackStuff(void) {
	ojk::SavedGameHelper saved_game(::gi.saved_game);

	saved_game.read_chunk<int32_t>(INT_ID('F', 'P', 'S', 'L'), ::gi_cg_forcepowerSelect);

	saved_game.read_chunk<int32_t>(INT_ID('I', 'V', 'S', 'L'), ::gi_cg_inventorySelect);
...
void CG_Init(int serverCommandSequence) {
	...
	static char *force_icon_files[NUM_FORCE_POWERS] = {
		"gfx/hud/f_icon_heal",		  "gfx/hud/f_icon_levitation",	 "gfx/hud/f_icon_speed",		"gfx/hud/f_icon_push",
		"gfx/hud/f_icon_pull",		  "gfx/hud/f_icon_telepathy",	 "gfx/hud/f_icon_grip",			"gfx/hud/f_icon_l1",
		"gfx/hud/f_icon_saber_throw", "gfx/hud/f_icon_saber_defend", "gfx/hud/f_icon_saber_attack",
	};
...
void CG_DrawDataPadInventorySelect(void) {
	...
	if (inv_icons[cg.DataPadInventorySelect]) {
		...
		addX = (float)bigIconSize * .75;
		cgi_R_SetColor(colorTable[CT_ICON_BLUE]);
		CG_DrawNumField((x - (bigIconSize / 2)) + addX, y, 2, cg.snap->ps.inventory[cg.DataPadInventorySelect], 6, 12, NUM_FONT_SMALL, qfalse);
...
int showPowers[MAX_SHOWPOWERS] = {FP_HEAL, FP_SPEED, FP_PUSH, FP_PULL, FP_TELEPATHY, FP_GRIP, FP_LIGHTNING};
...
int showDataPadPowers[MAX_DPSHOWPOWERS] = {
	FP_HEAL, FP_LEVITATION, FP_SPEED, FP_PUSH, FP_PULL, FP_TELEPATHY, FP_GRIP, FP_LIGHTNING, FP_SABERTHROW, FP_SABER_DEFENSE, FP_SABER_OFFENSE,
};
...
void CG_DrawForceSelect(void) {
	...
	*/
	...
	if (force_icons[showPowers[cg.forcepowerSelect]]) {
		CG_DrawPic(x - (bigIconSize / 2), (y - ((bigIconSize - smallIconSize) / 2)), bigIconSize, bigIconSize,
				   force_icons[showPowers[cg.forcepowerSelect]]); // only cache the icon for display
	}
...
char *forcepowerDesc[NUM_FORCE_POWERS] = {
	"FORCE_HEAL_DESC", "FORCE_JUMP_DESC",	   "FORCE_SPEED_DESC",		 "FORCE_PUSH_DESC",			 "FORCE_PULL_DESC",			 "FORCE_MIND_TRICK_DESC",
	"FORCE_GRIP_DESC", "FORCE_LIGHTNING_DESC", "FORCE_SABER_THROW_DESC", "FORCE_SABER_DEFENSE_DESC", "FORCE_SABER_OFFENSE_DESC",
};

char *forcepowerLvl1Desc[NUM_FORCE_POWERS] = {
	"FORCE_HEAL_LVL1_DESC",		   "FORCE_JUMP_LVL1_DESC",			"FORCE_SPEED_LVL1_DESC",		 "FORCE_PUSH_LVL1_DESC",
	"FORCE_PULL_LVL1_DESC",		   "FORCE_MIND_TRICK_LVL1_DESC",	"FORCE_GRIP_LVL1_DESC",			 "FORCE_LIGHTNING_LVL1_DESC",
	"FORCE_SABER_THROW_LVL1_DESC", "FORCE_SABER_DEFENSE_LVL1_DESC", "FORCE_SABER_OFFENSE_LVL1_DESC",
};

char *forcepowerLvl2Desc[NUM_FORCE_POWERS] = {
	"FORCE_HEAL_LVL2_DESC",		   "FORCE_JUMP_LVL2_DESC",			"FORCE_SPEED_LVL2_DESC",		 "FORCE_PUSH_LVL2_DESC",
	"FORCE_PULL_LVL2_DESC",		   "FORCE_MIND_TRICK_LVL2_DESC",	"FORCE_GRIP_LVL2_DESC",			 "FORCE_LIGHTNING_LVL2_DESC",
	"FORCE_SABER_THROW_LVL2_DESC", "FORCE_SABER_DEFENSE_LVL2_DESC", "FORCE_SABER_OFFENSE_LVL2_DESC",
};

char *forcepowerLvl3Desc[NUM_FORCE_POWERS] = {
	"FORCE_HEAL_LVL3_DESC",		   "FORCE_JUMP_LVL3_DESC",			"FORCE_SPEED_LVL3_DESC",		 "FORCE_PUSH_LVL3_DESC",
	"FORCE_PULL_LVL3_DESC",		   "FORCE_MIND_TRICK_LVL3_DESC",	"FORCE_GRIP_LVL3_DESC",			 "FORCE_LIGHTNING_LVL3_DESC",
	"FORCE_SABER_THROW_LVL3_DESC", "FORCE_SABER_DEFENSE_LVL3_DESC", "FORCE_SABER_OFFENSE_LVL3_DESC",
};
...
void CG_DrawDataPadForceSelect(void) {
	...
	if (force_icons[showDataPadPowers[cg.DataPadforcepowerSelect]]) {
		...
		CG_DrawPic(x - (bigIconSize / 2), (y - ((bigIconSize - smallIconSize) / 2)), bigIconSize, bigIconSize,
				   force_icons[showDataPadPowers[cg.DataPadforcepowerSelect]]); // only cache the icon for display
	...
	if (text[0]) {
		...
		CG_DisplayBoxedText(70, 50, 500, 300, va("%s%s", text, text2), cgs.media.qhFontSmall, 0.7f, colorTable[CT_ICON_BLUE]);
	}
}
