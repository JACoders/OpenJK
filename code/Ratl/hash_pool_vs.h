...
// Hash Pool
// ---------
// The hash pool stores raw data of variable size.  It uses a hash table to
// check for redundant data, and upon finding any, will return the existing
// handle.  Otherwise it copies the data to memory and returns a new handle.
//
//
// NOTES:
//
...
// The Hash Pool
////////////////////////////////////////////////////////////////////////////////////////
template <int SIZE, int SIZE_HANDLES> class hash_pool {
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  // This function searches for a handle which already stores the data (assuming
  // the handle is a hash within range SIZE_HANDLES).
  //
...
// assert(mCurrentCollisions < 16);		// If We Had 16+ Collisions, Hash
// May Be Inefficient.
...
public:
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  int size() const { return mDataAlloc; }

  ////////////////////////////////////////////////////////////////////////////////////
  // Check To See If This Memory Pool Is Empty
  ////////////////////////////////////////////////////////////////////////////////////
  bool empty() const { return (mDataAlloc == 1); }

  ////////////////////////////////////////////////////////////////////////////////////
  // Check To See If This Memory Pool Has Enough Space Left For (minimum) Bytes
  ////////////////////////////////////////////////////////////////////////////////////
  bool full(int minimum) const { return ((SIZE - mDataAlloc) < minimum); }
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  // This is the primary functionality of the hash pool.  It will search for
  // existing data of the same size, and failing to find any, it will append the
  // data to the memory.
  //
  ...
  int get_handle(const void *data, int datasize) {
    ...
    if (!find_existing(handle, data, datasize)) {
      ...
      mem::cpy((void *)(&mData[mDataAlloc]), data,
               datasize);            // Copy Data To Memory
