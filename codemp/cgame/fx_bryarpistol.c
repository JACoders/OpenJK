...
-------------------------
*/
void FX_BryarHitWall(vec3_t origin, vec3_t normal) { trap->FX_PlayEffectID(cgs.effects.bryarWallImpactEffect, origin, normal, -1, -1, qfalse); }
...
-------------------------
*/
void FX_TurretHitWall(vec3_t origin, vec3_t normal) { trap->FX_PlayEffectID(cgs.effects.bryarWallImpactEffect, origin, normal, -1, -1, qfalse); }
...
-------------------------
*/
void FX_ConcussionHitWall(vec3_t origin, vec3_t normal) { trap->FX_PlayEffectID(cgs.effects.concussionImpactEffect, origin, normal, -1, -1, qfalse); }
