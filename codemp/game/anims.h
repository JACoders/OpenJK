...
typedef enum //# animNumber_e
{
  ...
  BOTH_T6_BL__L, //# Fast arc bottom left to left
                 // Saber Arc Transitions that use existing animations played
                 // backwards
  BOTH_T6_BR_TR, //# Fast arc bottom right to top right		(use:
                 //BOTH_T6_TR_BR)
  BOTH_T6_BR_T_, //# Fast arc bottom right to top			(use:
                 //BOTH_T6_T__BR)
  BOTH_T6__R_BR, //# Fast arc right to bottom right			(use:
                 //BOTH_T6_BR__R)
  BOTH_T6__R_T_, //# Fast ar right to top				(use:
                 //BOTH_T6_T___R)
  BOTH_T6_TR__R, //# Fast arc top right to right			(use:
                 //BOTH_T6__R_TR)
  BOTH_T6_TR_T_, //# Fast arc top right to top				(use:
                 //BOTH_T6_T__TR)
  BOTH_T6_TL__R, //# Fast arc top left to right			(use:
                 //BOTH_T6__R_TL)
  BOTH_T6_TL_TR, //# Fast arc top left to top right			(use:
                 //BOTH_T6_TR_TL)
  BOTH_T6_TL_T_, //# Fast arc top left to top				(use:
                 //BOTH_T6_T__TL)
  BOTH_T6_TL__L, //# Fast arc top left to left				(use:
                 //BOTH_T6__L_TL)
  BOTH_T6__L_TR, //# Fast arc left to top right			(use:
                 //BOTH_T6_TR__L)
  BOTH_T6__L_T_, //# Fast arc left to top				(use:
                 //BOTH_T6_T___L)
  BOTH_T6__L_BL, //# Fast arc left to bottom left			(use:
                 //BOTH_T6_BL__L)
  BOTH_T6_BL_T_, //# Fast arc bottom left to top			(use:
                 //BOTH_T6_T__BL)
  BOTH_T6_BL_TL, //# Fast arc bottom left to top left		(use:
                 //BOTH_T6_TL_BL) Saber Attack Start Transitions
  BOTH_S6_S6_T_, //# Fast plain transition from stance1 to top-to-bottom Fast
                 //weak attack
  BOTH_S6_S6__L, //# Fast plain transition from stance1 to left-to-right Fast
                 //weak attack
  BOTH_S6_S6__R, //# Fast plain transition from stance1 to right-to-left Fast
                 //weak attack
  BOTH_S6_S6_TL, //# Fast plain transition from stance1 to
                 //top-left-to-bottom-right Fast weak attack
  BOTH_S6_S6_BR, //# Fast plain transition from stance1 to
                 //bottom-right-to-top-left Fast weak attack
  BOTH_S6_S6_BL, //# Fast plain transition from stance1 to
                 //bottom-left-to-top-right Fast weak attack
  BOTH_S6_S6_TR, //# Fast plain transition from stance1 to
                 //top-right-to-bottom-left Fast weak attack Saber Attack Return
                 // Transitions
  BOTH_R6_B__S6, //# Fast plain transition from top-to-bottom Fast weak attack
                 //to stance1
  BOTH_R6__L_S6, //# Fast plain transition from left-to-right Fast weak attack
                 //to stance1
  BOTH_R6__R_S6, //# Fast plain transition from right-to-left Fast weak attack
                 //to stance1
  BOTH_R6_TL_S6, //# Fast plain transition from top-left-to-bottom-right Fast
                 //weak attack to stance1
  BOTH_R6_BR_S6, //# Fast plain transition from bottom-right-to-top-left Fast
                 //weak attack to stance1
  BOTH_R6_BL_S6, //# Fast plain transition from bottom-left-to-top-right Fast
                 //weak attack to stance1
  BOTH_R6_TR_S6, //# Fast plain transition from top-right-to-bottom-left Fast
                 //weak attack Saber Attack Bounces (first 4 frames of an
                 // attack, played backwards)
  ...
  BOTH_T7_BL__L, //# Fast arc bottom left to left
                 // Saber Arc Transitions that use existing animations played
                 // backwards
  BOTH_T7_BR_TR, //# Fast arc bottom right to top right		(use:
                 //BOTH_T7_TR_BR)
  BOTH_T7_BR_T_, //# Fast arc bottom right to top			(use:
                 //BOTH_T7_T__BR)
  BOTH_T7__R_BR, //# Fast arc right to bottom right			(use:
                 //BOTH_T7_BR__R)
  BOTH_T7__R_T_, //# Fast ar right to top				(use:
                 //BOTH_T7_T___R)
  BOTH_T7_TR__R, //# Fast arc top right to right			(use:
                 //BOTH_T7__R_TR)
  BOTH_T7_TR_T_, //# Fast arc top right to top				(use:
                 //BOTH_T7_T__TR)
  BOTH_T7_TL__R, //# Fast arc top left to right			(use:
                 //BOTH_T7__R_TL)
  BOTH_T7_TL_TR, //# Fast arc top left to top right			(use:
                 //BOTH_T7_TR_TL)
  BOTH_T7_TL_T_, //# Fast arc top left to top				(use:
                 //BOTH_T7_T__TL)
  BOTH_T7_TL__L, //# Fast arc top left to left				(use:
                 //BOTH_T7__L_TL)
  BOTH_T7__L_TR, //# Fast arc left to top right			(use:
                 //BOTH_T7_TR__L)
  BOTH_T7__L_T_, //# Fast arc left to top				(use:
                 //BOTH_T7_T___L)
  BOTH_T7__L_BL, //# Fast arc left to bottom left			(use:
                 //BOTH_T7_BL__L)
  BOTH_T7_BL_T_, //# Fast arc bottom left to top			(use:
                 //BOTH_T7_T__BL)
  BOTH_T7_BL_TL, //# Fast arc bottom left to top left		(use:
                 //BOTH_T7_TL_BL) Saber Attack Start Transitions
  BOTH_S7_S7_T_, //# Fast plain transition from stance1 to top-to-bottom Fast
                 //weak attack
  BOTH_S7_S7__L, //# Fast plain transition from stance1 to left-to-right Fast
                 //weak attack
  BOTH_S7_S7__R, //# Fast plain transition from stance1 to right-to-left Fast
                 //weak attack
  BOTH_S7_S7_TL, //# Fast plain transition from stance1 to
                 //top-left-to-bottom-right Fast weak attack
  BOTH_S7_S7_BR, //# Fast plain transition from stance1 to
                 //bottom-right-to-top-left Fast weak attack
  BOTH_S7_S7_BL, //# Fast plain transition from stance1 to
                 //bottom-left-to-top-right Fast weak attack
  BOTH_S7_S7_TR, //# Fast plain transition from stance1 to
                 //top-right-to-bottom-left Fast weak attack Saber Attack Return
                 // Transitions
  BOTH_R7_B__S7, //# Fast plain transition from top-to-bottom Fast weak attack
                 //to stance1
  BOTH_R7__L_S7, //# Fast plain transition from left-to-right Fast weak attack
                 //to stance1
  BOTH_R7__R_S7, //# Fast plain transition from right-to-left Fast weak attack
                 //to stance1
  BOTH_R7_TL_S7, //# Fast plain transition from top-left-to-bottom-right Fast
                 //weak attack to stance1
  BOTH_R7_BR_S7, //# Fast plain transition from bottom-right-to-top-left Fast
                 //weak attack to stance1
  BOTH_R7_BL_S7, //# Fast plain transition from bottom-left-to-top-right Fast
                 //weak attack to stance1
  BOTH_R7_TR_S7, //# Fast plain transition from top-right-to-bottom-left Fast
                 //weak attack Saber Attack Bounces (first 4 frames of an
                 // attack, played backwards)
  ...
  // Special cases for same saber style vs. each other (won't fit in nice 5-anim
  // size lists above)
  BOTH_LK_S_S_S_L_2, // lock if I'm using single vs. a single and other
                     // intitiated
  BOTH_LK_S_S_T_L_2, // lock if I'm using single vs. a single and other
                     // initiated
  ...
  BOTH_LK_ST_ST_S_L_2, // lock if I'm using staff vs. a staff and other
                       // initiated
  BOTH_LK_ST_ST_T_L_2, // lock if I'm using staff vs. a staff and other
                       // initiated
  //===End Saber
  //locks================================================================== old
  // locks
  ...
  BOTH_SPINATTACK6, //#
  BOTH_SPINATTACK7, //#
  BOTH_S1_S6,       //#	From stand1 to saberdual stance - turning on your dual
                    //sabers
  BOTH_S6_S1,       //#	From dualstaff stance to stand1 - turning off your dual
                    //sabers
  BOTH_S1_S7,       //#	From stand1 to saberstaff stance - turning on your
                    //saberstaff
  BOTH_S7_S1,       //#	From saberstaff stance to stand1 - turning off your
                    //saberstaff
  ...
  BOTH_VS_MOUNTTHROW_L, //# Land on an occupied vehicle & throw off current
                        //pilot
  BOTH_VS_MOUNTTHROW_R, //# Land on an occupied vehicle & throw off current
                        //pilot
  ...
  BOTH_LOSE_SABER,   //# player losing saber (pulled from hand by force pull 4 -
                     //Kyle?)
  ...
  BOTH_ROSH_HEAL, //# healed/rejuvenated
                  // Tavion
  BOTH_TAVION_SCEPTERGROUND, //# stabbing ground with sith sword shoots
  ...
  BOTH_PLAYER_PA_FLY, //# player getting knocked back from punch at end of hold
                      //1
