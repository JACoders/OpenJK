...
void UI_LoadArenas(void) {
  ...
  numdirs =
      trap->FS_GetFileList("scripts", ".arena", dirlist, ARRAY_LEN(dirlist));
  dirptr = dirlist;
...
static void UI_LoadBotsFromFile(char *filename) {
  ...
  // If we hit it just stop and trace back to the beginning of the bot define
  // and cut the string off. This is only done in the UI and not the game so that
