...
extern qboolean G_BoxInBounds(const vec3_t point, const vec3_t mins,
                              const vec3_t maxs, const vec3_t boundsMins,
...
qboolean WP_LobFire(gentity_t *self, vec3_t start, vec3_t target, vec3_t mins,
                    ...
                    float minSpeed = 0, float maxSpeed = 0,
                    float idealSpeed = 0, qboolean mustHit = qfalse);
