...
XCVAR_DEF( zyk_healing_area_cooldown,	"24000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_lightning_dome_cooldown,	"32000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_magic_explosion_cooldown,	"28000",	NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_ultra_strength_cooldown,	"8000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
...
XCVAR_DEF( zyk_rockfall_cooldown,	"11000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_dome_of_damage_cooldown,	"16000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_ice_stalagmite_cooldown,	"20000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_ice_boulder_cooldown,	"20000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_hurricane_cooldown,	"10000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_slow_motion_cooldown,	"9000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_ultra_resistance_cooldown,	"8000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_sleeping_flowers_cooldown,	"15000",	NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_healing_water_cooldown,	"12000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_flame_burst_cooldown,	"10000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_earthquake_cooldown,	"11000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_magic_shield_cooldown,	"28000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_blowing_wind_cooldown,	"10000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_ultra_speed_cooldown,	"9000",			NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_ultra_drain_cooldown,	"24000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
XCVAR_DEF( zyk_immunity_power_cooldown,	"22000",		NULL,				CVAR_ARCHIVE|CVAR_NORESTART,					qtrue )
