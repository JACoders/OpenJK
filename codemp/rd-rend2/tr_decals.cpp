...
void R_InitDecals(void) { RE_ClearDecals(); }
...
void RE_AddDecalToScene(qhandle_t decalShader, const vec3_t origin, const vec3_t dir, float orientation, float red, float green, float blue, float alpha,
	...
	numFragments = R_MarkFragments(4, (const vec3_t *)originalPoints, projection, MAX_DECAL_POINTS, markPoints[0], MAX_DECAL_FRAGMENTS, markFragments);
