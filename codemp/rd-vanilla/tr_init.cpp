...
cvar_t *r_cullRoofFaces; // attempted smart method of culling out upwards facing
                         // surfaces on roofs for automap shots -rww
...
void R_Splash() {
  ...
  /*	const char* s = ri.Cvar_VariableString("se_language");
          ...
          {
                  pImage = R_FindImageFile( "menu/splash_eur", qfalse, qfalse,
     qfalse, GL_CLAMP);
          }
          else
          {
                  pImage = R_FindImageFile( "menu/splash", qfalse, qfalse,
     qfalse, GL_CLAMP);
          }
  */
...
** GLW_CheckForExtension
  ...
  Cannot use strstr directly to differentiate between (for eg) reg_combiners and
reg_combiners2
*/
...
static void GLW_InitTextureCompression(void) {
  ...
  newer_tc = ri.GL_ExtensionSupported("GL_ARB_texture_compression") &&
             ri.GL_ExtensionSupported("GL_EXT_texture_compression_s3tc");
    ...
    if (r_ext_preferred_tc_method->integer == TC_NONE) {
      ...
      if (old_tc && newer_tc) {
        ...
        if (r_ext_preferred_tc_method->integer == TC_S3TC) {
          ...
          Com_Printf("...using preferred tc method, "
        ...
        if (r_ext_preferred_tc_method->integer == TC_S3TC) {
          ...
          if (newer_tc) {
            ...
            // Drat, preference can't be honored
            Com_Printf("...preferred tc method, "
...
static void GLimp_InitExtensions(void) {
  ...
  if (ri.GL_ExtensionSupported("GL_EXT_texture_filter_anisotropic")) {
    ...
    ri.Cvar_SetValue("r_ext_texture_filter_anisotropic_avail",
                     glConfig.maxTextureFilterAnisotropy);
  ...
  if (ri.GL_ExtensionSupported("GL_ARB_multitexture")) {
    if (r_ext_multitexture->integer) {
      qglMultiTexCoord2fARB = (PFNGLMULTITEXCOORD2FARBPROC)ri.GL_GetProcAddress(
          "glMultiTexCoord2fARB");
      qglActiveTextureARB =
          (PFNGLACTIVETEXTUREARBPROC)ri.GL_GetProcAddress("glActiveTextureARB");
      qglClientActiveTextureARB =
          (PFNGLCLIENTACTIVETEXTUREARBPROC)ri.GL_GetProcAddress(
  ...
  if (ri.GL_ExtensionSupported("GL_EXT_compiled_vertex_array")) {
    if (r_ext_compiled_vertex_array->integer) {
      ...
      qglLockArraysEXT =
          (PFNGLLOCKARRAYSEXTPROC)ri.GL_GetProcAddress("glLockArraysEXT");
      qglUnlockArraysEXT =
  ...
  if (ri.GL_ExtensionSupported("GL_NV_register_combiners")) {
    ...
    if (glConfig.maxActiveTextures >= 2) {
      ...
      // NOTE: VV guys will _definetly_ not be able to use regcoms. Pixel
      // Shaders are just as good though :-) NOTE: Also, this is an nVidia
      // specific extension (of course), so fragment shaders would serve the
      // same purpose if we needed some kind of fragment/pixel manipulation
      // support.
      qglCombinerParameterfvNV =
          (PFNGLCOMBINERPARAMETERFVNVPROC)ri.GL_GetProcAddress(
              "glCombinerParameterfvNV");
      qglCombinerParameterivNV =
          (PFNGLCOMBINERPARAMETERIVNVPROC)ri.GL_GetProcAddress(
              "glCombinerParameterivNV");
      qglCombinerParameterfNV =
          (PFNGLCOMBINERPARAMETERFNVPROC)ri.GL_GetProcAddress(
              "glCombinerParameterfNV");
      qglCombinerParameteriNV =
          (PFNGLCOMBINERPARAMETERINVPROC)ri.GL_GetProcAddress(
              "glCombinerParameteriNV");
      qglCombinerInputNV =
          (PFNGLCOMBINERINPUTNVPROC)ri.GL_GetProcAddress("glCombinerInputNV");
      qglCombinerOutputNV =
          (PFNGLCOMBINEROUTPUTNVPROC)ri.GL_GetProcAddress("glCombinerOutputNV");
      qglFinalCombinerInputNV =
          (PFNGLFINALCOMBINERINPUTNVPROC)ri.GL_GetProcAddress(
              "glFinalCombinerInputNV");
      qglGetCombinerInputParameterfvNV =
          (PFNGLGETCOMBINERINPUTPARAMETERFVNVPROC)ri.GL_GetProcAddress(
              "glGetCombinerInputParameterfvNV");
      qglGetCombinerInputParameterivNV =
          (PFNGLGETCOMBINERINPUTPARAMETERIVNVPROC)ri.GL_GetProcAddress(
              "glGetCombinerInputParameterivNV");
      qglGetCombinerOutputParameterfvNV =
          (PFNGLGETCOMBINEROUTPUTPARAMETERFVNVPROC)ri.GL_GetProcAddress(
              "glGetCombinerOutputParameterfvNV");
      qglGetCombinerOutputParameterivNV =
          (PFNGLGETCOMBINEROUTPUTPARAMETERIVNVPROC)ri.GL_GetProcAddress(
              "glGetCombinerOutputParameterivNV");
      qglGetFinalCombinerInputParameterfvNV =
          (PFNGLGETFINALCOMBINERINPUTPARAMETERFVNVPROC)ri.GL_GetProcAddress(
              "glGetFinalCombinerInputParameterfvNV");
      qglGetFinalCombinerInputParameterivNV =
          (PFNGLGETFINALCOMBINERINPUTPARAMETERIVNVPROC)ri.GL_GetProcAddress(
              "glGetFinalCombinerInputParameterivNV");

      // Validate the functions we need.
      if (!qglCombinerParameterfvNV || !qglCombinerParameterivNV ||
          !qglCombinerParameterfNV || !qglCombinerParameteriNV ||
          !qglCombinerInputNV || !qglCombinerOutputNV ||
          !qglFinalCombinerInputNV || !qglGetCombinerInputParameterfvNV ||
          !qglGetCombinerInputParameterivNV ||
          !qglGetCombinerOutputParameterfvNV ||
          !qglGetCombinerOutputParameterivNV ||
          !qglGetFinalCombinerInputParameterfvNV ||
  ...
  // NOTE: Vertex and Fragment Programs are very dependant on each other - this
  // is actually a good thing! So, just check to see which we support (one or
  // the other) and load the shared function pointers. ARB rocks!
  ...
  if (bARBVertexProgram || bARBFragmentProgram) {
    qglProgramStringARB =
        (PFNGLPROGRAMSTRINGARBPROC)ri.GL_GetProcAddress("glProgramStringARB");
    qglBindProgramARB =
        (PFNGLBINDPROGRAMARBPROC)ri.GL_GetProcAddress("glBindProgramARB");
    qglDeleteProgramsARB =
        (PFNGLDELETEPROGRAMSARBPROC)ri.GL_GetProcAddress("glDeleteProgramsARB");
    qglGenProgramsARB =
        (PFNGLGENPROGRAMSARBPROC)ri.GL_GetProcAddress("glGenProgramsARB");
    qglProgramEnvParameter4dARB =
        (PFNGLPROGRAMENVPARAMETER4DARBPROC)ri.GL_GetProcAddress(
            "glProgramEnvParameter4dARB");
    qglProgramEnvParameter4dvARB =
        (PFNGLPROGRAMENVPARAMETER4DVARBPROC)ri.GL_GetProcAddress(
            "glProgramEnvParameter4dvARB");
    qglProgramEnvParameter4fARB =
        (PFNGLPROGRAMENVPARAMETER4FARBPROC)ri.GL_GetProcAddress(
            "glProgramEnvParameter4fARB");
    qglProgramEnvParameter4fvARB =
        (PFNGLPROGRAMENVPARAMETER4FVARBPROC)ri.GL_GetProcAddress(
            "glProgramEnvParameter4fvARB");
    qglProgramLocalParameter4dARB =
        (PFNGLPROGRAMLOCALPARAMETER4DARBPROC)ri.GL_GetProcAddress(
            "glProgramLocalParameter4dARB");
    qglProgramLocalParameter4dvARB =
        (PFNGLPROGRAMLOCALPARAMETER4DVARBPROC)ri.GL_GetProcAddress(
            "glProgramLocalParameter4dvARB");
    qglProgramLocalParameter4fARB =
        (PFNGLPROGRAMLOCALPARAMETER4FARBPROC)ri.GL_GetProcAddress(
            "glProgramLocalParameter4fARB");
    qglProgramLocalParameter4fvARB =
        (PFNGLPROGRAMLOCALPARAMETER4FVARBPROC)ri.GL_GetProcAddress(
            "glProgramLocalParameter4fvARB");
    qglGetProgramEnvParameterdvARB =
        (PFNGLGETPROGRAMENVPARAMETERDVARBPROC)ri.GL_GetProcAddress(
            "glGetProgramEnvParameterdvARB");
    qglGetProgramEnvParameterfvARB =
        (PFNGLGETPROGRAMENVPARAMETERFVARBPROC)ri.GL_GetProcAddress(
            "glGetProgramEnvParameterfvARB");
    qglGetProgramLocalParameterdvARB =
        (PFNGLGETPROGRAMLOCALPARAMETERDVARBPROC)ri.GL_GetProcAddress(
            "glGetProgramLocalParameterdvARB");
    qglGetProgramLocalParameterfvARB =
        (PFNGLGETPROGRAMLOCALPARAMETERFVARBPROC)ri.GL_GetProcAddress(
            "glGetProgramLocalParameterfvARB");
    qglGetProgramivARB =
        (PFNGLGETPROGRAMIVARBPROC)ri.GL_GetProcAddress("glGetProgramivARB");
    qglGetProgramStringARB = (PFNGLGETPROGRAMSTRINGARBPROC)ri.GL_GetProcAddress(
        "glGetProgramStringARB");
    qglIsProgramARB =
        (PFNGLISPROGRAMARBPROC)ri.GL_GetProcAddress("glIsProgramARB");

    // Validate the functions we need.
    if (!qglProgramStringARB || !qglBindProgramARB || !qglDeleteProgramsARB ||
        !qglGenProgramsARB || !qglProgramEnvParameter4dARB ||
        !qglProgramEnvParameter4dvARB || !qglProgramEnvParameter4fARB ||
        !qglProgramEnvParameter4fvARB || !qglProgramLocalParameter4dARB ||
        !qglProgramLocalParameter4dvARB || !qglProgramLocalParameter4fARB ||
        !qglProgramLocalParameter4fvARB || !qglGetProgramEnvParameterdvARB ||
        !qglGetProgramEnvParameterfvARB || !qglGetProgramLocalParameterdvARB ||
        !qglGetProgramLocalParameterfvARB || !qglGetProgramivARB ||
        !qglGetProgramStringARB || !qglIsProgramARB) {
      bARBVertexProgram = false;
      bARBFragmentProgram = false;
  ...
  if (Q_stricmpn(glConfig.vendor_string, "ATI Technologies", 16) == 0 &&
      ...
      glConfig.version_string[5] < '9') // 1.3.34 and 1.3.37 and 1.3.38 are
                                        // broken for sure, 1.3.39 is not
  {
    g_bTextureRectangleHack = true;
  }

  if (ri.GL_ExtensionSupported("GL_NV_texture_rectangle") ||
      ri.GL_ExtensionSupported("GL_EXT_texture_rectangle")) {
...
#define GL_MAX_GENERAL_COMBINERS_NV 0x854D
  ...
  if (r_gammaShaders->integer && qglActiveTextureARB && bTexRectSupported &&
      bARBVertexProgram && bARBFragmentProgram) {
#if !defined(__APPLE__)
    qglTexImage3D = (PFNGLTEXIMAGE3DPROC)ri.GL_GetProcAddress("glTexImage3D");
    qglTexSubImage3D =
        (PFNGLTEXSUBIMAGE3DPROC)ri.GL_GetProcAddress("glTexSubImage3D");
  ...
  if (bTexRectSupported && bARBVertexProgram && qglActiveTextureARB &&
      glConfig.maxActiveTextures >= 4 &&
      ((bNVRegisterCombiners && iNumGeneralCombiners >= 2) ||
       bARBFragmentProgram)) {
...
// Truncates the GL extensions string by only allowing up to 'maxExtensions'
// extensions in the string.
static const char *TruncateGLExtensionsString(const char *extensionsString,
                                              int maxExtensions) {
...
static void InitOpenGL(void) {
  ...
  if (glConfig.vidWidth == 0) {
    ...
    glConfig.extensions_string =
        TruncateGLExtensionsString(glConfigExt.originalExtensionString, 128);
...
byte *RB_ReadPixels(int x, int y, int width, int height, size_t *offset,
  ...
  buffer = (byte *)Hunk_AllocateTempMemory(padwidth * height + *offset +
                                           packAlign - 1);
...
static void R_LevelShot(void) {
  ...
  buffer = (byte *)ri.Hunk_AllocateTempMemory(
      LEVELSHOTSIZE * LEVELSHOTSIZE * 3 + 18);
  Com_Memset(buffer, 0, 18);
  buffer[2] = 2; // uncompressed type
  ...
  if ((tr.overbrightBits > 0) && glConfig.deviceSupportsGamma &&
      !glConfigExt.doGammaCorrectionWithShaders) {
...
void R_ScreenShotTGA_f(void) {
  ...
  if (ri.Cmd_Argc() == 2 && !silent) {
    // explicit filename
    Com_sprintf(checkname, sizeof(checkname), "screenshots/%s.tga",
                ri.Cmd_Argv(1));
  } else {
    // timestamp the file
...
void R_ScreenShotPNG_f(void) {
  ...
  if (ri.Cmd_Argc() == 2 && !silent) {
    // explicit filename
    Com_sprintf(checkname, sizeof(checkname), "screenshots/%s.png",
                ri.Cmd_Argv(1));
  } else {
    // timestamp the file
...
void R_ScreenShot_f(void) {
  ...
  if (ri.Cmd_Argc() == 2 && !silent) {
    // explicit filename
    Com_sprintf(checkname, sizeof(checkname), "screenshots/%s.jpg",
                ri.Cmd_Argv(1));
  } else {
    // timestamp the file
...
const void *RB_TakeVideoFrameCmd(const void *data) {
  ...
  if (cmd->motionJpeg) {
    memcount = RE_SaveJPGToBuffer(cmd->encodeBuffer, linelen * cmd->height,
                                  r_aviMotionJpegQuality->integer, cmd->width,
                                  cmd->height, cBuf, padlen);
...
void R_PrintLongString(const char *string) {
  ...
  while (remainingLength > 0) {
    // Take as much characters as possible from the string without splitting
    // words between buffers This avoids the client console splitting a word up
    // when one half fits on the current line, but the second half would have to
...
void GfxInfo_f(void) {
  ...
  const char *noborderstrings[] = {"", "noborder "};
  ...
  ri.Printf(
      PRINT_ALL,
      "MODE: %d, %d x %d %s%s hz:", ri.Cvar_VariableIntegerValue("r_mode"),
  ...
  ri.Printf(PRINT_ALL, "compressed lightmaps: %s\n",
            enablestrings[(r_ext_compressed_lightmaps->integer != 0 &&
                           glConfig.textureCompression != TC_NONE)]);
  ...
  ri.Printf(PRINT_ALL, "anisotropic filtering: %s  ",
            enablestrings[(r_ext_texture_filter_anisotropic->integer != 0) &&
                          glConfig.maxTextureFilterAnisotropy]);
  if (r_ext_texture_filter_anisotropic->integer != 0 &&
      glConfig.maxTextureFilterAnisotropy) {
    if (Q_isintegral(r_ext_texture_filter_anisotropic->value))
      ri.Printf(PRINT_ALL, "(%i of ",
                (int)r_ext_texture_filter_anisotropic->value);
    else
  ...
  if (g_bTextureRectangleHack)
    ri.Printf(PRINT_ALL, "Dynamic Glow ATI BAD DRIVER HACK %s\n",
  ...
  if (tr.world) {
    ri.Printf(PRINT_ALL, "Light Grid size set to (%.2f %.2f %.2f)\n",
              tr.world->lightGridSize[0], tr.world->lightGridSize[1],
              tr.world->lightGridSize[2]);
  }
}
...
void R_Register(void) {
  // FIXME: lol badness
  se_language =
      ri.Cvar_Get("se_language", "english", CVAR_ARCHIVE | CVAR_NORESTART, "");
  //
  // latched and archived variables
  //
  r_allowExtensions =
      ri.Cvar_Get("r_allowExtensions", "1", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_ext_compressed_textures = ri.Cvar_Get("r_ext_compress_textures", "1",
                                          CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_ext_compressed_lightmaps = ri.Cvar_Get("r_ext_compress_lightmaps", "0",
                                           CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_ext_preferred_tc_method = ri.Cvar_Get("r_ext_preferred_tc_method", "0",
                                          CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_ext_gamma_control =
      ri.Cvar_Get("r_ext_gamma_control", "1", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_ext_multitexture =
      ri.Cvar_Get("r_ext_multitexture", "1", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  ...
  r_gammaShaders =
      ri.Cvar_Get("r_gammaShaders", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_environmentMapping =
      ri.Cvar_Get("r_environmentMapping", "1", CVAR_ARCHIVE_ND, "");
  r_DynamicGlow = ri.Cvar_Get("r_DynamicGlow", "0", CVAR_ARCHIVE_ND, "");
  r_DynamicGlowPasses =
      ri.Cvar_Get("r_DynamicGlowPasses", "5", CVAR_ARCHIVE_ND, "");
  r_DynamicGlowDelta =
      ri.Cvar_Get("r_DynamicGlowDelta", "0.8f", CVAR_ARCHIVE_ND, "");
  r_DynamicGlowIntensity =
      ri.Cvar_Get("r_DynamicGlowIntensity", "1.13f", CVAR_ARCHIVE_ND, "");
  r_DynamicGlowSoft =
      ri.Cvar_Get("r_DynamicGlowSoft", "1", CVAR_ARCHIVE_ND, "");
  ...
  r_texturebits =
      ri.Cvar_Get("r_texturebits", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_texturebitslm =
      ri.Cvar_Get("r_texturebitslm", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_overBrightBits =
      ri.Cvar_Get("r_overBrightBits", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_mapOverBrightBits =
      ri.Cvar_Get("r_mapOverBrightBits", "0", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_simpleMipMaps =
      ri.Cvar_Get("r_simpleMipMaps", "1", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  r_vertexLight =
      ri.Cvar_Get("r_vertexLight", "0", CVAR_ARCHIVE | CVAR_LATCH, "");
  r_uiFullScreen = ri.Cvar_Get("r_uifullscreen", "0", CVAR_NONE, "");
  r_subdivisions =
      ri.Cvar_Get("r_subdivisions", "4", CVAR_ARCHIVE_ND | CVAR_LATCH, "");
  ...
  //	r_dlightBacks						= ri.Cvar_Get( "r_dlightBacks",
  //"1",						CVAR_CHEAT, "" );
  r_finish = ri.Cvar_Get("r_finish", "0", CVAR_ARCHIVE_ND, "");
  r_textureMode = ri.Cvar_Get("r_textureMode", "GL_LINEAR_MIPMAP_NEAREST",
                              CVAR_ARCHIVE, "");
  r_markcount = ri.Cvar_Get("r_markcount", "100", CVAR_ARCHIVE_ND, "");
  r_gamma = ri.Cvar_Get("r_gamma", "1", CVAR_ARCHIVE_ND, "");
  r_facePlaneCull = ri.Cvar_Get("r_facePlaneCull", "1", CVAR_ARCHIVE_ND, "");
  r_cullRoofFaces =
      ri.Cvar_Get("r_cullRoofFaces", "0", CVAR_CHEAT,
                  ""); // attempted smart method of culling out upwards facing
                       // surfaces on roofs for automap shots -rww
  r_roofCullCeilDist =
      ri.Cvar_Get("r_roofCullCeilDist", "256", CVAR_CHEAT,
                  ""); // attempted smart method of culling out upwards facing
                       // surfaces on roofs for automap shots -rww
  r_roofCullFloorDist =
      ri.Cvar_Get("r_roofCeilFloorDist", "128", CVAR_CHEAT,
                  ""); // attempted smart method of culling out upwards facing
                       // surfaces on roofs for automap shots -rww
  ...
  r_autoMap = ri.Cvar_Get("r_autoMap", "0", CVAR_ARCHIVE_ND,
                          ""); // automap renderside toggle for debugging -rww
  r_autoMapBackAlpha = ri.Cvar_Get("r_autoMapBackAlpha", "0", CVAR_NONE,
  ...
  r_marksOnTriangleMeshes =
      ri.Cvar_Get("r_marksOnTriangleMeshes", "0", CVAR_ARCHIVE_ND, "");
  r_aspectCorrectFonts =
      ri.Cvar_Get("r_aspectCorrectFonts", "0", CVAR_ARCHIVE, "");
  r_maxpolys =
      ri.Cvar_Get("r_maxpolys", XSTRING(DEFAULT_MAX_POLYS), CVAR_NONE, "");
  r_maxpolyverts = ri.Cvar_Get("r_maxpolyverts", XSTRING(DEFAULT_MAX_POLYVERTS),
                               CVAR_NONE, "");
/*
Ghoul2 Insert Start
*/
  ...
  r_Ghoul2UnSqashAfterSmooth =
      ri.Cvar_Get("r_ghoul2unsqashaftersmooth", "1", CVAR_NONE, "");
  broadsword = ri.Cvar_Get("broadsword", "0", CVAR_ARCHIVE_ND, "");
  broadsword_kickbones =
      ri.Cvar_Get("broadsword_kickbones", "1", CVAR_NONE, "");
  broadsword_kickorigin =
      ri.Cvar_Get("broadsword_kickorigin", "1", CVAR_NONE, "");
  broadsword_dontstopanim =
      ri.Cvar_Get("broadsword_dontstopanim", "0", CVAR_NONE, "");
  broadsword_waitforshot =
      ri.Cvar_Get("broadsword_waitforshot", "0", CVAR_NONE, "");
  broadsword_playflop = ri.Cvar_Get("broadsword_playflop", "1", CVAR_NONE, "");
  broadsword_smallbbox =
      ri.Cvar_Get("broadsword_smallbbox", "0", CVAR_NONE, "");
  ...
  broadsword_ragtobase =
      ri.Cvar_Get("broadsword_ragtobase", "2", CVAR_NONE, "");
  ...
  */
  ...
  r_aviMotionJpegQuality =
      ri.Cvar_Get("r_aviMotionJpegQuality", "90", CVAR_ARCHIVE_ND, "");
  r_screenshotJpegQuality =
      ri.Cvar_Get("r_screenshotJpegQuality", "95", CVAR_ARCHIVE_ND, "");
...
void R_Init(void) {
  ...
  ptr =
      (byte *)Hunk_Alloc(sizeof(*backEndData) + sizeof(srfPoly_t) * max_polys +
...
void RE_Shutdown(qboolean destroyWindow, qboolean restarting) {
  ...
  if (tr.registered) {
    ...
    if (destroyWindow) {
      R_DeleteTextures(); // only do this for vid_restart now, not during things
                          // like map load
...
static void G2API_BoltMatrixSPMethod(qboolean spMethod) {
...
static void SetRefractionProperties(float distortionAlpha,
                                    float distortionStretch,
                                    qboolean distortionPrePost,
...
Q_EXPORT refexport_t *QDECL GetRefAPI(int apiVersion, refimport_t *rimp) {
  ...
  re.G2API_LoadSaveCodeDestructGhoul2Info =
      G2API_LoadSaveCodeDestructGhoul2Info;
