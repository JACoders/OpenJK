...
#ifdef XCVAR_LIST
#define XCVAR_DEF(name, defVal, update, flags)                                 \
  {&name, #name, defVal, update, flags},
#endif

XCVAR_DEF(capturelimit, "0", NULL,
          CVAR_ARCHIVE | CVAR_NORESTART |
              CVAR_SERVERINFO) // fixme init'd to 8 in game module
...
XCVAR_DEF(ui_blueteam, DEFAULT_BLUETEAM_NAME, NULL,
          CVAR_ARCHIVE | CVAR_INTERNAL)
...
XCVAR_DEF(ui_browserShowPasswordProtected, "1", NULL,
          CVAR_ARCHIVE | CVAR_INTERNAL)
...
XCVAR_DEF(ui_redteam1, "1", NULL,
          CVAR_ARCHIVE | CVAR_INTERNAL) // rww - these used to all default to 0
                                        // (closed).. I changed them to 1 (human)
