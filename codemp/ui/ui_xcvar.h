...
XCVAR_DEF( ui_blueteam,						"Rebellion",		NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
...
XCVAR_DEF( ui_opponentName,					"Rebellion",		NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_rankChange,					"0",				NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_recordSPDemo,					"0",				NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
XCVAR_DEF( ui_redteam,						"Empire",			NULL,				CVAR_ARCHIVE|CVAR_INTERNAL )
