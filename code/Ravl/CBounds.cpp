...
bool CBBox::BoxTouchTest(const CBBox &b2, float tolout) const {
  if (mMin[0] - tolout > b2.mMax[0] || mMin[1] - tolout > b2.mMax[1] ||
      mMin[2] - tolout > b2.mMax[2] || b2.mMin[0] - tolout > mMax[0] ||
...
bool CBBox::SphereTouchTest(const CVec3 &v, float rad) const {
  if (v[0] < mMin[0] - rad || v[0] > mMax[0] + rad || v[1] < mMin[1] - rad ||
      v[1] > mMax[1] + rad || v[2] < mMin[2] - rad || v[2] > mMax[2] + rad)
    return false;
  return true;
}
...
////////////////////////////////////////////////////////////////////////////////////////
//
// return true if the segment intersect the box, in that case, return the first
// contact.
////////////////////////////////////////////////////////////////////////////////////////
bool CBBox::HitTest(CBTrace &Tr) const {
  ...
  // Missed?
  //---------
  if (Tr.mRangeMax < Tr.mRange || Tr.mRangeMax < 0.0f ||
      Tr.mRange > Tr.mLength) {
    return false;
  }
